...
Perfume Retailers represents an important category within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    N456 --> N45612["45612: Perfume Retailers"]
    style N45612 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 45612 |
| Market Segment | Perfume Retailers |
...
*Source: NAICS 45612 - Perfume Retailers*
