...
Drug Retailers represents an important category within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    N456 --> N45611["45611: Drug Retailers"]
    style N45611 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 45611 |
| Market Segment | Drug Retailers |
...
*Source: NAICS 45611 - Drug Retailers*
