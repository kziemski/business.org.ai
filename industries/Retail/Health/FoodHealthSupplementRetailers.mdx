---
id: FoodHealthSupplementRetailers
...
Food (Health) Supplement Retailers represents a specialized segment within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    S4445 --> N456["456: Health"]
    N456 --> N456191["456191: Food (Health) Supplement Retailers"]
    style N456191 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 456191 |
| Market Segment | Food (Health) Supplement Retailers |
...
*Source: NAICS 456191 - Food (Health) Supplement Retailers*
