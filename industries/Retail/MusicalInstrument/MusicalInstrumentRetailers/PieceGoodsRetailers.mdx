---
id: PieceGoodsRetailers
name: Piece Goods Retailers
code: 45913
type: Industry
level: Industry
status: complete
...
Piece Goods Retailers represents an important category within the Retail Trade sector (NAICS 44-45). This industry encompasses establishments primarily engaged in piece goods retailers.
...
graph TD
    ...
    style N45913 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 45913 |
| Level | Industry |
| Parent | [Musical Instrument Retailers](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 45913 |
| Market Segment | Piece Goods Retailers |
...
*Source: NAICS 45913 - Piece Goods Retailers*
