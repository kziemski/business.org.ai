...
> Establishments primarily engaged in book retailers.

## Overview

Book Retailers represents an important category within the Retail Trade sector (NAICS 44-45). This industry group encompasses establishments primarily engaged in book retailers.
...
graph TD
    ...
    style N4592 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 4592 - Book Retailers*
