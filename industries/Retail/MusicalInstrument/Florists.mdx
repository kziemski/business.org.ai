...
> Establishments primarily engaged in florists.

## Overview

Florists represents an important category within the Retail Trade sector (NAICS 44-45). This industry group encompasses establishments primarily engaged in florists.
...
graph TD
    ...
    style N4593 fill:#f96,stroke:#333,stroke-width:2px
```
