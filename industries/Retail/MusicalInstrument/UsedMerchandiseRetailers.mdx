...
> Establishments primarily engaged in used merchandise retailers.

## Overview

Used Merchandise Retailers represents an important category within the Retail Trade sector (NAICS 44-45). This industry group encompasses establishments primarily engaged in used merchandise retailers.
...
graph TD
    ...
    N459 --> N4595["4595: Used Merchandise Retailers"]
    style N4595 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4595 |
| Market Segment | Used Merchandise Retailers |
...
*Source: NAICS 4595 - Used Merchandise Retailers*
