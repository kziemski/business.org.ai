...
Jewelry Stores represents an important category within the Retail Trade sector (SIC 5944).
...
graph TD
    ...
    S4445 --> N5944["5944: Jewelry Stores"]
    style N5944 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 5944 - Jewelry Stores*
