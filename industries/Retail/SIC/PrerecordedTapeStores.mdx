---
id: PrerecordedTapeStores
name: Prerecorded Tape Stores
code: 5735
type: Industry
level: SIC (5735)
status: complete
...
Prerecorded Tape Stores represents an important category within the Retail Trade sector (SIC 5735).
...
graph TD
    ...
    S4445 --> N5735["5735: Prerecorded Tape Stores"]
    style N5735 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5735 |
| Market Segment | Prerecorded Tape Stores |
...
*Source: SIC 5735 - Prerecorded Tape Stores*
