...
Tobacco Stores represents an important category within the Retail Trade sector (SIC 5993).
...
graph TD
    ...
    S4445 --> N5993["5993: Tobacco Stores"]
    style N5993 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 5993 - Tobacco Stores*
