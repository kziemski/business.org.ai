...
home furnishings Stores represents an important category within the Retail Trade sector (SIC 5719).
...
graph TD
    ...
    S4445 --> N5719["5719: home furnishings Stores"]
    style N5719 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5719 |
| Market Segment | home furnishings Stores |
...
*Source: SIC 5719 - home furnishings Stores*
