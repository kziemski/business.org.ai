---
id: BuildingMaterialsDealers
name: Building Materials Dealers
code: 5211
type: Industry
level: SIC (5211)
status: complete
...
Building Materials Dealers represents an important category within the Retail Trade sector (SIC 5211).
...
graph TD
    ...
    S4445 --> N521["521: Monetary Authorities-Central Bank"]
    N521 --> N5211["5211: Building Materials Dealers"]
    style N5211 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5211 |
| Market Segment | Building Materials Dealers |
...
*Source: SIC 5211 - Building Materials Dealers*
