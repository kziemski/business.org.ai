...
Retail Stores represents an important category within the Retail Trade sector (SIC 5999).
...
graph TD
    ...
    S4445 --> N5999["5999: Retail Stores"]
    style N5999 fill:#f96,stroke:#333,stroke-width:2px
```
