...
Vegetable Markets represents an important category within the Retail Trade sector (SIC 5431).
...
graph TD
    ...
    S4445 --> N5431["5431: Vegetable Markets"]
    style N5431 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5431 |
| Market Segment | Vegetable Markets |
...
*Source: SIC 5431 - Vegetable Markets*
