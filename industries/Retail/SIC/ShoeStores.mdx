...
Shoe Stores represents an important category within the Retail Trade sector (SIC 5661).
...
graph TD
    ...
    S4445 --> N5661["5661: Shoe Stores"]
    style N5661 fill:#f96,stroke:#333,stroke-width:2px
```
