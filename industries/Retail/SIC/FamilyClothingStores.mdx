...
Family Clothing Stores represents an important category within the Retail Trade sector (SIC 5651).
...
graph TD
    ...
    S4445 --> N5651["5651: Family Clothing Stores"]
    style N5651 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5651 |
| Market Segment | Family Clothing Stores |
...
*Source: SIC 5651 - Family Clothing Stores*
