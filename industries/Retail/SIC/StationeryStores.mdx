...
Stationery Stores represents an important category within the Retail Trade sector (SIC 5943).
...
graph TD
    ...
    S4445 --> N5943["5943: Stationery Stores"]
    style N5943 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5943 |
| Market Segment | Stationery Stores |
...
*Source: SIC 5943 - Stationery Stores*
