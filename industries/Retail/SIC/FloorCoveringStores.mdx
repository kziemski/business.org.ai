...
Floor Covering Stores represents an important category within the Retail Trade sector (SIC 5713).
...
graph TD
    ...
    S4445 --> N5713["5713: Floor Covering Stores"]
    style N5713 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5713 |
| Market Segment | Floor Covering Stores |
...
*Source: SIC 5713 - Floor Covering Stores*
