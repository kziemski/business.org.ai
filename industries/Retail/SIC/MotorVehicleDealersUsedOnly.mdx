---
id: MotorVehicleDealersUsedOnly
...
Motor Vehicle Dealers (Used Only) represents an important category within the Retail Trade sector (SIC 5521).
...
graph TD
    ...
    S4445 --> N5521["5521: Motor Vehicle Dealers (Used Only)"]
    style N5521 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5521 |
| Market Segment | Motor Vehicle Dealers (Used Only) |
...
*Source: SIC 5521 - Motor Vehicle Dealers (Used Only)*
