...
Fuel Oil Dealers represents an important category within the Retail Trade sector (SIC 5983).
...
graph TD
    ...
    S4445 --> N5983["5983: Fuel Oil Dealers"]
    style N5983 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5983 |
| Market Segment | Fuel Oil Dealers |
...
*Source: SIC 5983 - Fuel Oil Dealers*
