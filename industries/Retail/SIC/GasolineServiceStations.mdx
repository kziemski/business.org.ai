...
Gasoline Service Stations represents an important category within the Retail Trade sector (SIC 5541).
...
graph TD
    ...
    S4445 --> N5541["5541: Gasoline Service Stations"]
    style N5541 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5541 |
| Market Segment | Gasoline Service Stations |
...
*Source: SIC 5541 - Gasoline Service Stations*
