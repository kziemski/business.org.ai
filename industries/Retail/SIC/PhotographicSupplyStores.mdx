---
id: PhotographicSupplyStores
name: Photographic Supply Stores
code: 5946
type: Industry
level: SIC (5946)
status: complete
...
Photographic Supply Stores represents an important category within the Retail Trade sector (SIC 5946).
...
graph TD
    ...
    S4445 --> N5946["5946: Photographic Supply Stores"]
    style N5946 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5946 |
| Market Segment | Photographic Supply Stores |
...
*Source: SIC 5946 - Photographic Supply Stores*
