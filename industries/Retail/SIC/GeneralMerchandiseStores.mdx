...
General Merchandise Stores represents an important category within the Retail Trade sector (SIC 5399).
...
graph TD
    ...
    S4445 --> N5399["5399: General Merchandise Stores"]
    style N5399 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5399 |
| Market Segment | General Merchandise Stores |
...
*Source: SIC 5399 - General Merchandise Stores*
