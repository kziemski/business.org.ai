...
Household Appliance Stores represents an important category within the Retail Trade sector (SIC 5722).
...
graph TD
    ...
    S4445 --> N5722["5722: Household Appliance Stores"]
    style N5722 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5722 |
| Market Segment | Household Appliance Stores |
...
*Source: SIC 5722 - Household Appliance Stores*
