...
Optical Goods Stores represents an important category within the Retail Trade sector (SIC 5995).
...
graph TD
    ...
    S4445 --> N5995["5995: Optical Goods Stores"]
    style N5995 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5995 |
| Market Segment | Optical Goods Stores |
...
*Source: SIC 5995 - Optical Goods Stores*
