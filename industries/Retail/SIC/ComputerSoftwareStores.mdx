...
Computer Software Stores represents an important category within the Retail Trade sector (SIC 5734).
...
graph TD
    ...
    S4445 --> N5734["5734: Computer Software Stores"]
    style N5734 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5734 |
| Market Segment | Computer Software Stores |
...
*Source: SIC 5734 - Computer Software Stores*
