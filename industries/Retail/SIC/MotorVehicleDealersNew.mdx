---
id: MotorVehicleDealersNew
name: Motor Vehicle Dealers (New
code: 5511
type: Industry
level: SIC (5511)
status: complete
...
Motor Vehicle Dealers (New represents an important category within the Retail Trade sector (SIC 5511).
...
graph TD
    ...
    S4445 --> N5511["5511: Motor Vehicle Dealers (New"]
    style N5511 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5511 |
| Market Segment | Motor Vehicle Dealers (New |
...
*Source: SIC 5511 - Motor Vehicle Dealers (New*
