...
Furniture Stores represents an important category within the Retail Trade sector (SIC 5712).
...
graph TD
    ...
    S4445 --> N5712["5712: Furniture Stores"]
    style N5712 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5712 |
| Market Segment | Furniture Stores |
...
*Source: SIC 5712 - Furniture Stores*
