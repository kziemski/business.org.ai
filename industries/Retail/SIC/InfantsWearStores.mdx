---
id: InfantsWearStores
name: Infants' Wear Stores
code: 5641
type: Industry
level: SIC (5641)
status: complete
...
Infants' Wear Stores represents an important category within the Retail Trade sector (SIC 5641).
...
graph TD
    ...
    S4445 --> N5641["5641: Infants' Wear Stores"]
    style N5641 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5641 |
| Market Segment | Infants' Wear Stores |
...
*Source: SIC 5641 - Infants' Wear Stores*
