...
Book Stores represents an important category within the Retail Trade sector (SIC 5942).
...
graph TD
    ...
    S4445 --> N5942["5942: Book Stores"]
    style N5942 fill:#f96,stroke:#333,stroke-width:2px
```
