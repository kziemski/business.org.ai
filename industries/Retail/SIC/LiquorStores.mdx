...
Liquor Stores represents an important category within the Retail Trade sector (SIC 5921).
...
graph TD
    ...
    S4445 --> N5921["5921: Liquor Stores"]
    style N5921 fill:#f96,stroke:#333,stroke-width:2px
```
