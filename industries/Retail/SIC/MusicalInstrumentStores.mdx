...
Musical Instrument Stores represents an important category within the Retail Trade sector (SIC 5736).
...
graph TD
    ...
    S4445 --> N5736["5736: Musical Instrument Stores"]
    style N5736 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5736 |
| Market Segment | Musical Instrument Stores |
...
*Source: SIC 5736 - Musical Instrument Stores*
