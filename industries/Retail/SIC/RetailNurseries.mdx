...
Retail Nurseries represents an important category within the Retail Trade sector (SIC 5261).
...
graph TD
    ...
    S4445 --> N5261["5261: Retail Nurseries"]
    style N5261 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5261 |
| Market Segment | Retail Nurseries |
...
*Source: SIC 5261 - Retail Nurseries*
