...
Used Merchandise Stores represents an important category within the Retail Trade sector (SIC 5932).
...
graph TD
    ...
    S4445 --> N5932["5932: Used Merchandise Stores"]
    style N5932 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5932 |
| Market Segment | Used Merchandise Stores |
...
*Source: SIC 5932 - Used Merchandise Stores*
