...
Food Stores represents an important category within the Retail Trade sector (SIC 5499).
...
graph TD
    ...
    S4445 --> N5499["5499: Food Stores"]
    style N5499 fill:#f96,stroke:#333,stroke-width:2px
```
