...
Mail-Order Houses represents an important category within the Retail Trade sector (SIC 5961).
...
graph TD
    ...
    S4445 --> N5961["5961: Mail-Order Houses"]
    style N5961 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5961 |
| Market Segment | Mail-Order Houses |
...
*Source: SIC 5961 - Mail-Order Houses*
