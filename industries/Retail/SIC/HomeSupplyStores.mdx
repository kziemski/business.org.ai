...
Home Supply Stores represents an important category within the Retail Trade sector (SIC 5531).
...
graph TD
    ...
    S4445 --> N5531["5531: Home Supply Stores"]
    style N5531 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5531 |
| Market Segment | Home Supply Stores |
...
*Source: SIC 5531 - Home Supply Stores*
