...
Specialty Stores represents an important category within the Retail Trade sector (SIC 5632).
...
graph TD
    ...
    S4445 --> N5632["5632: Specialty Stores"]
...
| NAICS/SIC Code | 5632 |
| Market Segment | Specialty Stores |
...
*Source: SIC 5632 - Specialty Stores*
