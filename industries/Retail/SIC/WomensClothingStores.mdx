...
Women's Clothing Stores represents an important category within the Retail Trade sector (SIC 5621).
...
graph TD
    ...
    S4445 --> N5621["5621: Women's Clothing Stores"]
...
| NAICS/SIC Code | 5621 |
| Market Segment | Women's Clothing Stores |
...
*Source: SIC 5621 - Women's Clothing Stores*
