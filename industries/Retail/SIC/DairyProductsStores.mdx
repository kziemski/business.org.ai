...
Dairy Products Stores represents an important category within the Retail Trade sector (SIC 5451).
...
graph TD
    ...
    S4445 --> N5451["5451: Dairy Products Stores"]
    style N5451 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5451 |
| Market Segment | Dairy Products Stores |
...
*Source: SIC 5451 - Dairy Products Stores*
