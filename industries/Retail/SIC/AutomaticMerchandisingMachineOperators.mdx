---
id: AutomaticMerchandisingMachineOperators
...
Automatic Merchandising Machine Operators represents an important category within the Retail Trade sector (SIC 5962).
...
graph TD
    ...
    S4445 --> N5962["5962: Automatic Merchandising Machine Opera..."]
    style N5962 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5962 |
| Market Segment | Automatic Merchandising Machine Operators |
...
*Source: SIC 5962 - Automatic Merchandising Machine Operators*
