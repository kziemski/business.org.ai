...
Fish (Seafood) Markets represents an important category within the Retail Trade sector (SIC 5421).
...
graph TD
    ...
    S4445 --> N5421["5421: Fish (Seafood) Markets"]
    style N5421 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5421 |
| Market Segment | Fish (Seafood) Markets |
...
*Source: SIC 5421 - Fish (Seafood) Markets*
