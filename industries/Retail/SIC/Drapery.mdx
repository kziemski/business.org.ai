...
Drapery represents an important category within the Retail Trade sector (SIC 5714).
...
graph TD
    ...
    S4445 --> N5714["5714: Drapery"]
    style N5714 fill:#f96,stroke:#333,stroke-width:2px
```
