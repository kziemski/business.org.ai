...
Newsstands represents an important category within the Retail Trade sector (SIC 5994).
...
graph TD
    ...
    S4445 --> N5994["5994: Newsstands"]
    style N5994 fill:#f96,stroke:#333,stroke-width:2px
```
