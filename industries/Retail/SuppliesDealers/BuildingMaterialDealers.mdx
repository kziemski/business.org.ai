---
id: BuildingMaterialDealers
name: Building Material Dealers
code: 44418
type: Industry
level: Industry
status: complete
...
Building Material Dealers represents an important category within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    S4445 --> N444["444: Building Material"]
    N444 --> N44418["44418: Building Material Dealers"]
    style N44418 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 44418 |
| Market Segment | Building Material Dealers |
...
*Source: NAICS 44418 - Building Material Dealers*
