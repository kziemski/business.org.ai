...
Home Centers represents an important category within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    N444 --> N44411["44411: Home Centers"]
    style N44411 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 44411 |
| Market Segment | Home Centers |
...
*Source: NAICS 44411 - Home Centers*
