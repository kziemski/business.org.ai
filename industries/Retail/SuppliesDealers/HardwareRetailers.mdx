...
Hardware Retailers represents an important category within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    N444 --> N44414["44414: Hardware Retailers"]
    style N44414 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 44414 |
| Market Segment | Hardware Retailers |
...
*Source: NAICS 44414 - Hardware Retailers*
