...
Home Furnishings represents an important category within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    N449 --> N4492["4492: Towing"]
    N449 --> N4492["4492: Tugboat Services"]
    N449 --> N4499["4499: Water Transportation Services"]
```
...
*Source: NAICS 449 - Home Furnishings*
