---
id: FarmSupplyRetailers
name: Farm Supply Retailers
code: 44424
type: Industry
level: Industry
status: complete
...
Farm Supply Retailers represents an important category within the Retail Trade sector (NAICS 44-45). This industry encompasses establishments primarily engaged in farm supply retailers.
...
graph TD
    ...
    style N44424 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 44424 |
| Market Segment | Farm Supply Retailers |
...
*Source: NAICS 44424 - Farm Supply Retailers*
