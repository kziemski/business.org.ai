...
Used Car Dealers represents an important category within the Retail Trade sector (NAICS 44-45). This industry encompasses establishments primarily engaged in used car dealers.
...
graph TD
    ...
    style N44112 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 44112 |
| Market Segment | Used Car Dealers |
...
*Source: NAICS 44112 - Used Car Dealers*
