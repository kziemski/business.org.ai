...
Grocery Retailers represents an important category within the Retail Trade sector (NAICS 44-45). This industry encompasses establishments primarily engaged in grocery retailers.
...
graph TD
    ...
    style N44511 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 44511 |
| Market Segment | Grocery Retailers |
...
*Source: NAICS 44511 - Grocery Retailers*
