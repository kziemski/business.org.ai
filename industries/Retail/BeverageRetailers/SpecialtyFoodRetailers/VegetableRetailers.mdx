---
id: VegetableRetailers
name: Vegetable Retailers
code: 44523
type: Industry
level: Industry
status: complete
...
Vegetable Retailers represents an important category within the Retail Trade sector (NAICS 44-45). This industry encompasses establishments primarily engaged in vegetable retailers.
...
graph TD
    ...
    style N44523 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 44523 |
| Level | Industry |
| Parent | [Specialty Food Retailers](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 44523 |
| Market Segment | Vegetable Retailers |
...
*Source: NAICS 44523 - Vegetable Retailers*
