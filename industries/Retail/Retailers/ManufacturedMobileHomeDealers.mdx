---
id: ManufacturedMobileHomeDealers
...
Manufactured (Mobile) Home Dealers represents an important category within the Retail Trade sector (NAICS 44-45).
...
graph TD
    ...
    N459 --> N45993["45993: Manufactured (Mobile) Home Dealers"]
    style N45993 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 45993 |
| Market Segment | Manufactured (Mobile) Home Dealers |
...
*Source: NAICS 45993 - Manufactured (Mobile) Home Dealers*
