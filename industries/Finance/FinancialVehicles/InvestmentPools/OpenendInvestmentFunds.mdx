...
Open-End Investment Funds represents an important category within the Finance and Insurance sector (NAICS 52). This industry encompasses establishments primarily engaged in open-end investment funds.
...
graph TD
    ...
    style N52591 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 52591 |
| Market Segment | Open-End Investment Funds |
...
*Source: NAICS 52591 - Open-End Investment Funds*
