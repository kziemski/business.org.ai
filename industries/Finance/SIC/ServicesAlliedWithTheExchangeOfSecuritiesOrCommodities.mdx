---
id: ServicesAlliedWithTheExchangeOfSecuritiesOrCommodities
name: Services Allied With the Exchange of Securities or Commodities
code: 6289
type: Industry
level: SIC (6289)
status: complete
...
Services Allied With the Exchange of Securities or Commodities represents an important category within the Finance and Insurance sector (SIC 6289).
...
graph TD
    ...
    S52 --> N6289["6289: Services Allied With the Exchange of ..."]
    style N6289 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6289 |
| Market Segment | Services Allied With the Exchange of Securities or Commodities |
...
*Source: SIC 6289 - Services Allied With the Exchange of Securities or Commodities*
