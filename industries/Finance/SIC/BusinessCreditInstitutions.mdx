---
id: BusinessCreditInstitutions
name: business Credit Institutions
code: 6159
type: Industry
level: SIC (6159)
status: complete
...
business Credit Institutions represents an important category within the Finance and Insurance sector (SIC 6159).
...
graph TD
    ...
    S52 --> N6159["6159: business Credit Institutions"]
    style N6159 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6159 |
| Market Segment | business Credit Institutions |
...
*Source: SIC 6159 - business Credit Institutions*
