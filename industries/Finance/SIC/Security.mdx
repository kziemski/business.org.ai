...
Security represents an important category within the Finance and Insurance sector (SIC 6231).
...
graph TD
    ...
    S52 --> N623["623: Nursing"]
    N623 --> N6231["6231: Security"]
