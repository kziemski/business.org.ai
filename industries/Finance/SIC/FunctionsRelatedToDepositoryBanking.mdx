---
id: FunctionsRelatedToDepositoryBanking
...
Functions Related to Depository Banking represents an important category within the Finance and Insurance sector (SIC 6099).
...
graph TD
    ...
    S52 --> N6099["6099: Functions Related to Depository Banking"]
    style N6099 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6099 |
| Market Segment | Functions Related to Depository Banking |
...
*Source: SIC 6099 - Functions Related to Depository Banking*
