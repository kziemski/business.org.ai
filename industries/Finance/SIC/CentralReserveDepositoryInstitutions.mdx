---
id: CentralReserveDepositoryInstitutions
name: Central Reserve Depository Institutions
code: 6019
type: Industry
level: SIC (6019)
status: complete
...
Central Reserve Depository Institutions represents an important category within the Finance and Insurance sector (SIC 6019).
...
graph TD
    ...
    S52 --> N6019["6019: Central Reserve Depository Institutions"]
    style N6019 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6019 |
| Market Segment | Central Reserve Depository Institutions |
...
*Source: SIC 6019 - Central Reserve Depository Institutions*
