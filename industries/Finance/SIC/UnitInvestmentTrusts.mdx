---
id: UnitInvestmentTrusts
name: Unit Investment Trusts
code: 6726
type: Industry
level: SIC (6726)
status: complete
...
Unit Investment Trusts represents an important category within the Finance and Insurance sector (SIC 6726).
...
graph TD
    ...
    S52 --> N6726["6726: Unit Investment Trusts"]
    style N6726 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6726 |
| Market Segment | Unit Investment Trusts |
...
*Source: SIC 6726 - Unit Investment Trusts*
