...
Fire represents an important category within the Finance and Insurance sector (SIC 6331).
...
graph TD
    ...
    S52 --> N6331["6331: Fire"]
    style N6331 fill:#f96,stroke:#333,stroke-width:2px
```
