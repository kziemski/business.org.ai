---
id: ManagementInvestmentOffices
name: Management Investment Offices
code: 6722
type: Industry
level: SIC (6722)
status: complete
...
Management Investment Offices represents an important category within the Finance and Insurance sector (SIC 6722).
...
graph TD
    ...
    S52 --> N6722["6722: Management Investment Offices"]
    style N6722 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6722 |
| Market Segment | Management Investment Offices |
...
*Source: SIC 6722 - Management Investment Offices*
