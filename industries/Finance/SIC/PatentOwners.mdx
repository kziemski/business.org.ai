...
Patent Owners represents an important category within the Finance and Insurance sector (SIC 6794).
...
graph TD
    ...
    S52 --> N6794["6794: Patent Owners"]
    style N6794 fill:#f96,stroke:#333,stroke-width:2px
```
