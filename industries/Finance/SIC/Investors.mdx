...
Investors represents an important category within the Finance and Insurance sector (SIC 6799).
...
graph TD
    ...
    S52 --> N6799["6799: Investors"]
    style N6799 fill:#f96,stroke:#333,stroke-width:2px
```
