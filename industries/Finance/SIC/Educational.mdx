...
Educational represents an important category within the Finance and Insurance sector (SIC 6732).
...
graph TD
    ...
    S52 --> N6732["6732: Educational"]
    style N6732 fill:#f96,stroke:#333,stroke-width:2px
```
