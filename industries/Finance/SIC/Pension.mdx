...
Pension represents an important category within the Finance and Insurance sector (SIC 6371).
...
graph TD
    ...
    S52 --> N6371["6371: Pension"]
    style N6371 fill:#f96,stroke:#333,stroke-width:2px
```
