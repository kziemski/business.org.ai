...
Loan Brokers represents an important category within the Finance and Insurance sector (SIC 6163).
...
graph TD
    ...
    S52 --> N6163["6163: Loan Brokers"]
    style N6163 fill:#f96,stroke:#333,stroke-width:2px
```
