---
id: MedicalServicePlans
name: Medical Service Plans
code: 6324
type: Industry
level: SIC (6324)
status: complete
...
Medical Service Plans represents an important category within the Finance and Insurance sector (SIC 6324).
...
graph TD
    ...
    S52 --> N6324["6324: Medical Service Plans"]
    style N6324 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6324 |
| Market Segment | Medical Service Plans |
...
*Source: SIC 6324 - Medical Service Plans*
