...
Insurance Agents represents an important category within the Finance and Insurance sector (SIC 6411).
...
graph TD
    ...
    S52 --> N6411["6411: Insurance Agents"]
    style N6411 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6411 |
| Market Segment | Insurance Agents |
...
*Source: SIC 6411 - Insurance Agents*
