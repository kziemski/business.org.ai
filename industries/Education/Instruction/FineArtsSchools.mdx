...
Fine Arts Schools represents an important category within the Educational Services sector (NAICS 61).
...
graph TD
    ...
    style N61161 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 61161 |
| Market Segment | Fine Arts Schools |
...
*Source: NAICS 61161 - Fine Arts Schools*
