...
Language Schools represents an important category within the Educational Services sector (NAICS 61).
...
graph TD
    ...
    style N61163 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 61163 |
| Market Segment | Language Schools |
...
*Source: NAICS 61163 - Language Schools*
