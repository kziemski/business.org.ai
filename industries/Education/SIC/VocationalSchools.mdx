...
Vocational Schools represents an important category within the Educational Services sector (SIC 8249).
...
graph TD
    ...
    S61 --> N8249["8249: Vocational Schools"]
    style N8249 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8249 |
| Market Segment | Vocational Schools |
...
*Source: SIC 8249 - Vocational Schools*
