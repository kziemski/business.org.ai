...
Computer Training represents an important category within the Educational Services sector (NAICS 61).
...
graph TD
    ...
    style N61142 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 61142 |
| Market Segment | Computer Training |
...
*Source: NAICS 61142 - Computer Training*
