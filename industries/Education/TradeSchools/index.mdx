...
> Establishments primarily engaged in trade schools.

## Overview

Trade Schools represents an important category within the Educational Services sector (NAICS 61).
...
graph TD
    ...
    S61 --> N6115["6115: Trade Schools"]
    style N6115 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 6115 - Trade Schools*
