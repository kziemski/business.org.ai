...
Apprenticeship Training represents a specialized segment within the Educational Services sector (NAICS 61).

This U.S. industry comprises establishments primarily engaged in offering apprenticeship training programs. These programs involve applied training as well as course work. Cross-References.
...
graph TD
    ...
    N6115 --> N611513["611513: Apprenticeship Training"]
    style N611513 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 611513 |
| Market Segment | Apprenticeship Training |
...
*Source: NAICS 611513 - Apprenticeship Training*
