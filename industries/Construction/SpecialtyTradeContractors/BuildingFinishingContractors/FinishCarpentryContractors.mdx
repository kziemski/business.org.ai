...
Finish Carpentry Contractors represents an important category within the Construction sector (NAICS 23). This industry encompasses establishments primarily engaged in finish carpentry contractors.
...
graph TD
    ...
    style N23835 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 23835 - Finish Carpentry Contractors*
