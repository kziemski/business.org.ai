...
Poured Concrete Foundation represents an important category within the Construction sector (NAICS 23). This industry encompasses establishments primarily engaged in poured concrete foundation.
...
graph TD
    ...
    style N23811 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 23811 - Poured Concrete Foundation*
