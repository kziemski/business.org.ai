...
Institutional Building Construction represents an important category within the Construction sector (NAICS 23). This industry encompasses establishments primarily engaged in institutional building construction.
...
graph TD
    ...
    style N23622 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 23622 - Institutional Building Construction*
