...
Bridge represents an important category within the Construction sector (SIC 1622).
...
graph TD
    S23["23: Construction"]
    S23 --> N1622["1622: Bridge"]
    style N1622 fill:#f96,stroke:#333,stroke-width:2px
```
