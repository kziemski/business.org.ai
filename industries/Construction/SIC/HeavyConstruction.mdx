...
Heavy Construction represents an important category within the Construction sector (SIC 1629).
...
graph TD
    S23["23: Construction"]
    S23 --> N1629["1629: Heavy Construction"]
    style N1629 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1629 |
| Market Segment | Heavy Construction |
...
*Source: SIC 1629 - Heavy Construction*
