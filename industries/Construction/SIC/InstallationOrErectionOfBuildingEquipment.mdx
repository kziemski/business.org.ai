---
id: InstallationOrErectionOfBuildingEquipment
name: Installation or Erection of Building Equipment
code: 1796
type: Industry
level: SIC (1796)
status: complete
...
Installation or Erection of Building Equipment represents an important category within the Construction sector (SIC 1796).
...
graph TD
    S23["23: Construction"]
    S23 --> N1796["1796: Installation or Erection of Building ..."]
    style N1796 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1796 |
| Market Segment | Installation or Erection of Building Equipment |
...
*Source: SIC 1796 - Installation or Erection of Building Equipment*
