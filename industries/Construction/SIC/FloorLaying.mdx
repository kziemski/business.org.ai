...
Floor Laying represents an important category within the Construction sector (SIC 1752).
...
graph TD
    S23["23: Construction"]
    S23 --> N1752["1752: Floor Laying"]
    style N1752 fill:#f96,stroke:#333,stroke-width:2px
```
