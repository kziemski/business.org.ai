...
Terrazzo represents an important category within the Construction sector (SIC 1743).
...
graph TD
    S23["23: Construction"]
    S23 --> N1743["1743: Terrazzo"]
    style N1743 fill:#f96,stroke:#333,stroke-width:2px
```
