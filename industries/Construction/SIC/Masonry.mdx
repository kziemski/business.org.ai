...
Masonry represents an important category within the Construction sector (SIC 1741).
...
graph TD
    S23["23: Construction"]
    S23 --> N1741["1741: Masonry"]
    style N1741 fill:#f96,stroke:#333,stroke-width:2px
```
