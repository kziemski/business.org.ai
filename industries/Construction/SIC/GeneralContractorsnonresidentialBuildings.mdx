---
id: GeneralContractorsNonresidentialBuildings
...
General Contractors-Nonresidential Buildings represents an important category within the Construction sector (SIC 1542).
...
graph TD
    S23["23: Construction"]
    S23 --> N1542["1542: General Contractors-Nonresidential Bu..."]
    style N1542 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1542 |
| Market Segment | General Contractors-Nonresidential Buildings |
...
*Source: SIC 1542 - General Contractors-Nonresidential Buildings*
