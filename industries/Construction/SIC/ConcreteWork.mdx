...
Concrete Work represents an important category within the Construction sector (SIC 1771).
...
graph TD
    S23["23: Construction"]
    S23 --> N1771["1771: Concrete Work"]
    style N1771 fill:#f96,stroke:#333,stroke-width:2px
```
