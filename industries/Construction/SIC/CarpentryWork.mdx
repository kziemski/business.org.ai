...
Carpentry Work represents an important category within the Construction sector (SIC 1751).
...
graph TD
    S23["23: Construction"]
    S23 --> N1751["1751: Carpentry Work"]
    style N1751 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 1751 - Carpentry Work*
