...
Electrical Work represents an important category within the Construction sector (SIC 1731).
...
graph TD
    S23["23: Construction"]
    S23 --> N1731["1731: Electrical Work"]
    style N1731 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1731 |
| Market Segment | Electrical Work |
...
*Source: SIC 1731 - Electrical Work*
