---
id: GeneralContractorsSingleFamilyHouses
...
General Contractors-Single-Family Houses represents an important category within the Construction sector (SIC 1521).
...
graph TD
    S23["23: Construction"]
    S23 --> N1521["1521: General Contractors-Single-Family Houses"]
    style N1521 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1521 |
| Market Segment | General Contractors-Single-Family Houses |
...
*Source: SIC 1521 - General Contractors-Single-Family Houses*
