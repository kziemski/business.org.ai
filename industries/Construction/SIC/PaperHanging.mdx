...
Paper Hanging represents an important category within the Construction sector (SIC 1721).
...
graph TD
    S23["23: Construction"]
    S23 --> N1721["1721: Paper Hanging"]
    style N1721 fill:#f96,stroke:#333,stroke-width:2px
```
