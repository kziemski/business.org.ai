---
id: GeneralContractorsResidentialBuildings
...
General Contractors-Residential Buildings represents an important category within the Construction sector (SIC 1522).
...
graph TD
    S23["23: Construction"]
    S23 --> N1522["1522: General Contractors-Residential Build..."]
    style N1522 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1522 |
| Market Segment | General Contractors-Residential Buildings |
...
*Source: SIC 1522 - General Contractors-Residential Buildings*
