...
Operative Builders represents an important category within the Construction sector (SIC 1531).
...
graph TD
    S23["23: Construction"]
    S23 --> N1531["1531: Operative Builders"]
    style N1531 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1531 |
| Market Segment | Operative Builders |
...
*Source: SIC 1531 - Operative Builders*
