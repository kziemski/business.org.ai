---
id: GeneralContractorsIndustrialBuildings
...
General Contractors-Industrial Buildings represents an important category within the Construction sector (SIC 1541).
...
graph TD
    S23["23: Construction"]
    S23 --> N1541["1541: General Contractors-Industrial Buildings"]
    style N1541 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1541 |
| Market Segment | General Contractors-Industrial Buildings |
...
*Source: SIC 1541 - General Contractors-Industrial Buildings*
