...
Plastering represents an important category within the Construction sector (SIC 1742).
...
graph TD
    S23["23: Construction"]
    S23 --> N1742["1742: Plastering"]
    style N1742 fill:#f96,stroke:#333,stroke-width:2px
```
