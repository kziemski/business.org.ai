...
Glazing Work represents an important category within the Construction sector (SIC 1793).
...
graph TD
    S23["23: Construction"]
    S23 --> N1793["1793: Glazing Work"]
    style N1793 fill:#f96,stroke:#333,stroke-width:2px
```
