...
Excavation Work represents an important category within the Construction sector (SIC 1794).
...
graph TD
    S23["23: Construction"]
    S23 --> N1794["1794: Excavation Work"]
    style N1794 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1794 |
| Market Segment | Excavation Work |
...
*Source: SIC 1794 - Excavation Work*
