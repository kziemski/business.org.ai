...
Structural Steel Erection represents an important category within the Construction sector (SIC 1791).
...
graph TD
    S23["23: Construction"]
    S23 --> N1791["1791: Structural Steel Erection"]
    style N1791 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1791 |
| Market Segment | Structural Steel Erection |
...
*Source: SIC 1791 - Structural Steel Erection*
