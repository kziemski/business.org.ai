...
name: "Related Structures Construction"
code: "23711"
type: Industry
level: Industry
status: complete
...
Related Structures Construction represents an important category within the Construction sector (NAICS 23). This industry encompasses establishments primarily engaged in related structures construction.
...
*Source: NAICS 23711 - Related Structures Construction*
