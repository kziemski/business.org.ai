...
Gas Pipeline represents an important category within the Construction sector (NAICS 23). This industry encompasses establishments primarily engaged in gas pipeline.
...
graph TD
    ...
    style N23712 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 23712 - Gas Pipeline*
