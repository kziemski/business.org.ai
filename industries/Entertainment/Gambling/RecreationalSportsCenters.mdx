---
id: RecreationalSportsCenters
name: Recreational Sports Centers
code: 71394
type: Industry
level: Industry
status: complete
...
Recreational Sports Centers represents an important category within the Arts, Entertainment, and Recreation sector (NAICS 71).
...
graph TD
    ...
    S71 --> N713["713: Amusement"]
    N713 --> N71394["71394: Recreational Sports Centers"]
    style N71394 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 71394 |
| Market Segment | Recreational Sports Centers |
...
*Source: NAICS 71394 - Recreational Sports Centers*
