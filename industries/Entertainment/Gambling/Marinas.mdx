...
Marinas represents an important category within the Arts, Entertainment, and Recreation sector (NAICS 71).
...
graph TD
    ...
    N713 --> N71393["71393: Marinas"]
    style N71393 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 71393 |
| Market Segment | Marinas |
