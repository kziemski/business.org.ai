...
Country Clubs represents an important category within the Arts, Entertainment, and Recreation sector (NAICS 71).
...
graph TD
    ...
    N713 --> N71391["71391: Country Clubs"]
    style N71391 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 71391 |
| Market Segment | Country Clubs |
...
*Source: NAICS 71391 - Country Clubs*
