...
> Establishments primarily engaged in agents and managers.

## Overview

Agents and Managers represents an important category within the Arts, Entertainment, and Recreation sector (NAICS 71). This industry group encompasses establishments primarily engaged in agents and managers.
...
graph TD
    ...
    style N7114 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7114 |
| Market Segment | Agents and Managers |
...
*Source: NAICS 7114 - Agents and Managers*
