...
Musical Groups represents an important category within the Arts, Entertainment, and Recreation sector (NAICS 71). This industry encompasses establishments primarily engaged in musical groups.
...
graph TD
    ...
    style N71113 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 71113 |
| Market Segment | Musical Groups |
...
*Source: NAICS 71113 - Musical Groups*
