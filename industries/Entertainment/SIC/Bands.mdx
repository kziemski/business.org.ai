...
Bands represents an important category within the Arts, Entertainment, and Recreation sector (SIC 7929).
...
graph TD
    ...
    S71 --> N7929["7929: Bands"]
    style N7929 fill:#f96,stroke:#333,stroke-width:2px
```
