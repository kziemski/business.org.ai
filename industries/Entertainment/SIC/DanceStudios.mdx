...
Dance Studios represents an important category within the Arts, Entertainment, and Recreation sector (SIC 7911).
...
graph TD
    ...
    S71 --> N7911["7911: Dance Studios"]
    style N7911 fill:#f96,stroke:#333,stroke-width:2px
```
