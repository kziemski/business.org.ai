---
id: VideoTapeDistribution
name: Video Tape Distribution
code: 7822
type: Industry
level: SIC (7822)
status: complete
...
Video Tape Distribution represents an important category within the Arts, Entertainment, and Recreation sector (SIC 7822).
...
graph TD
    ...
    S71 --> N7822["7822: Video Tape Distribution"]
    style N7822 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7822 |
| Market Segment | Video Tape Distribution |
...
*Source: SIC 7822 - Video Tape Distribution*
