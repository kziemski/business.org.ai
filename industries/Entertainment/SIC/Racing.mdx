...
Racing represents an important category within the Arts, Entertainment, and Recreation sector (SIC 7948).
...
graph TD
    ...
    S71 --> N7948["7948: Racing"]
    style N7948 fill:#f96,stroke:#333,stroke-width:2px
```
