---
id: TheatricalProducers
name: Theatrical Producers (
code: 7922
type: Industry
level: SIC (7922)
status: complete
...
Theatrical Producers ( represents an important category within the Arts, Entertainment, and Recreation sector (SIC 7922).
...
graph TD
    ...
    S71 --> N7922["7922: Theatrical Producers ("]
    style N7922 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7922 |
| Market Segment | Theatrical Producers ( |
...
*Source: SIC 7922 - Theatrical Producers (*
