---
id: VideoTapeProduction
name: Video Tape Production
code: 7812
type: Industry
level: SIC (7812)
status: complete
...
Video Tape Production represents an important category within the Arts, Entertainment, and Recreation sector (SIC 7812).
...
graph TD
    ...
    S71 --> N7812["7812: Video Tape Production"]
    style N7812 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7812 |
| Market Segment | Video Tape Production |
...
*Source: SIC 7812 - Video Tape Production*
