...
Recreation Services represents an important category within the Arts, Entertainment, and Recreation sector (SIC 7999).
...
graph TD
    ...
    S71 --> N7999["7999: Recreation Services"]
    style N7999 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7999 |
| Market Segment | Recreation Services |
...
*Source: SIC 7999 - Recreation Services*
