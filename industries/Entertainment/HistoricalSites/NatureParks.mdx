...
Nature Parks represents an important category within the Arts, Entertainment, and Recreation sector (NAICS 71).
...
graph TD
    ...
    N712 --> N71219["71219: Nature Parks"]
    style N71219 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 71219 |
| Market Segment | Nature Parks |
...
*Source: NAICS 71219 - Nature Parks*
