...
Botanical Gardens represents an important category within the Arts, Entertainment, and Recreation sector (NAICS 71).
...
graph TD
    ...
    S71 --> N712["712: Museums"]
    N712 --> N71213["71213: Botanical Gardens"]
    style N71213 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 71213 |
| Market Segment | Botanical Gardens |
...
*Source: NAICS 71213 - Botanical Gardens*
