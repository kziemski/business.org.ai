...
Human Rights Organizations represents a specialized segment within the Other Services (except Public Administration) sector (NAICS 81).
...
graph TD
    ...
    N8133 --> N813311["813311: Human Rights Organizations"]
    style N813311 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 813311 - Human Rights Organizations*
