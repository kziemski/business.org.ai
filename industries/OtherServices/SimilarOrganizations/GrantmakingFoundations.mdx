...
Grantmaking Foundations represents a specialized segment within the Other Services (except Public Administration) sector (NAICS 81).
...
graph TD
    ...
    N8132 --> N813211["813211: Grantmaking Foundations"]
    style N813211 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 813211 - Grantmaking Foundations*
