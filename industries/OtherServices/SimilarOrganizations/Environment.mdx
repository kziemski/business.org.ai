...
Environment represents a specialized segment within the Other Services (except Public Administration) sector (NAICS 81).
...
graph TD
    ...
    N8133 --> N813312["813312: Environment"]
...
*Source: NAICS 813312 - Environment*
