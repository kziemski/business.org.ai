---
id: TelevisionRepairShops
name: Television Repair Shops
code: 7622
type: Industry
level: SIC (7622)
status: complete
...
Television Repair Shops represents an important category within the Other Services (except Public Administration) sector (SIC 7622).
...
graph TD
    ...
    S81 --> N7622["7622: Television Repair Shops"]
    style N7622 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7622 |
| Market Segment | Television Repair Shops |
...
*Source: SIC 7622 - Television Repair Shops*
