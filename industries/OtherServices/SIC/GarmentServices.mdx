...
Garment Services represents an important category within the Other Services (except Public Administration) sector (SIC 7219).
...
graph TD
    ...
    S81 --> N7219["7219: Garment Services"]
    style N7219 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7219 |
| Market Segment | Garment Services |
...
*Source: SIC 7219 - Garment Services*
