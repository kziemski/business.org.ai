...
Carwashes represents an important category within the Other Services (except Public Administration) sector (SIC 7542).
...
graph TD
    ...
    S81 --> N7542["7542: Carwashes"]
    style N7542 fill:#f96,stroke:#333,stroke-width:2px
```
