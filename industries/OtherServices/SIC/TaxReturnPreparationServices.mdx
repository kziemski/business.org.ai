---
id: TaxReturnPreparationServices
...
Tax Return Preparation Services represents an important category within the Other Services (except Public Administration) sector (SIC 7291).
...
graph TD
    ...
    S81 --> N7291["7291: Tax Return Preparation Services"]
    style N7291 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7291 |
| Market Segment | Tax Return Preparation Services |
...
*Source: SIC 7291 - Tax Return Preparation Services*
