...
Photographic Studios represents an important category within the Other Services (except Public Administration) sector (SIC 7221).
...
graph TD
    ...
    S81 --> N722["722: Drinking Places"]
    N722 --> N7221["7221: Photographic Studios"]
    style N7221 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7221 |
| Market Segment | Photographic Studios |
...
*Source: SIC 7221 - Photographic Studios*
