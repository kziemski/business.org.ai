...
Automotive Services represents an important category within the Other Services (except Public Administration) sector (SIC 7549).
...
graph TD
    ...
    S81 --> N7549["7549: Automotive Services"]
    style N7549 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7549 |
| Market Segment | Automotive Services |
...
*Source: SIC 7549 - Automotive Services*
