...
Power Laundries represents an important category within the Other Services (except Public Administration) sector (SIC 7211).
...
graph TD
    ...
    S81 --> N7211["7211: Power Laundries"]
...
| NAICS/SIC Code | 7211 |
| Market Segment | Power Laundries |
...
*Source: SIC 7211 - Power Laundries*
