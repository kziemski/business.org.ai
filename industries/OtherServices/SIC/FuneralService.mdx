...
Funeral Service represents an important category within the Other Services (except Public Administration) sector (SIC 7261).
...
graph TD
    ...
    S81 --> N7261["7261: Funeral Service"]
    style N7261 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7261 |
| Market Segment | Funeral Service |
...
*Source: SIC 7261 - Funeral Service*
