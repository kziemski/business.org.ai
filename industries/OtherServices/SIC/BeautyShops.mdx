...
Beauty Shops represents an important category within the Other Services (except Public Administration) sector (SIC 7231).
...
graph TD
    ...
    S81 --> N7231["7231: Beauty Shops"]
    style N7231 fill:#f96,stroke:#333,stroke-width:2px
```
