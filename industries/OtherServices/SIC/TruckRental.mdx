...
Truck Rental represents an important category within the Other Services (except Public Administration) sector (SIC 7513).
...
graph TD
    ...
    S81 --> N7513["7513: Truck Rental"]
    style N7513 fill:#f96,stroke:#333,stroke-width:2px
```
