...
Air-Conditioning Service represents an important category within the Other Services (except Public Administration) sector (SIC 7623).
...
graph TD
    ...
    S81 --> N7623["7623: Air-Conditioning Service"]
    style N7623 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7623 |
| Market Segment | Air-Conditioning Service |
...
*Source: SIC 7623 - Air-Conditioning Service*
