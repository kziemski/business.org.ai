...
Art Galleries represents an important category within the Other Services (except Public Administration) sector (SIC 8412).
...
graph TD
    ...
    S81 --> N8412["8412: Art Galleries"]
    style N8412 fill:#f96,stroke:#333,stroke-width:2px
```
