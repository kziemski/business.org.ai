...
Armature Rewinding Shops represents an important category within the Other Services (except Public Administration) sector (SIC 7694).
...
graph TD
    ...
    S81 --> N7694["7694: Armature Rewinding Shops"]
    style N7694 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7694 |
| Market Segment | Armature Rewinding Shops |
...
*Source: SIC 7694 - Armature Rewinding Shops*
