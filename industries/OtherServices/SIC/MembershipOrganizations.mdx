...
Membership Organizations represents an important category within the Other Services (except Public Administration) sector (SIC 8699).
...
graph TD
    ...
    S81 --> N8699["8699: Membership Organizations"]
    style N8699 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8699 |
| Market Segment | Membership Organizations |
...
*Source: SIC 8699 - Membership Organizations*
