---
id: ProfessionalMembershipOrganizations
...
Professional Membership Organizations represents an important category within the Other Services (except Public Administration) sector (SIC 8621).
...
graph TD
    ...
    S81 --> N8621["8621: Professional Membership Organizations"]
    style N8621 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8621 |
| Market Segment | Professional Membership Organizations |
...
*Source: SIC 8621 - Professional Membership Organizations*
