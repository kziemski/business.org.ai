...
Pet Care (except Veterinary) Services represents an important category within the Other Services (except Public Administration) sector (NAICS 81). This industry encompasses establishments primarily engaged in pet care (.
...
graph TD
    ...
    N8129 --> N81291["81291: Pet Care (except Veterinary) Services"]
    style N81291 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 81291 |
| Market Segment | Pet Care (except Veterinary) Services |
...
*Source: NAICS 81291 - Pet Care (except Veterinary) Services*
