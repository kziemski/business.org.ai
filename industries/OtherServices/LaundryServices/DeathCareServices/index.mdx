...
Death Care Services represents an important category within the Other Services (except Public Administration) sector (NAICS 81). This industry group encompasses establishments primarily engaged in death care services.
...
graph TD
    ...
    style N8122 fill:#f96,stroke:#333,stroke-width:2px
    N8122 --> N81221["81221: Funeral Services"]
    N8122 --> N81222["81222: Crematories"]
```
...
|----------|------|-------------|
| [Funeral Services](./FuneralServices/) | 81221 | See industry description for 812210 |
| [Crematories](./Crematories/) | 81222 | See industry description for 812220 |
...
*Source: NAICS 8122 - Death Care Services*
