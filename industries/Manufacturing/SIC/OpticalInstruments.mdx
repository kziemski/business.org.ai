...
Optical Instruments represents an important category within the Manufacturing sector (SIC 3827).
...
graph TD
    ...
    S3133 --> N3827["3827: Optical Instruments"]
    style N3827 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3827 |
| Market Segment | Optical Instruments |
...
*Source: SIC 3827 - Optical Instruments*
