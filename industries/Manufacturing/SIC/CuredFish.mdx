...
Cured Fish represents an important category within the Manufacturing sector (SIC 2091).
...
graph TD
    ...
    S3133 --> N2091["2091: Cured Fish"]
    style N2091 fill:#f96,stroke:#333,stroke-width:2px
```
