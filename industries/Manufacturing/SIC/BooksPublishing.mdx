...
Books: Publishing represents an important category within the Manufacturing sector (SIC 2731).
...
graph TD
    ...
    S3133 --> N2731["2731: Books: Publishing"]
    style N2731 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2731 |
| Market Segment | Books: Publishing |
...
*Source: SIC 2731 - Books: Publishing*
