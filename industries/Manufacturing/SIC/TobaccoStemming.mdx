...
Tobacco Stemming represents an important category within the Manufacturing sector (SIC 2141).
...
graph TD
    ...
    S3133 --> N2141["2141: Tobacco Stemming"]
    style N2141 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2141 |
| Market Segment | Tobacco Stemming |
...
*Source: SIC 2141 - Tobacco Stemming*
