...
Fasteners represents an important category within the Manufacturing sector (SIC 3965).
...
graph TD
    ...
    S3133 --> N3965["3965: Fasteners"]
    style N3965 fill:#f96,stroke:#333,stroke-width:2px
```
