...
Manufacturing Industries represents an important category within the Manufacturing sector (SIC 3999).
...
graph TD
    ...
    S3133 --> N3999["3999: Manufacturing Industries"]
    style N3999 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3999 |
| Market Segment | Manufacturing Industries |
...
*Source: SIC 3999 - Manufacturing Industries*
