...
Boys' Neckwear represents an important category within the Manufacturing sector (SIC 2323).
...
graph TD
    ...
    S3133 --> N2323["2323: Boys' Neckwear"]
    style N2323 fill:#f96,stroke:#333,stroke-width:2px
```
