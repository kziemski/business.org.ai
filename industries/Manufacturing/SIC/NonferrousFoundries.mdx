---
id: NonferrousFoundries
name: Nonferrous Foundries
code: 3369
type: Industry
level: SIC (3369)
status: complete
...
Nonferrous Foundries represents an important category within the Manufacturing sector (SIC 3369).
...
graph TD
    ...
    style N3369 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3369 |
| Market Segment | Nonferrous Foundries |
...
*Source: SIC 3369 - Nonferrous Foundries*
