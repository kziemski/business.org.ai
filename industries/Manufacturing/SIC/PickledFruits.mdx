...
Pickled Fruits represents an important category within the Manufacturing sector (SIC 2035).
...
graph TD
    ...
    S3133 --> N2035["2035: Pickled Fruits"]
    style N2035 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2035 - Pickled Fruits*
