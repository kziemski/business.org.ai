...
Electronic Capacitors represents an important category within the Manufacturing sector (SIC 3675).
...
graph TD
    ...
    S3133 --> N3675["3675: Electronic Capacitors"]
    style N3675 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3675 |
| Market Segment | Electronic Capacitors |
...
*Source: SIC 3675 - Electronic Capacitors*
