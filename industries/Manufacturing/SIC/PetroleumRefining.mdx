...
Petroleum Refining represents an important category within the Manufacturing sector (SIC 2911).
...
graph TD
    ...
    S3133 --> N2911["2911: Petroleum Refining"]
    style N2911 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2911 |
| Market Segment | Petroleum Refining |
...
*Source: SIC 2911 - Petroleum Refining*
