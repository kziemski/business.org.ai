...
Potato Chips represents an important category within the Manufacturing sector (SIC 2096).
...
graph TD
    ...
    S3133 --> N2096["2096: Potato Chips"]
    style N2096 fill:#f96,stroke:#333,stroke-width:2px
```
