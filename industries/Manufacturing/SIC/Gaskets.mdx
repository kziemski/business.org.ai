...
Gaskets represents an important category within the Manufacturing sector (SIC 3053).
...
graph TD
    ...
    S3133 --> N3053["3053: Gaskets"]
    style N3053 fill:#f96,stroke:#333,stroke-width:2px
```
