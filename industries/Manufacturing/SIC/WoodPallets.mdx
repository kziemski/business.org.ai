...
Wood Pallets represents an important category within the Manufacturing sector (SIC 2448).
...
graph TD
    ...
    S3133 --> N2448["2448: Wood Pallets"]
    style N2448 fill:#f96,stroke:#333,stroke-width:2px
```
