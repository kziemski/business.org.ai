...
Yarn Texturizing represents an important category within the Manufacturing sector (SIC 2282).
...
graph TD
    ...
    S3133 --> N2282["2282: Yarn Texturizing"]
    style N2282 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2282 |
| Market Segment | Yarn Texturizing |
...
*Source: SIC 2282 - Yarn Texturizing*
