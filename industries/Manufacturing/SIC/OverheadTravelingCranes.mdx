---
id: OverheadTravelingCranes
name: Overhead Traveling Cranes
code: 3536
type: Industry
level: SIC (3536)
status: complete
...
Overhead Traveling Cranes represents an important category within the Manufacturing sector (SIC 3536).
...
graph TD
    ...
    S3133 --> N3536["3536: Overhead Traveling Cranes"]
    style N3536 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3536 |
| Market Segment | Overhead Traveling Cranes |
...
*Source: SIC 3536 - Overhead Traveling Cranes*
