...
Industrial Controls represents an important category within the Manufacturing sector (SIC 3625).
...
graph TD
    ...
    S3133 --> N3625["3625: Industrial Controls"]
    style N3625 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3625 - Industrial Controls*
