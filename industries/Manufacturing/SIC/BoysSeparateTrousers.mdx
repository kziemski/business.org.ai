---
id: BoysSeparateTrousers
name: Boys' Separate Trousers
code: 2325
type: Industry
level: SIC (2325)
status: complete
...
# Boys' Separate Trousers

> Men's and Boys' Separate Trousers and Slacks.

## Overview

Boys' Separate Trousers represents an important category within the Manufacturing sector (SIC 2325).
...
graph TD
    ...
    S3133 --> N2325["2325: Boys' Separate Trousers"]
    style N2325 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2325 |
| Market Segment | Boys' Separate Trousers |
...
*Source: SIC 2325 - Boys' Separate Trousers*
