...
Screw Machine Products represents an important category within the Manufacturing sector (SIC 3451).
...
graph TD
    ...
    S3133 --> N3451["3451: Screw Machine Products"]
    style N3451 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3451 |
| Market Segment | Screw Machine Products |
...
*Source: SIC 3451 - Screw Machine Products*
