...
Small Arms Ammunition represents an important category within the Manufacturing sector (SIC 3482).
...
graph TD
    ...
    S3133 --> N3482["3482: Small Arms Ammunition"]
    style N3482 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3482 |
| Market Segment | Small Arms Ammunition |
...
*Source: SIC 3482 - Small Arms Ammunition*
