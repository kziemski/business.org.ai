...
Laminated Paper represents an important category within the Manufacturing sector (SIC 2672).
...
graph TD
    ...
    S3133 --> N2672["2672: Laminated Paper"]
    style N2672 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2672 |
| Market Segment | Laminated Paper |
...
*Source: SIC 2672 - Laminated Paper*
