...
Electronic Resistors represents an important category within the Manufacturing sector (SIC 3676).
...
graph TD
    ...
    S3133 --> N3676["3676: Electronic Resistors"]
    style N3676 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3676 |
| Market Segment | Electronic Resistors |
...
*Source: SIC 3676 - Electronic Resistors*
