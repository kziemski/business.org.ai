...
Power-Driven Handtools represents an important category within the Manufacturing sector (SIC 3546).
...
graph TD
    ...
    S3133 --> N3546["3546: Power-Driven Handtools"]
    style N3546 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3546 |
| Market Segment | Power-Driven Handtools |
...
*Source: SIC 3546 - Power-Driven Handtools*
