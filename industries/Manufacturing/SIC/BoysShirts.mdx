...
Boys' Shirts represents an important category within the Manufacturing sector (SIC 2321).
...
graph TD
    ...
    S3133 --> N2321["2321: Boys' Shirts"]
    style N2321 fill:#f96,stroke:#333,stroke-width:2px
```
