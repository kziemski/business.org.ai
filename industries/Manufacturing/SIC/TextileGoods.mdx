...
Textile goods represents an important category within the Manufacturing sector (SIC 2299).
...
graph TD
    ...
    S3133 --> N2299["2299: Textile goods"]
    style N2299 fill:#f96,stroke:#333,stroke-width:2px
```
