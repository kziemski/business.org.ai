...
Blankbooks represents an important category within the Manufacturing sector (SIC 2782).
...
graph TD
    ...
    S3133 --> N2782["2782: Blankbooks"]
    style N2782 fill:#f96,stroke:#333,stroke-width:2px
```
