...
Aircraft represents an important category within the Manufacturing sector (SIC 3721).
...
graph TD
    ...
    S3133 --> N3721["3721: Aircraft"]
    style N3721 fill:#f96,stroke:#333,stroke-width:2px
```
