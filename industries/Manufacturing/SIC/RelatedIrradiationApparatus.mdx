---
id: RelatedIrradiationApparatus
name: Related Irradiation Apparatus
code: 3844
type: Industry
level: SIC (3844)
status: complete
...
Related Irradiation Apparatus represents an important category within the Manufacturing sector (SIC 3844).
...
graph TD
    ...
    S3133 --> N3844["3844: Related Irradiation Apparatus"]
    style N3844 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3844 |
| Market Segment | Related Irradiation Apparatus |
...
*Source: SIC 3844 - Related Irradiation Apparatus*
