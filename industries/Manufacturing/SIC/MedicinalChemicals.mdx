---
id: MedicinalChemicals
name: Medicinal Chemicals
code: 2833
type: Industry
level: SIC (2833)
status: complete
...
Medicinal Chemicals represents an important category within the Manufacturing sector (SIC 2833).
...
graph TD
    ...
    S3133 --> N2833["2833: Medicinal Chemicals"]
    style N2833 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2833 |
| Market Segment | Medicinal Chemicals |
...
*Source: SIC 2833 - Medicinal Chemicals*
