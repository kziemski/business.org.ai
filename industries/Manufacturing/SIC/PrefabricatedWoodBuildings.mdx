...
Prefabricated Wood Buildings represents an important category within the Manufacturing sector (SIC 2452).
...
graph TD
    ...
    S3133 --> N2452["2452: Prefabricated Wood Buildings"]
    style N2452 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2452 |
| Market Segment | Prefabricated Wood Buildings |
...
*Source: SIC 2452 - Prefabricated Wood Buildings*
