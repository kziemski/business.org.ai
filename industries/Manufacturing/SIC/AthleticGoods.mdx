...
Athletic Goods represents an important category within the Manufacturing sector (SIC 3949).
...
graph TD
    ...
    S3133 --> N3949["3949: Athletic Goods"]
    style N3949 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3949 - Athletic Goods*
