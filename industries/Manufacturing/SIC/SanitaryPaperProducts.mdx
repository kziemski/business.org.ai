...
Sanitary Paper Products represents an important category within the Manufacturing sector (SIC 2676).
...
graph TD
    ...
    S3133 --> N2676["2676: Sanitary Paper Products"]
    style N2676 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2676 |
| Market Segment | Sanitary Paper Products |
...
*Source: SIC 2676 - Sanitary Paper Products*
