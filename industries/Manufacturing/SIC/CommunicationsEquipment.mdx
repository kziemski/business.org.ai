...
Communications Equipment represents an important category within the Manufacturing sector (SIC 3663).
...
graph TD
    ...
    S3133 --> N3663["3663: Communications Equipment"]
    style N3663 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3663 |
| Market Segment | Communications Equipment |
...
*Source: SIC 3663 - Communications Equipment*
