...
Glassware represents an important category within the Manufacturing sector (SIC 3229).
...
graph TD
    ...
    N322 --> N3229["3229: Glassware"]
    style N3229 fill:#f96,stroke:#333,stroke-width:2px
```
