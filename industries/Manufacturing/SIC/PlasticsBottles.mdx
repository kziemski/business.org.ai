...
Plastics Bottles represents an important category within the Manufacturing sector (SIC 3085).
...
graph TD
    ...
    S3133 --> N3085["3085: Plastics Bottles"]
    style N3085 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3085 |
| Market Segment | Plastics Bottles |
...
*Source: SIC 3085 - Plastics Bottles*
