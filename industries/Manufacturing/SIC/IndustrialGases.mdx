...
Industrial Gases represents an important category within the Manufacturing sector (SIC 2813).
...
graph TD
    ...
    S3133 --> N2813["2813: Industrial Gases"]
    style N2813 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2813 |
| Market Segment | Industrial Gases |
...
*Source: SIC 2813 - Industrial Gases*
