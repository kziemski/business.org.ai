...
Steel Springs represents an important category within the Manufacturing sector (SIC 3493).
...
graph TD
    ...
    S3133 --> N3493["3493: Steel Springs"]
    style N3493 fill:#f96,stroke:#333,stroke-width:2px
```
