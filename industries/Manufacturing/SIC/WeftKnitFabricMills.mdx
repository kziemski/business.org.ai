...
Weft Knit Fabric Mills represents an important category within the Manufacturing sector (SIC 2257).
...
graph TD
    ...
    S3133 --> N2257["2257: Weft Knit Fabric Mills"]
    style N2257 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2257 |
| Market Segment | Weft Knit Fabric Mills |
...
*Source: SIC 2257 - Weft Knit Fabric Mills*
