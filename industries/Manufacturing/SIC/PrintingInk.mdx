...
Printing Ink represents an important category within the Manufacturing sector (SIC 2893).
...
graph TD
    ...
    S3133 --> N2893["2893: Printing Ink"]
    style N2893 fill:#f96,stroke:#333,stroke-width:2px
```
