...
Malt represents an important category within the Manufacturing sector (SIC 2083).
...
graph TD
    ...
    S3133 --> N2083["2083: Malt"]
    style N2083 fill:#f96,stroke:#333,stroke-width:2px
```
