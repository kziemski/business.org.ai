...
Shortening represents an important category within the Manufacturing sector (SIC 2079).
...
graph TD
    ...
    S3133 --> N2079["2079: Shortening"]
    style N2079 fill:#f96,stroke:#333,stroke-width:2px
```
