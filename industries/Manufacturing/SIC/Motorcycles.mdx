...
Motorcycles represents an important category within the Manufacturing sector (SIC 3751).
...
graph TD
    ...
    S3133 --> N3751["3751: Motorcycles"]
    style N3751 fill:#f96,stroke:#333,stroke-width:2px
```
