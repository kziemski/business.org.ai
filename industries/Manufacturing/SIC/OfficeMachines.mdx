...
Office Machines represents an important category within the Manufacturing sector (SIC 3579).
...
graph TD
    ...
    S3133 --> N3579["3579: Office Machines"]
    style N3579 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3579 |
| Market Segment | Office Machines |
...
*Source: SIC 3579 - Office Machines*
