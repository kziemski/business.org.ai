...
Yarn Spinning Mills represents an important category within the Manufacturing sector (SIC 2281).
...
graph TD
    ...
    S3133 --> N2281["2281: Yarn Spinning Mills"]
    style N2281 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2281 |
| Market Segment | Yarn Spinning Mills |
...
*Source: SIC 2281 - Yarn Spinning Mills*
