...
House Slippers represents an important category within the Manufacturing sector (SIC 3142).
...
graph TD
    ...
    N314 --> N3142["3142: House Slippers"]
    style N3142 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3142 - House Slippers*
