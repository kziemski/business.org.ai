...
Drapery Hardware represents an important category within the Manufacturing sector (SIC 2591).
...
graph TD
    ...
    S3133 --> N2591["2591: Drapery Hardware"]
    style N2591 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2591 |
| Market Segment | Drapery Hardware |
...
*Source: SIC 2591 - Drapery Hardware*
