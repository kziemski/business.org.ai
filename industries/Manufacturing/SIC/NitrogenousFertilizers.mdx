...
Nitrogenous Fertilizers represents an important category within the Manufacturing sector (SIC 2873).
...
graph TD
    ...
    S3133 --> N2873["2873: Nitrogenous Fertilizers"]
    style N2873 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2873 |
| Market Segment | Nitrogenous Fertilizers |
...
*Source: SIC 2873 - Nitrogenous Fertilizers*
