...
Packaging Paper represents an important category within the Manufacturing sector (SIC 2671).
...
graph TD
    ...
    S3133 --> N2671["2671: Packaging Paper"]
    style N2671 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2671 |
| Market Segment | Packaging Paper |
...
*Source: SIC 2671 - Packaging Paper*
