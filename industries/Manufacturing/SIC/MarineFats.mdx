...
Marine Fats represents an important category within the Manufacturing sector (SIC 2077).
...
graph TD
    ...
    S3133 --> N2077["2077: Marine Fats"]
    style N2077 fill:#f96,stroke:#333,stroke-width:2px
```
