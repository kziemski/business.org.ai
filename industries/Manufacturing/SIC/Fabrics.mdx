...
Fabrics represents an important category within the Manufacturing sector (SIC 2296).
...
graph TD
    ...
    S3133 --> N2296["2296: Fabrics"]
    style N2296 fill:#f96,stroke:#333,stroke-width:2px
```
