...
Boys' Underwear represents an important category within the Manufacturing sector (SIC 2322).
...
graph TD
    ...
    S3133 --> N2322["2322: Boys' Underwear"]
    style N2322 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2322 - Boys' Underwear*
