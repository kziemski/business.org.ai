...
Related Furniture represents an important category within the Manufacturing sector (SIC 2531).
...
graph TD
    ...
    S3133 --> N2531["2531: Related Furniture"]
    style N2531 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2531 |
| Market Segment | Related Furniture |
...
*Source: SIC 2531 - Related Furniture*
