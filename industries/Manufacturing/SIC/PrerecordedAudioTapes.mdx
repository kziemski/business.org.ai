---
id: PrerecordedAudioTapes
name: Prerecorded Audio Tapes
code: 3652
type: Industry
level: SIC (3652)
status: complete
...
Prerecorded Audio Tapes represents an important category within the Manufacturing sector (SIC 3652).
...
graph TD
    ...
    S3133 --> N3652["3652: Prerecorded Audio Tapes"]
    style N3652 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3652 |
| Market Segment | Prerecorded Audio Tapes |
...
*Source: SIC 3652 - Prerecorded Audio Tapes*
