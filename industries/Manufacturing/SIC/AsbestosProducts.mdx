...
Asbestos Products represents an important category within the Manufacturing sector (SIC 3292).
...
graph TD
    ...
    S3133 --> N3292["3292: Asbestos Products"]
    style N3292 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3292 |
| Market Segment | Asbestos Products |
...
*Source: SIC 3292 - Asbestos Products*
