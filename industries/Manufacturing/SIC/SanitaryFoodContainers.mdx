...
Sanitary Food Containers represents an important category within the Manufacturing sector (SIC 2656).
...
graph TD
    ...
    S3133 --> N2656["2656: Sanitary Food Containers"]
    style N2656 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2656 |
| Market Segment | Sanitary Food Containers |
...
*Source: SIC 2656 - Sanitary Food Containers*
