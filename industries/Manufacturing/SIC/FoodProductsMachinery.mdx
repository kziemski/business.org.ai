...
Food Products Machinery represents an important category within the Manufacturing sector (SIC 3556).
...
graph TD
    ...
    S3133 --> N3556["3556: Food Products Machinery"]
    style N3556 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3556 |
| Market Segment | Food Products Machinery |
...
*Source: SIC 3556 - Food Products Machinery*
