...
Mineral Wool represents an important category within the Manufacturing sector (SIC 3296).
...
graph TD
    ...
    S3133 --> N3296["3296: Mineral Wool"]
    style N3296 fill:#f96,stroke:#333,stroke-width:2px
```
