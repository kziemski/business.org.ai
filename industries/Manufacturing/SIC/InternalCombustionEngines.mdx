...
Internal Combustion Engines represents an important category within the Manufacturing sector (SIC 3519).
...
graph TD
    ...
    S3133 --> N3519["3519: Internal Combustion Engines"]
    style N3519 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3519 |
| Market Segment | Internal Combustion Engines |
...
*Source: SIC 3519 - Internal Combustion Engines*
