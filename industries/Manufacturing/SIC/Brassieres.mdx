...
Brassieres represents an important category within the Manufacturing sector (SIC 2342).
...
graph TD
    ...
    S3133 --> N2342["2342: Brassieres"]
    style N2342 fill:#f96,stroke:#333,stroke-width:2px
```
