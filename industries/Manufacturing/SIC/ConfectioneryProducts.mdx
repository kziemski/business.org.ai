...
Confectionery Products represents an important category within the Manufacturing sector (SIC 2064).
...
graph TD
    ...
    S3133 --> N2064["2064: Confectionery Products"]
    style N2064 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2064 |
| Market Segment | Confectionery Products |
...
*Source: SIC 2064 - Confectionery Products*
