---
id: PlumbingFixtureFittings
name: Plumbing Fixture Fittings
code: 3432
type: Industry
level: SIC (3432)
status: complete
...
Plumbing Fixture Fittings represents an important category within the Manufacturing sector (SIC 3432).
...
graph TD
    ...
    S3133 --> N3432["3432: Plumbing Fixture Fittings"]
    style N3432 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3432 |
| Market Segment | Plumbing Fixture Fittings |
...
*Source: SIC 3432 - Plumbing Fixture Fittings*
