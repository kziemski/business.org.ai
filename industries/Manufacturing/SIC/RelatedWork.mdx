...
Related Work represents an important category within the Manufacturing sector (SIC 2789).
...
graph TD
    ...
    S3133 --> N2789["2789: Related Work"]
    style N2789 fill:#f96,stroke:#333,stroke-width:2px
```
