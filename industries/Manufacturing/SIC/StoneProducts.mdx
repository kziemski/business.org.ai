...
Stone Products represents an important category within the Manufacturing sector (SIC 3281).
...
graph TD
    ...
    S3133 --> N3281["3281: Stone Products"]
    style N3281 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3281 - Stone Products*
