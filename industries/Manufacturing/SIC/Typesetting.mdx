...
Typesetting represents an important category within the Manufacturing sector (SIC 2791).
...
graph TD
    ...
    S3133 --> N2791["2791: Typesetting"]
    style N2791 fill:#f96,stroke:#333,stroke-width:2px
```
