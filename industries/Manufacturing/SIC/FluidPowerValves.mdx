...
Fluid Power Valves represents an important category within the Manufacturing sector (SIC 3492).
...
graph TD
    ...
    S3133 --> N3492["3492: Fluid Power Valves"]
    style N3492 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3492 |
| Market Segment | Fluid Power Valves |
...
*Source: SIC 3492 - Fluid Power Valves*
