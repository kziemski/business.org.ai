...
Silverware represents an important category within the Manufacturing sector (SIC 3914).
...
graph TD
    ...
    S3133 --> N3914["3914: Silverware"]
    style N3914 fill:#f96,stroke:#333,stroke-width:2px
```
