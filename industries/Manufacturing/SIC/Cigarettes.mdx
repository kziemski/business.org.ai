...
Cigarettes represents an important category within the Manufacturing sector (SIC 2111).
...
graph TD
    ...
    style N2111 fill:#f96,stroke:#333,stroke-width:2px
