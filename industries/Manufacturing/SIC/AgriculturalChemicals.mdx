...
Agricultural Chemicals represents an important category within the Manufacturing sector (SIC 2879).
...
graph TD
    ...
    S3133 --> N2879["2879: Agricultural Chemicals"]
    style N2879 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2879 |
| Market Segment | Agricultural Chemicals |
...
*Source: SIC 2879 - Agricultural Chemicals*
