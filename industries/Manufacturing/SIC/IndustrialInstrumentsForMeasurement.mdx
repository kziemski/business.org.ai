---
id: IndustrialInstrumentsForMeasurement
...
Industrial Instruments for Measurement represents an important category within the Manufacturing sector (SIC 3823).
...
graph TD
    ...
    S3133 --> N3823["3823: Industrial Instruments for Measurement"]
    style N3823 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3823 |
| Market Segment | Industrial Instruments for Measurement |
...
*Source: SIC 3823 - Industrial Instruments for Measurement*
