---
id: FabricatedTextileProducts
name: Fabricated Textile Products
code: 2399
type: Industry
level: SIC (2399)
status: complete
...
Fabricated Textile Products represents an important category within the Manufacturing sector (SIC 2399).
...
graph TD
    ...
    S3133 --> N2399["2399: Fabricated Textile Products"]
    style N2399 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2399 |
| Market Segment | Fabricated Textile Products |
...
*Source: SIC 2399 - Fabricated Textile Products*
