...
Watches represents an important category within the Manufacturing sector (SIC 3873).
...
graph TD
    ...
    S3133 --> N3873["3873: Watches"]
    style N3873 fill:#f96,stroke:#333,stroke-width:2px
```
