---
id: WarpKnitFabricMills
name: Warp Knit Fabric Mills
code: 2258
type: Industry
level: SIC (2258)
status: complete
...
Warp Knit Fabric Mills represents an important category within the Manufacturing sector (SIC 2258).
...
graph TD
    ...
    S3133 --> N2258["2258: Warp Knit Fabric Mills"]
    style N2258 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2258 |
| Market Segment | Warp Knit Fabric Mills |
...
*Source: SIC 2258 - Warp Knit Fabric Mills*
