...
Household Audio represents an important category within the Manufacturing sector (SIC 3651).
...
graph TD
    ...
    S3133 --> N3651["3651: Household Audio"]
    style N3651 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3651 |
| Market Segment | Household Audio |
...
*Source: SIC 3651 - Household Audio*
