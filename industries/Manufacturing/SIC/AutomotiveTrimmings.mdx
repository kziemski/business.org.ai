---
id: AutomotiveTrimmings
name: Automotive Trimmings
code: 2396
type: Industry
level: SIC (2396)
status: complete
...
Automotive Trimmings represents an important category within the Manufacturing sector (SIC 2396).
...
graph TD
    ...
    S3133 --> N2396["2396: Automotive Trimmings"]
    style N2396 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2396 |
| Market Segment | Automotive Trimmings |
...
*Source: SIC 2396 - Automotive Trimmings*
