...
Gas Compressors represents an important category within the Manufacturing sector (SIC 3563).
...
graph TD
    ...
    S3133 --> N3563["3563: Gas Compressors"]
    style N3563 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3563 |
| Market Segment | Gas Compressors |
...
*Source: SIC 3563 - Gas Compressors*
