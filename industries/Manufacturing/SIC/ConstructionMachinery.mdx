...
Construction Machinery represents an important category within the Manufacturing sector (SIC 3531).
...
graph TD
    ...
    S3133 --> N3531["3531: Construction Machinery"]
    style N3531 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3531 |
| Market Segment | Construction Machinery |
...
*Source: SIC 3531 - Construction Machinery*
