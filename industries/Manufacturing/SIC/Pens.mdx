...
Pens represents an important category within the Manufacturing sector (SIC 3951).
...
graph TD
    ...
    S3133 --> N3951["3951: Pens"]
    style N3951 fill:#f96,stroke:#333,stroke-width:2px
```
