...
Fluid Power Pumps represents an important category within the Manufacturing sector (SIC 3594).
...
graph TD
    ...
    S3133 --> N3594["3594: Fluid Power Pumps"]
    style N3594 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3594 |
| Market Segment | Fluid Power Pumps |
...
*Source: SIC 3594 - Fluid Power Pumps*
