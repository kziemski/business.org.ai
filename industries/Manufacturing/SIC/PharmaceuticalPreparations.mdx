...
Pharmaceutical Preparations represents an important category within the Manufacturing sector (SIC 2834).
...
graph TD
    ...
    S3133 --> N2834["2834: Pharmaceutical Preparations"]
    style N2834 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2834 |
| Market Segment | Pharmaceutical Preparations |
...
*Source: SIC 2834 - Pharmaceutical Preparations*
