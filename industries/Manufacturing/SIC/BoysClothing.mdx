...
Boys' Clothing represents an important category within the Manufacturing sector (SIC 2329).
...
graph TD
    ...
    S3133 --> N2329["2329: Boys' Clothing"]
    style N2329 fill:#f96,stroke:#333,stroke-width:2px
```
