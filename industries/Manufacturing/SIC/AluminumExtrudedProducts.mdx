...
Aluminum Extruded Products represents an important category within the Manufacturing sector (SIC 3354).
...
graph TD
    ...
    N335 --> N3354["3354: Aluminum Extruded Products"]
    style N3354 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3354 |
| Market Segment | Aluminum Extruded Products |
...
*Source: SIC 3354 - Aluminum Extruded Products*
