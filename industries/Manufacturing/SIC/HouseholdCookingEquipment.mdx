...
Household Cooking Equipment represents an important category within the Manufacturing sector (SIC 3631).
...
graph TD
    ...
    S3133 --> N3631["3631: Household Cooking Equipment"]
    style N3631 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3631 |
| Market Segment | Household Cooking Equipment |
...
*Source: SIC 3631 - Household Cooking Equipment*
