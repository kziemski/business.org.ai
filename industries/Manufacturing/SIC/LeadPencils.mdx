...
Lead Pencils represents an important category within the Manufacturing sector (SIC 3952).
...
graph TD
    ...
    S3133 --> N3952["3952: Lead Pencils"]
    style N3952 fill:#f96,stroke:#333,stroke-width:2px
```
