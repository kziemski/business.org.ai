...
Women's represents an important category within the Manufacturing sector (SIC 2331).
...
graph TD
    ...
    S3133 --> N2331["2331: Women's"]
    style N2331 fill:#f96,stroke:#333,stroke-width:2px
```
