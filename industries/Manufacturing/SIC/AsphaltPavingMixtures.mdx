---
id: AsphaltPavingMixtures
name: Asphalt Paving Mixtures
code: 2951
type: Industry
level: SIC (2951)
status: complete
...
Asphalt Paving Mixtures represents an important category within the Manufacturing sector (SIC 2951).
...
graph TD
    ...
    S3133 --> N2951["2951: Asphalt Paving Mixtures"]
    style N2951 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2951 |
| Market Segment | Asphalt Paving Mixtures |
...
*Source: SIC 2951 - Asphalt Paving Mixtures*
