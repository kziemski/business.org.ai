...
Textile Bags represents an important category within the Manufacturing sector (SIC 2393).
...
graph TD
    ...
    S3133 --> N2393["2393: Textile Bags"]
    style N2393 fill:#f96,stroke:#333,stroke-width:2px
```
