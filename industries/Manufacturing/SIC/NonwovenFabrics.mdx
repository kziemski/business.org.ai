...
Non-woven Fabrics represents an important category within the Manufacturing sector (SIC 2297).
...
graph TD
    ...
    S3133 --> N2297["2297: Non-woven Fabrics"]
    style N2297 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2297 |
| Market Segment | Non-woven Fabrics |
...
*Source: SIC 2297 - Non-woven Fabrics*
