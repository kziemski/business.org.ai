...
Tank Components represents an important category within the Manufacturing sector (SIC 3795).
...
graph TD
    ...
    S3133 --> N3795["3795: Tank Components"]
    style N3795 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3795 |
| Market Segment | Tank Components |
...
*Source: SIC 3795 - Tank Components*
