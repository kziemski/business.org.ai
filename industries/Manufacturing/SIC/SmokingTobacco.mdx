...
Smoking Tobacco represents an important category within the Manufacturing sector (SIC 2131).
...
graph TD
    ...
    S3133 --> N213["213: Support Activities for Mining"]
    N213 --> N2131["2131: Smoking Tobacco"]
    style N2131 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2131 |
| Market Segment | Smoking Tobacco |
...
*Source: SIC 2131 - Smoking Tobacco*
