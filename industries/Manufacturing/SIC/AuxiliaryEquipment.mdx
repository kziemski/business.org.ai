...
Auxiliary Equipment represents an important category within the Manufacturing sector (SIC 3728).
...
graph TD
    ...
    S3133 --> N3728["3728: Auxiliary Equipment"]
    style N3728 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3728 |
| Market Segment | Auxiliary Equipment |
...
*Source: SIC 3728 - Auxiliary Equipment*
