...
Biological Products represents an important category within the Manufacturing sector (SIC 2836).
...
graph TD
    ...
    S3133 --> N2836["2836: Biological Products"]
    style N2836 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2836 |
| Market Segment | Biological Products |
...
*Source: SIC 2836 - Biological Products*
