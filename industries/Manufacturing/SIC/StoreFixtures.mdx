...
Store Fixtures represents an important category within the Manufacturing sector (SIC 2541).
...
graph TD
    ...
    S3133 --> N2541["2541: Store Fixtures"]
    style N2541 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2541 - Store Fixtures*
