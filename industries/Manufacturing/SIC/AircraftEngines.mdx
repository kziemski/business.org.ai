...
Aircraft Engines represents an important category within the Manufacturing sector (SIC 3724).
...
graph TD
    ...
    S3133 --> N3724["3724: Aircraft Engines"]
    style N3724 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3724 |
| Market Segment | Aircraft Engines |
...
*Source: SIC 3724 - Aircraft Engines*
