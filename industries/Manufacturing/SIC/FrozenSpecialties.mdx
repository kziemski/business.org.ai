...
Frozen Specialties represents an important category within the Manufacturing sector (SIC 2038).
...
graph TD
    ...
    S3133 --> N2038["2038: Frozen Specialties"]
    style N2038 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2038 |
| Market Segment | Frozen Specialties |
...
*Source: SIC 2038 - Frozen Specialties*
