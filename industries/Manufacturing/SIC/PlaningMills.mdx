...
Planing Mills represents an important category within the Manufacturing sector (SIC 2421).
...
graph TD
    ...
    S3133 --> N2421["2421: Planing Mills"]
    style N2421 fill:#f96,stroke:#333,stroke-width:2px
```
