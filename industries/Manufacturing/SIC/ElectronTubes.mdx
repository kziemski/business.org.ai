...
Electron Tubes represents an important category within the Manufacturing sector (SIC 3671).
...
graph TD
    ...
    S3133 --> N3671["3671: Electron Tubes"]
    style N3671 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3671 - Electron Tubes*
