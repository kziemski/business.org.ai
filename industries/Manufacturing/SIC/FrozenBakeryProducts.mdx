---
id: FrozenBakeryProducts
name: Frozen Bakery Products
code: 2053
type: Industry
level: SIC (2053)
status: complete
...
Frozen Bakery Products represents an important category within the Manufacturing sector (SIC 2053).
...
graph TD
    ...
    S3133 --> N2053["2053: Frozen Bakery Products"]
    style N2053 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2053 |
| Market Segment | Frozen Bakery Products |
...
*Source: SIC 2053 - Frozen Bakery Products*
