...
Special Dies represents an important category within the Manufacturing sector (SIC 3544).
...
graph TD
    ...
    S3133 --> N3544["3544: Special Dies"]
    style N3544 fill:#f96,stroke:#333,stroke-width:2px
```
