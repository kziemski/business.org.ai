...
Plastics Plumbing Fixtures represents an important category within the Manufacturing sector (SIC 3088).
...
graph TD
    ...
    S3133 --> N3088["3088: Plastics Plumbing Fixtures"]
    style N3088 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3088 |
| Market Segment | Plastics Plumbing Fixtures |
...
*Source: SIC 3088 - Plastics Plumbing Fixtures*
