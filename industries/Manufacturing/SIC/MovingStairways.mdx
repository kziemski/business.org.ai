...
Moving Stairways represents an important category within the Manufacturing sector (SIC 3534).
...
graph TD
    ...
    S3133 --> N3534["3534: Moving Stairways"]
    style N3534 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3534 |
| Market Segment | Moving Stairways |
...
*Source: SIC 3534 - Moving Stairways*
