...
Frozen Fruits represents an important category within the Manufacturing sector (SIC 2037).
...
graph TD
    ...
    S3133 --> N2037["2037: Frozen Fruits"]
    style N2037 fill:#f96,stroke:#333,stroke-width:2px
```
