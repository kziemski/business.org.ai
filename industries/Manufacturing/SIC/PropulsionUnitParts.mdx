---
id: PropulsionUnitParts
name: Propulsion Unit Parts
code: 3764
type: Industry
level: SIC (3764)
status: complete
...
Propulsion Unit Parts represents an important category within the Manufacturing sector (SIC 3764).
...
graph TD
    ...
    S3133 --> N3764["3764: Propulsion Unit Parts"]
...
| NAICS/SIC Code | 3764 |
| Market Segment | Propulsion Unit Parts |
...
*Source: SIC 3764 - Propulsion Unit Parts*
