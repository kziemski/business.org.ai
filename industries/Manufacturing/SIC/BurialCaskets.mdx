...
Burial Caskets represents an important category within the Manufacturing sector (SIC 3995).
...
graph TD
    ...
    S3133 --> N3995["3995: Burial Caskets"]
    style N3995 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3995 - Burial Caskets*
