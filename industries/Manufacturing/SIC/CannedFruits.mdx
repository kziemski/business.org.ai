...
Canned Fruits represents an important category within the Manufacturing sector (SIC 2033).
...
graph TD
    ...
    S3133 --> N2033["2033: Canned Fruits"]
    style N2033 fill:#f96,stroke:#333,stroke-width:2px
```
