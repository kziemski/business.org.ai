---
id: FabricatedWireProducts
name: Fabricated Wire Products
code: 3496
type: Industry
level: SIC (3496)
status: complete
...
Fabricated Wire Products represents an important category within the Manufacturing sector (SIC 3496).
...
graph TD
    ...
    S3133 --> N3496["3496: Fabricated Wire Products"]
    style N3496 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3496 |
| Market Segment | Fabricated Wire Products |
...
*Source: SIC 3496 - Fabricated Wire Products*
