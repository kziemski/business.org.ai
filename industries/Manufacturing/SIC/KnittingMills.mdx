...
Knitting Mills represents an important category within the Manufacturing sector (SIC 2259).
...
graph TD
    ...
    S3133 --> N2259["2259: Knitting Mills"]
    style N2259 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2259 - Knitting Mills*
