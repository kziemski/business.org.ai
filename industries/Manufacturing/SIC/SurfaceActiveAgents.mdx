...
Surface Active Agents represents an important category within the Manufacturing sector (SIC 2843).
...
graph TD
    ...
    S3133 --> N2843["2843: Surface Active Agents"]
    style N2843 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2843 |
| Market Segment | Surface Active Agents |
...
*Source: SIC 2843 - Surface Active Agents*
