...
Storage Batteries represents an important category within the Manufacturing sector (SIC 3691).
...
graph TD
    ...
    S3133 --> N3691["3691: Storage Batteries"]
    style N3691 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3691 |
| Market Segment | Storage Batteries |
...
*Source: SIC 3691 - Storage Batteries*
