...
Blended Liquors represents an important category within the Manufacturing sector (SIC 2085).
...
graph TD
    ...
    S3133 --> N2085["2085: Blended Liquors"]
    style N2085 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2085 |
| Market Segment | Blended Liquors |
...
*Source: SIC 2085 - Blended Liquors*
