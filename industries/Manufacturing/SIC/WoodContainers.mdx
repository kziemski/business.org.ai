...
Wood Containers represents an important category within the Manufacturing sector (SIC 2449).
...
graph TD
    ...
    S3133 --> N2449["2449: Wood Containers"]
    style N2449 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2449 |
| Market Segment | Wood Containers |
...
*Source: SIC 2449 - Wood Containers*
