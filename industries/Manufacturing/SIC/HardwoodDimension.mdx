---
id: HardwoodDimension
name: Hardwood Dimension
code: 2426
type: Industry
level: SIC (2426)
status: complete
...
Hardwood Dimension represents an important category within the Manufacturing sector (SIC 2426).
...
graph TD
    ...
    S3133 --> N2426["2426: Hardwood Dimension"]
    style N2426 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2426 |
| Market Segment | Hardwood Dimension |
...
*Source: SIC 2426 - Hardwood Dimension*
