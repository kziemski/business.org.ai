...
Salted represents an important category within the Manufacturing sector (SIC 2068).
...
graph TD
    ...
    S3133 --> N2068["2068: Salted"]
    style N2068 fill:#f96,stroke:#333,stroke-width:2px
```
