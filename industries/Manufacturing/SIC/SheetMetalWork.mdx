...
Sheet Metal Work represents an important category within the Manufacturing sector (SIC 3444).
...
graph TD
    ...
    S3133 --> N3444["3444: Sheet Metal Work"]
    style N3444 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3444 |
| Market Segment | Sheet Metal Work |
...
*Source: SIC 3444 - Sheet Metal Work*
