...
Office represents an important category within the Manufacturing sector (SIC 2542).
...
graph TD
    ...
    S3133 --> N2542["2542: Office"]
    style N2542 fill:#f96,stroke:#333,stroke-width:2px
```
