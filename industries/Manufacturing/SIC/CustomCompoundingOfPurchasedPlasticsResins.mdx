---
id: CustomCompoundingOfPurchasedPlasticsResins
...
Custom Compounding of Purchased Plastics Resins represents an important category within the Manufacturing sector (SIC 3087).
...
graph TD
    ...
    S3133 --> N3087["3087: Custom Compounding of Purchased Plast..."]
    style N3087 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3087 |
| Market Segment | Custom Compounding of Purchased Plastics Resins |
...
*Source: SIC 3087 - Custom Compounding of Purchased Plastics Resins*
