---
id: FabricatedRubberProducts
name: Fabricated Rubber Products
code: 3069
type: Industry
level: SIC (3069)
status: complete
...
Fabricated Rubber Products represents an important category within the Manufacturing sector (SIC 3069).
...
graph TD
    ...
    S3133 --> N3069["3069: Fabricated Rubber Products"]
    style N3069 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3069 |
| Market Segment | Fabricated Rubber Products |
...
*Source: SIC 3069 - Fabricated Rubber Products*
