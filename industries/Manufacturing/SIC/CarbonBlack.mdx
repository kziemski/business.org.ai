...
Carbon Black represents an important category within the Manufacturing sector (SIC 2895).
...
graph TD
    ...
    S3133 --> N2895["2895: Carbon Black"]
    style N2895 fill:#f96,stroke:#333,stroke-width:2px
```
