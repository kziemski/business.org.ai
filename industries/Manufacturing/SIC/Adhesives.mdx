...
Adhesives represents an important category within the Manufacturing sector (SIC 2891).
...
graph TD
    ...
    S3133 --> N2891["2891: Adhesives"]
    style N2891 fill:#f96,stroke:#333,stroke-width:2px
```
