...
Automotive Stampings represents an important category within the Manufacturing sector (SIC 3465).
...
graph TD
    ...
    S3133 --> N3465["3465: Automotive Stampings"]
    style N3465 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3465 |
| Market Segment | Automotive Stampings |
...
*Source: SIC 3465 - Automotive Stampings*
