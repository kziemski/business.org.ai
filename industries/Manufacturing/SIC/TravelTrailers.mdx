...
Travel Trailers represents an important category within the Manufacturing sector (SIC 3792).
...
graph TD
    ...
    S3133 --> N3792["3792: Travel Trailers"]
    style N3792 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3792 |
| Market Segment | Travel Trailers |
...
*Source: SIC 3792 - Travel Trailers*
