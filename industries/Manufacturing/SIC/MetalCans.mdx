...
Metal Cans represents an important category within the Manufacturing sector (SIC 3411).
...
graph TD
    ...
    S3133 --> N3411["3411: Metal Cans"]
    style N3411 fill:#f96,stroke:#333,stroke-width:2px
```
