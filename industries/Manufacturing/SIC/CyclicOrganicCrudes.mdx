---
id: CyclicOrganicCrudes
name: Cyclic Organic Crudes
code: 2865
type: Industry
level: SIC (2865)
status: complete
...
Cyclic Organic Crudes represents an important category within the Manufacturing sector (SIC 2865).
...
graph TD
    ...
    S3133 --> N2865["2865: Cyclic Organic Crudes"]
    style N2865 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2865 |
| Market Segment | Cyclic Organic Crudes |
...
*Source: SIC 2865 - Cyclic Organic Crudes*
