...
Pipe Fittings represents an important category within the Manufacturing sector (SIC 3494).
...
graph TD
    ...
    S3133 --> N3494["3494: Pipe Fittings"]
    style N3494 fill:#f96,stroke:#333,stroke-width:2px
```
