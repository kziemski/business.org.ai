...
Garden Tractors represents an important category within the Manufacturing sector (SIC 3524).
...
graph TD
    ...
    S3133 --> N3524["3524: Garden Tractors"]
    style N3524 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3524 |
| Market Segment | Garden Tractors |
...
*Source: SIC 3524 - Garden Tractors*
