...
Fiber Cans represents an important category within the Manufacturing sector (SIC 2655).
...
graph TD
    ...
    S3133 --> N2655["2655: Fiber Cans"]
    style N2655 fill:#f96,stroke:#333,stroke-width:2px
```
