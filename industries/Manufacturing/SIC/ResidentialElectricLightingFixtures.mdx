---
id: ResidentialElectricLightingFixtures
...
Residential Electric Lighting Fixtures represents an important category within the Manufacturing sector (SIC 3645).
...
graph TD
    ...
    S3133 --> N3645["3645: Residential Electric Lighting Fixtures"]
    style N3645 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3645 |
| Market Segment | Residential Electric Lighting Fixtures |
...
*Source: SIC 3645 - Residential Electric Lighting Fixtures*
