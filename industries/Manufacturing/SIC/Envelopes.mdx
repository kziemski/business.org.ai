...
Envelopes represents an important category within the Manufacturing sector (SIC 2677).
...
graph TD
    ...
    S3133 --> N2677["2677: Envelopes"]
    style N2677 fill:#f96,stroke:#333,stroke-width:2px
```
