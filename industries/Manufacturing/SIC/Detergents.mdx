...
Detergents represents an important category within the Manufacturing sector (SIC 2841).
...
graph TD
    ...
    S3133 --> N2841["2841: Detergents"]
    style N2841 fill:#f96,stroke:#333,stroke-width:2px
```
