---
id: FlavoringExtracts
name: Flavoring Extracts
code: 2087
type: Industry
level: SIC (2087)
status: complete
...
Flavoring Extracts represents an important category within the Manufacturing sector (SIC 2087).
...
graph TD
    ...
    S3133 --> N2087["2087: Flavoring Extracts"]
    style N2087 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2087 |
| Market Segment | Flavoring Extracts |
...
*Source: SIC 2087 - Flavoring Extracts*
