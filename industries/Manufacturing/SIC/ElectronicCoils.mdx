...
Electronic Coils represents an important category within the Manufacturing sector (SIC 3677).
...
graph TD
    ...
    S3133 --> N3677["3677: Electronic Coils"]
    style N3677 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3677 |
| Market Segment | Electronic Coils |
...
*Source: SIC 3677 - Electronic Coils*
