...
Reconstituted Wood Products represents an important category within the Manufacturing sector (SIC 2493).
...
graph TD
    ...
    S3133 --> N2493["2493: Reconstituted Wood Products"]
    style N2493 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2493 |
| Market Segment | Reconstituted Wood Products |
...
*Source: SIC 2493 - Reconstituted Wood Products*
