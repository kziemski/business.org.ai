...
Minerals represents an important category within the Manufacturing sector (SIC 3295).
...
graph TD
    ...
    S3133 --> N3295["3295: Minerals"]
    style N3295 fill:#f96,stroke:#333,stroke-width:2px
```
