...
Metal Stampings represents an important category within the Manufacturing sector (SIC 3469).
...
graph TD
    ...
    S3133 --> N3469["3469: Metal Stampings"]
    style N3469 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3469 |
| Market Segment | Metal Stampings |
...
*Source: SIC 3469 - Metal Stampings*
