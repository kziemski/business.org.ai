...
Cat Food represents an important category within the Manufacturing sector (SIC 2047).
...
graph TD
    ...
    S3133 --> N2047["2047: Cat Food"]
    style N2047 fill:#f96,stroke:#333,stroke-width:2px
```
