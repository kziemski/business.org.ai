...
Soldering Equipment represents an important category within the Manufacturing sector (SIC 3548).
...
graph TD
    ...
    S3133 --> N3548["3548: Soldering Equipment"]
    style N3548 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3548 |
| Market Segment | Soldering Equipment |
...
*Source: SIC 3548 - Soldering Equipment*
