...
Edge Tools represents an important category within the Manufacturing sector (SIC 3423).
...
graph TD
    ...
    S3133 --> N3423["3423: Edge Tools"]
    style N3423 fill:#f96,stroke:#333,stroke-width:2px
```
