...
Knit Outerwear Mills represents an important category within the Manufacturing sector (SIC 2253).
...
graph TD
    ...
    S3133 --> N2253["2253: Knit Outerwear Mills"]
    style N2253 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2253 |
| Market Segment | Knit Outerwear Mills |
...
*Source: SIC 2253 - Knit Outerwear Mills*
