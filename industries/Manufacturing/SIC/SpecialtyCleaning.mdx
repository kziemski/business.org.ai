...
Specialty Cleaning represents an important category within the Manufacturing sector (SIC 2842).
...
graph TD
    ...
    S3133 --> N2842["2842: Specialty Cleaning"]
    style N2842 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2842 |
| Market Segment | Specialty Cleaning |
...
*Source: SIC 2842 - Specialty Cleaning*
