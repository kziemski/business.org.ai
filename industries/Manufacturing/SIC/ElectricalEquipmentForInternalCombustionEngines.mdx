---
id: ElectricalEquipmentForInternalCombustionEngines
...
Electrical Equipment for Internal Combustion Engines represents an important category within the Manufacturing sector (SIC 3694).
...
graph TD
    ...
    S3133 --> N3694["3694: Electrical Equipment for Internal Com..."]
    style N3694 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3694 |
| Market Segment | Electrical Equipment for Internal Combustion Engines |
...
*Source: SIC 3694 - Electrical Equipment for Internal Combustion Engines*
