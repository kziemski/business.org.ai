...
Waterproof Outerwear represents an important category within the Manufacturing sector (SIC 2385).
...
graph TD
    ...
    N238 --> N2385["2385: Waterproof Outerwear"]
    style N2385 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2385 |
| Market Segment | Waterproof Outerwear |
...
*Source: SIC 2385 - Waterproof Outerwear*
