...
Men's Footwear represents an important category within the Manufacturing sector (SIC 3143).
...
graph TD
    ...
    N314 --> N3143["3143: Men's Footwear"]
    style N3143 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3143 - Men's Footwear*
