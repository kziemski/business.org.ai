...
Bakery Products represents an important category within the Manufacturing sector (SIC 2051).
...
graph TD
    ...
    S3133 --> N2051["2051: Bakery Products"]
    style N2051 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2051 |
| Market Segment | Bakery Products |
...
*Source: SIC 2051 - Bakery Products*
