...
Asphalt Felts represents an important category within the Manufacturing sector (SIC 2952).
...
graph TD
    ...
    S3133 --> N2952["2952: Asphalt Felts"]
    style N2952 fill:#f96,stroke:#333,stroke-width:2px
```
