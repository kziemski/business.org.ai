...
Carburetors represents an important category within the Manufacturing sector (SIC 3592).
...
graph TD
    ...
    S3133 --> N3592["3592: Carburetors"]
    style N3592 fill:#f96,stroke:#333,stroke-width:2px
```
