...
Electronic Computers represents an important category within the Manufacturing sector (SIC 3571).
...
graph TD
    ...
    S3133 --> N3571["3571: Electronic Computers"]
    style N3571 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3571 |
| Market Segment | Electronic Computers |
...
*Source: SIC 3571 - Electronic Computers*
