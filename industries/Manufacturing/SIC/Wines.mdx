...
Wines represents an important category within the Manufacturing sector (SIC 2084).
...
graph TD
    ...
    S3133 --> N2084["2084: Wines"]
    style N2084 fill:#f96,stroke:#333,stroke-width:2px
```
