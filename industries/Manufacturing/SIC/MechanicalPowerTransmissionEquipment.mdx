---
id: MechanicalPowerTransmissionEquipment
...
Mechanical Power Transmission Equipment represents an important category within the Manufacturing sector (SIC 3568).
...
graph TD
    ...
    S3133 --> N3568["3568: Mechanical Power Transmission Equipment"]
    style N3568 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3568 |
| Market Segment | Mechanical Power Transmission Equipment |
...
*Source: SIC 3568 - Mechanical Power Transmission Equipment*
