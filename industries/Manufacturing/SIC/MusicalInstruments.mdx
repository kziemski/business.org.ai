...
Musical Instruments represents an important category within the Manufacturing sector (SIC 3931).
...
graph TD
    ...
    S3133 --> N3931["3931: Musical Instruments"]
    style N3931 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3931 |
| Market Segment | Musical Instruments |
...
*Source: SIC 3931 - Musical Instruments*
