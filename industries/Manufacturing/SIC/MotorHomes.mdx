...
Motor Homes represents an important category within the Manufacturing sector (SIC 3716).
...
graph TD
    ...
    S3133 --> N3716["3716: Motor Homes"]
    style N3716 fill:#f96,stroke:#333,stroke-width:2px
```
