...
Phosphatic Fertilizers represents an important category within the Manufacturing sector (SIC 2874).
...
graph TD
    ...
    S3133 --> N2874["2874: Phosphatic Fertilizers"]
    style N2874 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2874 |
| Market Segment | Phosphatic Fertilizers |
...
*Source: SIC 2874 - Phosphatic Fertilizers*
