...
Cane Sugar Refining represents an important category within the Manufacturing sector (SIC 2062).
...
graph TD
    ...
    S3133 --> N2062["2062: Cane Sugar Refining"]
    style N2062 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2062 |
| Market Segment | Cane Sugar Refining |
...
*Source: SIC 2062 - Cane Sugar Refining*
