---
id: KneeLengthHosiery
name: Knee-Length Hosiery
code: 2251
type: Industry
level: SIC (2251)
status: complete
...
Knee-Length Hosiery represents an important category within the Manufacturing sector (SIC 2251).
...
graph TD
    ...
    S3133 --> N2251["2251: Knee-Length Hosiery"]
    style N2251 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2251 |
| Market Segment | Knee-Length Hosiery |
...
*Source: SIC 2251 - Knee-Length Hosiery*
