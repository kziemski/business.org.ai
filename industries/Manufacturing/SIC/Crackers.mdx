...
Crackers represents an important category within the Manufacturing sector (SIC 2052).
...
graph TD
    ...
    S3133 --> N2052["2052: Crackers"]
    style N2052 fill:#f96,stroke:#333,stroke-width:2px
```
