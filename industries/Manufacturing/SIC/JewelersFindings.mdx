...
Jewelers' Findings represents an important category within the Manufacturing sector (SIC 3915).
...
graph TD
    ...
    S3133 --> N3915["3915: Jewelers' Findings"]
    style N3915 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3915 |
| Market Segment | Jewelers' Findings |
...
*Source: SIC 3915 - Jewelers' Findings*
