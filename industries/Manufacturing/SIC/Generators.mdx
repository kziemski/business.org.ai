...
Generators represents an important category within the Manufacturing sector (SIC 3621).
...
graph TD
    ...
    S3133 --> N3621["3621: Generators"]
    style N3621 fill:#f96,stroke:#333,stroke-width:2px
```
