...
Computer Storage Devices represents an important category within the Manufacturing sector (SIC 3572).
...
graph TD
    ...
    S3133 --> N3572["3572: Computer Storage Devices"]
    style N3572 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3572 |
| Market Segment | Computer Storage Devices |
...
*Source: SIC 3572 - Computer Storage Devices*
