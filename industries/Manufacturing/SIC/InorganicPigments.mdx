...
Inorganic Pigments represents an important category within the Manufacturing sector (SIC 2816).
...
graph TD
    ...
    S3133 --> N2816["2816: Inorganic Pigments"]
    style N2816 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2816 |
| Market Segment | Inorganic Pigments |
...
*Source: SIC 2816 - Inorganic Pigments*
