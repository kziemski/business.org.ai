...
Metal Doors represents an important category within the Manufacturing sector (SIC 3442).
...
graph TD
    ...
    S3133 --> N3442["3442: Metal Doors"]
    style N3442 fill:#f96,stroke:#333,stroke-width:2px
```
