...
Women's Handbags represents an important category within the Manufacturing sector (SIC 3171).
...
graph TD
    ...
    S3133 --> N3171["3171: Women's Handbags"]
    style N3171 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3171 |
| Market Segment | Women's Handbags |
...
*Source: SIC 3171 - Women's Handbags*
