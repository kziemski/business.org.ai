...
Fixtures represents an important category within the Manufacturing sector (SIC 2599).
...
graph TD
    ...
    S3133 --> N2599["2599: Fixtures"]
    style N2599 fill:#f96,stroke:#333,stroke-width:2px
```
