...
Fluid Milk represents an important category within the Manufacturing sector (SIC 2026).
...
graph TD
    ...
    S3133 --> N2026["2026: Fluid Milk"]
    style N2026 fill:#f96,stroke:#333,stroke-width:2px
```
