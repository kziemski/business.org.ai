---
id: CurrentCarryingWiringDevices
...
Current-Carrying Wiring Devices represents an important category within the Manufacturing sector (SIC 3643).
...
graph TD
    ...
    S3133 --> N3643["3643: Current-Carrying Wiring Devices"]
    style N3643 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3643 |
| Market Segment | Current-Carrying Wiring Devices |
...
*Source: SIC 3643 - Current-Carrying Wiring Devices*
