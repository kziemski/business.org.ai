---
id: SpaceVehiclePropulsionUnits
name: Space Vehicle Propulsion Units
code: 3764
type: Industry
level: SIC (3764)
status: complete
...
Space Vehicle Propulsion Units represents an important category within the Manufacturing sector (SIC 3764).
...
graph TD
    ...
    S3133 --> N3764["3764: Space Vehicle Propulsion Units"]
    style N3764 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3764 |
| Market Segment | Space Vehicle Propulsion Units |
...
*Source: SIC 3764 - Space Vehicle Propulsion Units*
