---
id: ServiceIndustryMachinery
name: Service Industry Machinery
code: 3589
type: Industry
level: SIC (3589)
status: complete
...
Service Industry Machinery represents an important category within the Manufacturing sector (SIC 3589).
...
graph TD
    ...
    S3133 --> N3589["3589: Service Industry Machinery"]
    style N3589 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3589 |
| Market Segment | Service Industry Machinery |
...
*Source: SIC 3589 - Service Industry Machinery*
