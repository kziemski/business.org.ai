...
Computer Terminals represents an important category within the Manufacturing sector (SIC 3575).
...
graph TD
    ...
    S3133 --> N3575["3575: Computer Terminals"]
    style N3575 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3575 |
| Market Segment | Computer Terminals |
...
*Source: SIC 3575 - Computer Terminals*
