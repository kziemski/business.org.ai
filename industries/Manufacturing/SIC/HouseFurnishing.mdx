...
House furnishing represents an important category within the Manufacturing sector (SIC 2392).
...
graph TD
    ...
    S3133 --> N2392["2392: House furnishing"]
    style N2392 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2392 |
| Market Segment | House furnishing |
...
*Source: SIC 2392 - House furnishing*
