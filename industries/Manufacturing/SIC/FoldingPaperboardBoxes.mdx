...
Folding Paperboard Boxes represents an important category within the Manufacturing sector (SIC 2657).
...
graph TD
    ...
    S3133 --> N2657["2657: Folding Paperboard Boxes"]
    style N2657 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2657 |
| Market Segment | Folding Paperboard Boxes |
...
*Source: SIC 2657 - Folding Paperboard Boxes*
