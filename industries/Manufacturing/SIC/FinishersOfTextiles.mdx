---
id: FinishersOfTextiles
name: Finishers of Textiles
code: 2269
type: Industry
level: SIC (2269)
status: complete
...
Finishers of Textiles represents an important category within the Manufacturing sector (SIC 2269).
...
graph TD
    ...
    S3133 --> N2269["2269: Finishers of Textiles"]
    style N2269 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2269 |
| Market Segment | Finishers of Textiles |
...
*Source: SIC 2269 - Finishers of Textiles*
