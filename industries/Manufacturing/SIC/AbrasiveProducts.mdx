...
Abrasive Products represents an important category within the Manufacturing sector (SIC 3291).
...
graph TD
    ...
    S3133 --> N3291["3291: Abrasive Products"]
    style N3291 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3291 |
| Market Segment | Abrasive Products |
...
*Source: SIC 3291 - Abrasive Products*
