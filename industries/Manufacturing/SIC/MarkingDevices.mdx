...
Marking Devices represents an important category within the Manufacturing sector (SIC 3953).
...
graph TD
    ...
    S3133 --> N3953["3953: Marking Devices"]
    style N3953 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3953 |
| Market Segment | Marking Devices |
...
*Source: SIC 3953 - Marking Devices*
