---
id: PreparedFreshOrFrozenFish
name: Prepared Fresh or Frozen Fish
code: 2092
type: Industry
level: SIC (2092)
status: complete
...
Prepared Fresh or Frozen Fish represents an important category within the Manufacturing sector (SIC 2092).
...
graph TD
    ...
    S3133 --> N2092["2092: Prepared Fresh or Frozen Fish"]
    style N2092 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2092 |
| Market Segment | Prepared Fresh or Frozen Fish |
...
*Source: SIC 2092 - Prepared Fresh or Frozen Fish*
