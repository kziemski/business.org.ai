...
Gypsum Products represents an important category within the Manufacturing sector (SIC 3275).
...
graph TD
    ...
    N327 --> N3275["3275: Gypsum Products"]
    style N3275 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3275 |
| Market Segment | Gypsum Products |
...
*Source: SIC 3275 - Gypsum Products*
