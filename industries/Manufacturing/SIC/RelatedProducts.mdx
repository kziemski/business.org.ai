...
Related Products represents an important category within the Manufacturing sector (SIC 2394).
...
graph TD
    ...
    S3133 --> N2394["2394: Related Products"]
    style N2394 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2394 |
| Market Segment | Related Products |
...
*Source: SIC 2394 - Related Products*
