...
Costume Novelties represents an important category within the Manufacturing sector (SIC 3961).
...
graph TD
    ...
    S3133 --> N3961["3961: Costume Novelties"]
    style N3961 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3961 |
| Market Segment | Costume Novelties |
...
*Source: SIC 3961 - Costume Novelties*
