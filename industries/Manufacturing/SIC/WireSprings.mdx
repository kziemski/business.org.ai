...
Wire Springs represents an important category within the Manufacturing sector (SIC 3495).
...
graph TD
    ...
    S3133 --> N3495["3495: Wire Springs"]
    style N3495 fill:#f96,stroke:#333,stroke-width:2px
```
