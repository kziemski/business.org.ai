...
Explosives represents an important category within the Manufacturing sector (SIC 2892).
...
graph TD
    ...
    S3133 --> N2892["2892: Explosives"]
    style N2892 fill:#f96,stroke:#333,stroke-width:2px
```
