---
id: ChemicalPreparations
name: Chemical Preparations
code: 2899
type: Industry
level: SIC (2899)
status: complete
...
Chemical Preparations represents an important category within the Manufacturing sector (SIC 2899).
...
graph TD
    ...
    S3133 --> N2899["2899: Chemical Preparations"]
    style N2899 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2899 |
| Market Segment | Chemical Preparations |
...
*Source: SIC 2899 - Chemical Preparations*
