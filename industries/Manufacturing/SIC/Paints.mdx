...
Paints represents an important category within the Manufacturing sector (SIC 2851).
...
graph TD
    ...
    S3133 --> N2851["2851: Paints"]
    style N2851 fill:#f96,stroke:#333,stroke-width:2px
```
