...
Industrial Patterns represents an important category within the Manufacturing sector (SIC 3543).
...
graph TD
    ...
    S3133 --> N3543["3543: Industrial Patterns"]
    style N3543 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3543 |
| Market Segment | Industrial Patterns |
...
*Source: SIC 3543 - Industrial Patterns*
