...
Metal Foil represents an important category within the Manufacturing sector (SIC 3497).
...
graph TD
    ...
    S3133 --> N3497["3497: Metal Foil"]
    style N3497 fill:#f96,stroke:#333,stroke-width:2px
```
