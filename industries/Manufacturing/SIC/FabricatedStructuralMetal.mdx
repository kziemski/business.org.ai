...
Fabricated Structural Metal represents an important category within the Manufacturing sector (SIC 3441).
...
graph TD
    ...
    S3133 --> N3441["3441: Fabricated Structural Metal"]
    style N3441 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3441 |
| Market Segment | Fabricated Structural Metal |
...
*Source: SIC 3441 - Fabricated Structural Metal*
