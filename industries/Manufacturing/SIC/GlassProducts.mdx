...
Glass Products represents an important category within the Manufacturing sector (SIC 3231).
...
graph TD
    ...
    style N3231 fill:#f96,stroke:#333,stroke-width:2px
...
*Source: SIC 3231 - Glass Products*
