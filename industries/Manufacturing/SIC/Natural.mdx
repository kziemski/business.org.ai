...
Natural represents an important category within the Manufacturing sector (SIC 2022).
...
graph TD
    ...
    S3133 --> N2022["2022: Natural"]
    style N2022 fill:#f96,stroke:#333,stroke-width:2px
```
