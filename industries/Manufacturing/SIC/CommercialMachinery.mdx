...
Commercial Machinery represents an important category within the Manufacturing sector (SIC 3599).
...
graph TD
    ...
    S3133 --> N3599["3599: Commercial Machinery"]
    style N3599 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3599 |
| Market Segment | Commercial Machinery |
...
*Source: SIC 3599 - Commercial Machinery*
