...
Meat Packing Plants represents an important category within the Manufacturing sector (SIC 2011).
...
graph TD
    ...
    S3133 --> N2011["2011: Meat Packing Plants"]
    style N2011 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2011 |
| Market Segment | Meat Packing Plants |
...
*Source: SIC 2011 - Meat Packing Plants*
