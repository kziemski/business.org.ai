...
Truck Trailers represents an important category within the Manufacturing sector (SIC 3715).
...
graph TD
    ...
    S3133 --> N3715["3715: Truck Trailers"]
    style N3715 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3715 - Truck Trailers*
