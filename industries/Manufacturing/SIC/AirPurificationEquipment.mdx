---
id: AirPurificationEquipment
name: Air Purification Equipment
code: 3564
type: Industry
level: SIC (3564)
status: complete
...
Air Purification Equipment represents an important category within the Manufacturing sector (SIC 3564).
...
graph TD
    ...
    S3133 --> N3564["3564: Air Purification Equipment"]
    style N3564 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3564 |
| Market Segment | Air Purification Equipment |
...
*Source: SIC 3564 - Air Purification Equipment*
