...
Perfumes represents an important category within the Manufacturing sector (SIC 2844).
...
graph TD
    ...
    S3133 --> N2844["2844: Perfumes"]
    style N2844 fill:#f96,stroke:#333,stroke-width:2px
```
