...
Dehydrated Fruits represents an important category within the Manufacturing sector (SIC 2034).
...
graph TD
    ...
    S3133 --> N2034["2034: Dehydrated Fruits"]
    style N2034 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2034 |
| Market Segment | Dehydrated Fruits |
...
*Source: SIC 2034 - Dehydrated Fruits*
