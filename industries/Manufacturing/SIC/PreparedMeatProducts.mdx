---
id: PreparedMeatProducts
name: Prepared Meat Products
code: 2013
type: Industry
level: SIC (2013)
status: complete
...
Prepared Meat Products represents an important category within the Manufacturing sector (SIC 2013).
...
graph TD
    ...
    S3133 --> N2013["2013: Prepared Meat Products"]
    style N2013 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2013 |
| Market Segment | Prepared Meat Products |
...
*Source: SIC 2013 - Prepared Meat Products*
