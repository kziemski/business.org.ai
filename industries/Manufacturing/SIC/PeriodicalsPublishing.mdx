---
id: PeriodicalsPublishing
name: "Periodicals: Publishing"
code: 2721
type: Industry
level: SIC (2721)
status: complete
...
Periodicals: Publishing represents an important category within the Manufacturing sector (SIC 2721).
...
graph TD
    ...
    S3133 --> N2721["2721: Periodicals: Publishing"]
    style N2721 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2721 |
| Market Segment | Periodicals: Publishing |
...
*Source: SIC 2721 - Periodicals: Publishing*
