---
id: PersonalLeatherGoods
name: Personal Leather Goods
code: 3172
type: Industry
level: SIC (3172)
status: complete
...
Personal Leather Goods represents an important category within the Manufacturing sector (SIC 3172).
...
graph TD
    ...
    S3133 --> N3172["3172: Personal Leather Goods"]
    style N3172 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3172 |
| Market Segment | Personal Leather Goods |
...
*Source: SIC 3172 - Personal Leather Goods*
