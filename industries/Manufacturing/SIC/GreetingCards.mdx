...
Greeting Cards represents an important category within the Manufacturing sector (SIC 2771).
...
graph TD
    ...
    S3133 --> N2771["2771: Greeting Cards"]
    style N2771 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2771 - Greeting Cards*
