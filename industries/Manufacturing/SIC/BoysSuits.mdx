...
Boys' Suits represents an important category within the Manufacturing sector (SIC 2311).
...
graph TD
    ...
    S3133 --> N2311["2311: Boys' Suits"]
    style N2311 fill:#f96,stroke:#333,stroke-width:2px
```
