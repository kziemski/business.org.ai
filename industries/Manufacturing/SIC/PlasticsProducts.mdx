...
Plastics Products represents an important category within the Manufacturing sector (SIC 3089).
...
graph TD
    ...
    S3133 --> N3089["3089: Plastics Products"]
    style N3089 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3089 |
| Market Segment | Plastics Products |
...
*Source: SIC 3089 - Plastics Products*
