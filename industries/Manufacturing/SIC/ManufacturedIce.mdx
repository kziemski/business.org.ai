...
Manufactured Ice represents an important category within the Manufacturing sector (SIC 2097).
...
graph TD
    ...
    S3133 --> N2097["2097: Manufactured Ice"]
    style N2097 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2097 |
| Market Segment | Manufactured Ice |
...
*Source: SIC 2097 - Manufactured Ice*
