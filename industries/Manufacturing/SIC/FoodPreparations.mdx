...
Food Preparations represents an important category within the Manufacturing sector (SIC 2099).
...
graph TD
    ...
    S3133 --> N2099["2099: Food Preparations"]
    style N2099 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2099 |
| Market Segment | Food Preparations |
...
*Source: SIC 2099 - Food Preparations*
