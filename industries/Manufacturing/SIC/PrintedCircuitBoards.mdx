...
Printed Circuit Boards represents an important category within the Manufacturing sector (SIC 3672).
...
graph TD
    ...
    S3133 --> N3672["3672: Printed Circuit Boards"]
    style N3672 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3672 |
| Market Segment | Printed Circuit Boards |
...
*Source: SIC 3672 - Printed Circuit Boards*
