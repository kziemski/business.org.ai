...
Mobile Homes represents an important category within the Manufacturing sector (SIC 2451).
...
graph TD
    ...
    S3133 --> N2451["2451: Mobile Homes"]
    style N2451 fill:#f96,stroke:#333,stroke-width:2px
```
