...
Pleating represents an important category within the Manufacturing sector (SIC 2395).
...
graph TD
    ...
    S3133 --> N2395["2395: Pleating"]
    style N2395 fill:#f96,stroke:#333,stroke-width:2px
```
