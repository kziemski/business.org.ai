---
id: SchiffliMachineEmbroideries
...
Schiffli Machine Embroideries represents an important category within the Manufacturing sector (SIC 2397).
...
graph TD
    ...
    S3133 --> N2397["2397: Schiffli Machine Embroideries"]
    style N2397 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2397 |
| Market Segment | Schiffli Machine Embroideries |
...
*Source: SIC 2397 - Schiffli Machine Embroideries*
