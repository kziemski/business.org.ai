...
Textile Machinery represents an important category within the Manufacturing sector (SIC 3552).
...
graph TD
    ...
    S3133 --> N3552["3552: Textile Machinery"]
    style N3552 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3552 |
| Market Segment | Textile Machinery |
...
*Source: SIC 3552 - Textile Machinery*
