...
Laboratory Apparatus represents an important category within the Manufacturing sector (SIC 3821).
...
graph TD
    ...
    S3133 --> N3821["3821: Laboratory Apparatus"]
    style N3821 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3821 |
| Market Segment | Laboratory Apparatus |
...
*Source: SIC 3821 - Laboratory Apparatus*
