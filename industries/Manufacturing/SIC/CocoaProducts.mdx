...
Cocoa Products represents an important category within the Manufacturing sector (SIC 2066).
...
graph TD
    ...
    S3133 --> N2066["2066: Cocoa Products"]
    style N2066 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2066 - Cocoa Products*
