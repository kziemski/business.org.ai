---
id: AutomaticControlsForRegulatingResidential
name: Automatic Controls for Regulating Residential
code: 3822
type: Industry
level: SIC (3822)
status: complete
...
Automatic Controls for Regulating Residential represents an important category within the Manufacturing sector (SIC 3822).
...
graph TD
    ...
    S3133 --> N3822["3822: Automatic Controls for Regulating Res..."]
    style N3822 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3822 |
| Market Segment | Automatic Controls for Regulating Residential |
...
*Source: SIC 3822 - Automatic Controls for Regulating Residential*
