...
Nonmetallic Mineral Products represents an important category within the Manufacturing sector (SIC 3299).
...
graph TD
    ...
    S3133 --> N3299["3299: Nonmetallic Mineral Products"]
    style N3299 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3299 |
| Market Segment | Nonmetallic Mineral Products |
...
*Source: SIC 3299 - Nonmetallic Mineral Products*
