---
id: LockCornerWoodBoxes
name: Lock Corner Wood Boxes
code: 2441
type: Industry
level: SIC (2441)
status: complete
...
# Lock Corner Wood Boxes

> Nailed and Lock Corner Wood Boxes and Shook.

## Overview

Lock Corner Wood Boxes represents an important category within the Manufacturing sector (SIC 2441).
...
graph TD
    ...
    S3133 --> N2441["2441: Lock Corner Wood Boxes"]
    style N2441 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2441 |
| Market Segment | Lock Corner Wood Boxes |
...
*Source: SIC 2441 - Lock Corner Wood Boxes*
