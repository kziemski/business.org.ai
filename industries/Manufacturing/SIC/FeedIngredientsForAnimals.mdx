---
id: FeedIngredientsForAnimals
name: Feed Ingredients for Animals
code: 2048
type: Industry
level: SIC (2048)
status: complete
...
Feed Ingredients for Animals represents an important category within the Manufacturing sector (SIC 2048).
...
graph TD
    ...
    S3133 --> N2048["2048: Feed Ingredients for Animals"]
    style N2048 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2048 |
| Market Segment | Feed Ingredients for Animals |
...
*Source: SIC 2048 - Feed Ingredients for Animals*
