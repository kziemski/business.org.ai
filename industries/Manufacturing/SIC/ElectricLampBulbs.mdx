---
id: ElectricLampBulbs
name: Electric Lamp Bulbs
code: 3641
type: Industry
level: SIC (3641)
status: complete
...
Electric Lamp Bulbs represents an important category within the Manufacturing sector (SIC 3641).
...
graph TD
    ...
    S3133 --> N3641["3641: Electric Lamp Bulbs"]
    style N3641 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3641 |
| Market Segment | Electric Lamp Bulbs |
...
*Source: SIC 3641 - Electric Lamp Bulbs*
