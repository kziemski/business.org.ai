...
Accounting Machines represents an important category within the Manufacturing sector (SIC 3578).
...
graph TD
    ...
    S3133 --> N3578["3578: Accounting Machines"]
    style N3578 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3578 |
| Market Segment | Accounting Machines |
...
*Source: SIC 3578 - Accounting Machines*
