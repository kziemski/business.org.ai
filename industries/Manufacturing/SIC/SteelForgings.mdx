...
Steel Forgings represents an important category within the Manufacturing sector (SIC 3462).
...
graph TD
    ...
    S3133 --> N3462["3462: Steel Forgings"]
    style N3462 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3462 - Steel Forgings*
