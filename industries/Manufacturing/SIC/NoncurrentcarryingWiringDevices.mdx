---
id: NoncurrentCarryingWiringDevices
...
Noncurrent-Carrying Wiring Devices represents an important category within the Manufacturing sector (SIC 3644).
...
graph TD
    ...
    S3133 --> N3644["3644: Noncurrent-Carrying Wiring Devices"]
    style N3644 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3644 |
| Market Segment | Noncurrent-Carrying Wiring Devices |
...
*Source: SIC 3644 - Noncurrent-Carrying Wiring Devices*
