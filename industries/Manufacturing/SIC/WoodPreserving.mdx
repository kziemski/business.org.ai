...
Wood Preserving represents an important category within the Manufacturing sector (SIC 2491).
...
graph TD
    ...
    S3133 --> N2491["2491: Wood Preserving"]
    style N2491 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2491 |
| Market Segment | Wood Preserving |
...
*Source: SIC 2491 - Wood Preserving*
