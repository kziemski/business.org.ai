...
Lighting Equipment represents an important category within the Manufacturing sector (SIC 3648).
...
graph TD
    ...
    S3133 --> N3648["3648: Lighting Equipment"]
    style N3648 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3648 |
| Market Segment | Lighting Equipment |
...
*Source: SIC 3648 - Lighting Equipment*
