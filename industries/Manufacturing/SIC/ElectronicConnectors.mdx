...
Electronic Connectors represents an important category within the Manufacturing sector (SIC 3678).
...
graph TD
    ...
    S3133 --> N3678["3678: Electronic Connectors"]
    style N3678 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3678 |
| Market Segment | Electronic Connectors |
...
*Source: SIC 3678 - Electronic Connectors*
