...
Creamery Butter represents an important category within the Manufacturing sector (SIC 2021).
...
graph TD
    ...
    S3133 --> N2021["2021: Creamery Butter"]
    style N2021 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2021 |
| Market Segment | Creamery Butter |
...
*Source: SIC 2021 - Creamery Butter*
