...
Hosiery represents an important category within the Manufacturing sector (SIC 2252).
...
graph TD
    ...
    S3133 --> N2252["2252: Hosiery"]
    style N2252 fill:#f96,stroke:#333,stroke-width:2px
```
