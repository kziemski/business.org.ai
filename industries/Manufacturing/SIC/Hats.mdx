...
Hats represents an important category within the Manufacturing sector (SIC 2353).
...
graph TD
    ...
    S3133 --> N2353["2353: Hats"]
    style N2353 fill:#f96,stroke:#333,stroke-width:2px
```
