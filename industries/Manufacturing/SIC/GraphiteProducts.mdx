...
Graphite Products represents an important category within the Manufacturing sector (SIC 3624).
...
graph TD
    ...
    S3133 --> N3624["3624: Graphite Products"]
    style N3624 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3624 |
| Market Segment | Graphite Products |
...
*Source: SIC 3624 - Graphite Products*
