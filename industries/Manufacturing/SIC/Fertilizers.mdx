...
Fertilizers represents an important category within the Manufacturing sector (SIC 2875).
...
graph TD
    ...
    S3133 --> N2875["2875: Fertilizers"]
    style N2875 fill:#f96,stroke:#333,stroke-width:2px
```
