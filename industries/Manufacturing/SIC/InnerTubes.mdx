...
Inner Tubes represents an important category within the Manufacturing sector (SIC 3011).
...
graph TD
    ...
    S3133 --> N3011["3011: Inner Tubes"]
    style N3011 fill:#f96,stroke:#333,stroke-width:2px
```
