...
Pumping Equipment represents an important category within the Manufacturing sector (SIC 3561).
...
graph TD
    ...
    S3133 --> N3561["3561: Pumping Equipment"]
    style N3561 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3561 |
| Market Segment | Pumping Equipment |
...
*Source: SIC 3561 - Pumping Equipment*
