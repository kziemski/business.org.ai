...
Conveying Equipment represents an important category within the Manufacturing sector (SIC 3535).
...
graph TD
    ...
    S3133 --> N3535["3535: Conveying Equipment"]
    style N3535 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3535 |
| Market Segment | Conveying Equipment |
...
*Source: SIC 3535 - Conveying Equipment*
