...
Apparel belts represents an important category within the Manufacturing sector (SIC 2387).
...
graph TD
    ...
    N238 --> N2387["2387: Apparel belts"]
    style N2387 fill:#f96,stroke:#333,stroke-width:2px
```
