...
Chlorine represents an important category within the Manufacturing sector (SIC 2812).
...
graph TD
    ...
    S3133 --> N2812["2812: Chlorine"]
    style N2812 fill:#f96,stroke:#333,stroke-width:2px
```
