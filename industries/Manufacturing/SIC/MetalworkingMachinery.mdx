...
Metalworking Machinery represents an important category within the Manufacturing sector (SIC 3549).
...
graph TD
    ...
    S3133 --> N3549["3549: Metalworking Machinery"]
    style N3549 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3549 |
| Market Segment | Metalworking Machinery |
...
*Source: SIC 3549 - Metalworking Machinery*
