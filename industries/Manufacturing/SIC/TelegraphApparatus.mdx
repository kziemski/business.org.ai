---
id: TelegraphApparatus
name: Telegraph Apparatus
code: 3661
type: Industry
level: SIC (3661)
status: complete
...
Telegraph Apparatus represents an important category within the Manufacturing sector (SIC 3661).
...
graph TD
    ...
    S3133 --> N3661["3661: Telegraph Apparatus"]
    style N3661 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3661 |
| Market Segment | Telegraph Apparatus |
...
*Source: SIC 3661 - Telegraph Apparatus*
