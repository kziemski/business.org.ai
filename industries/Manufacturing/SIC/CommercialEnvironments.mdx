...
Commercial Environments represents an important category within the Manufacturing sector (SIC 3822).
...
graph TD
    ...
    S3133 --> N3822["3822: Commercial Environments"]
...
| NAICS/SIC Code | 3822 |
| Market Segment | Commercial Environments |
...
*Source: SIC 3822 - Commercial Environments*
