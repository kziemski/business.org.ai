---
id: FabricatedPlateWorkBoilerShops
...
Fabricated Plate Work (Boiler Shops) represents an important category within the Manufacturing sector (SIC 3443).
...
graph TD
    ...
    S3133 --> N3443["3443: Fabricated Plate Work (Boiler Shops)"]
    style N3443 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3443 |
| Market Segment | Fabricated Plate Work (Boiler Shops) |
...
*Source: SIC 3443 - Fabricated Plate Work (Boiler Shops)*
