...
Guided Missiles represents an important category within the Manufacturing sector (SIC 3761).
...
graph TD
    ...
    S3133 --> N3761["3761: Guided Missiles"]
    style N3761 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3761 |
| Market Segment | Guided Missiles |
...
*Source: SIC 3761 - Guided Missiles*
