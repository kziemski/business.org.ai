...
Ophthalmic Goods represents an important category within the Manufacturing sector (SIC 3851).
...
graph TD
    ...
    S3133 --> N3851["3851: Ophthalmic Goods"]
    style N3851 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3851 |
| Market Segment | Ophthalmic Goods |
...
*Source: SIC 3851 - Ophthalmic Goods*
