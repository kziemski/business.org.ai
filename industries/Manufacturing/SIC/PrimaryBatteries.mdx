...
Primary Batteries represents an important category within the Manufacturing sector (SIC 3692).
...
graph TD
    ...
    S3133 --> N3692["3692: Primary Batteries"]
    style N3692 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3692 |
| Market Segment | Primary Batteries |
...
*Source: SIC 3692 - Primary Batteries*
