...
Wood Products represents an important category within the Manufacturing sector (SIC 2499).
...
graph TD
    ...
    S3133 --> N2499["2499: Wood Products"]
    style N2499 fill:#f96,stroke:#333,stroke-width:2px
```
