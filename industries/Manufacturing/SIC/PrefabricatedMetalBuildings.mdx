---
id: PrefabricatedMetalBuildings
...
Prefabricated Metal Buildings represents an important category within the Manufacturing sector (SIC 3448).
...
graph TD
    ...
    S3133 --> N3448["3448: Prefabricated Metal Buildings"]
    style N3448 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3448 |
| Market Segment | Prefabricated Metal Buildings |
...
*Source: SIC 3448 - Prefabricated Metal Buildings*
