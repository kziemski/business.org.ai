...
Printing Trades Machinery represents an important category within the Manufacturing sector (SIC 3555).
...
graph TD
    ...
    S3133 --> N3555["3555: Printing Trades Machinery"]
    style N3555 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3555 |
| Market Segment | Printing Trades Machinery |
...
*Source: SIC 3555 - Printing Trades Machinery*
