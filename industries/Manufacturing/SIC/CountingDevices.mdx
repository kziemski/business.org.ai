...
Counting Devices represents an important category within the Manufacturing sector (SIC 3824).
...
graph TD
    ...
    S3133 --> N3824["3824: Counting Devices"]
...
| NAICS/SIC Code | 3824 |
| Market Segment | Counting Devices |
...
*Source: SIC 3824 - Counting Devices*
