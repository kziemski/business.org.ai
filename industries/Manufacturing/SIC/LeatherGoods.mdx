...
Leather Goods represents an important category within the Manufacturing sector (SIC 3199).
...
graph TD
    ...
    S3133 --> N3199["3199: Leather Goods"]
    style N3199 fill:#f96,stroke:#333,stroke-width:2px
```
