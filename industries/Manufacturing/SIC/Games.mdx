...
Games represents an important category within the Manufacturing sector (SIC 3944).
...
graph TD
    ...
    S3133 --> N3944["3944: Games"]
    style N3944 fill:#f96,stroke:#333,stroke-width:2px
```
