...
Coated Fabrics represents an important category within the Manufacturing sector (SIC 2295).
...
graph TD
    ...
    S3133 --> N2295["2295: Coated Fabrics"]
    style N2295 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2295 - Coated Fabrics*
