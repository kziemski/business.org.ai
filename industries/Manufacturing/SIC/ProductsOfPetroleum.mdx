---
id: ProductsOfPetroleum
name: Products of Petroleum
code: 2999
type: Industry
level: SIC (2999)
status: complete
...
Products of Petroleum represents an important category within the Manufacturing sector (SIC 2999).
...
graph TD
    ...
    S3133 --> N2999["2999: Products of Petroleum"]
    style N2999 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2999 |
| Market Segment | Products of Petroleum |
...
*Source: SIC 2999 - Products of Petroleum*
