...
Vehicular Lighting Equipment represents an important category within the Manufacturing sector (SIC 3647).
...
graph TD
    ...
    S3133 --> N3647["3647: Vehicular Lighting Equipment"]
    style N3647 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3647 |
| Market Segment | Vehicular Lighting Equipment |
...
*Source: SIC 3647 - Vehicular Lighting Equipment*
