...
Nonclay Refractories represents an important category within the Manufacturing sector (SIC 3297).
...
graph TD
    ...
    S3133 --> N3297["3297: Nonclay Refractories"]
    style N3297 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3297 |
| Market Segment | Nonclay Refractories |
...
*Source: SIC 3297 - Nonclay Refractories*
