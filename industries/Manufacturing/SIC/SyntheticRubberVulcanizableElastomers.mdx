---
id: SyntheticRubberVulcanizableElastomers
...
Synthetic Rubber (Vulcanizable Elastomers) represents an important category within the Manufacturing sector (SIC 2822).
...
graph TD
    ...
    S3133 --> N2822["2822: Synthetic Rubber (Vulcanizable Elasto..."]
    style N2822 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2822 |
| Market Segment | Synthetic Rubber (Vulcanizable Elastomers) |
...
*Source: SIC 2822 - Synthetic Rubber (Vulcanizable Elastomers)*
