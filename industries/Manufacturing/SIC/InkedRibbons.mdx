...
Inked Ribbons represents an important category within the Manufacturing sector (SIC 3955).
...
graph TD
    ...
    S3133 --> N3955["3955: Inked Ribbons"]
    style N3955 fill:#f96,stroke:#333,stroke-width:2px
```
