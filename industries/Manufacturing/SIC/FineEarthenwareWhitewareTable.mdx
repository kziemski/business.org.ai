---
id: FineEarthenwareWhitewareTable
name: Fine Earthenware (Whiteware) Table
code: 3263
type: Industry
level: SIC (3263)
status: complete
...
Fine Earthenware (Whiteware) Table represents an important category within the Manufacturing sector (SIC 3263).
...
graph TD
    ...
    N326 --> N3263["3263: Fine Earthenware (Whiteware) Table"]
    style N3263 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3263 |
| Market Segment | Fine Earthenware (Whiteware) Table |
...
*Source: SIC 3263 - Fine Earthenware (Whiteware) Table*
