---
id: ElectrotherapeuticApparatus
name: Electrotherapeutic Apparatus
code: 3845
type: Industry
level: SIC (3845)
status: complete
...
Electrotherapeutic Apparatus represents an important category within the Manufacturing sector (SIC 3845).
...
graph TD
    ...
    S3133 --> N3845["3845: Electrotherapeutic Apparatus"]
    style N3845 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3845 |
| Market Segment | Electrotherapeutic Apparatus |
...
*Source: SIC 3845 - Electrotherapeutic Apparatus*
