...
Bolts represents an important category within the Manufacturing sector (SIC 3452).
...
graph TD
    ...
    S3133 --> N3452["3452: Bolts"]
    style N3452 fill:#f96,stroke:#333,stroke-width:2px
```
