...
Passenger Car Bodies represents an important category within the Manufacturing sector (SIC 3711).
...
graph TD
    ...
    S3133 --> N3711["3711: Passenger Car Bodies"]
    style N3711 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3711 |
| Market Segment | Passenger Car Bodies |
...
*Source: SIC 3711 - Passenger Car Bodies*
