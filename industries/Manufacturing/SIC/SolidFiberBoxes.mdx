...
Solid Fiber Boxes represents an important category within the Manufacturing sector (SIC 2653).
...
graph TD
    ...
    S3133 --> N2653["2653: Solid Fiber Boxes"]
    style N2653 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2653 |
| Market Segment | Solid Fiber Boxes |
...
*Source: SIC 2653 - Solid Fiber Boxes*
