...
Dressing Gowns represents an important category within the Manufacturing sector (SIC 2384).
...
graph TD
    ...
    N238 --> N2384["2384: Dressing Gowns"]
    style N2384 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2384 - Dressing Gowns*
