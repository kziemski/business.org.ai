...
Chewing Gum represents an important category within the Manufacturing sector (SIC 2067).
...
graph TD
    ...
    S3133 --> N2067["2067: Chewing Gum"]
    style N2067 fill:#f96,stroke:#333,stroke-width:2px
```
