...
Publishing represents an important category within the Manufacturing sector (SIC 2741).
...
graph TD
    ...
    S3133 --> N2741["2741: Publishing"]
    style N2741 fill:#f96,stroke:#333,stroke-width:2px
```
