...
Closures represents an important category within the Manufacturing sector (SIC 3466).
...
graph TD
    ...
    S3133 --> N3466["3466: Closures"]
    style N3466 fill:#f96,stroke:#333,stroke-width:2px
```
