...
Brushes represents an important category within the Manufacturing sector (SIC 3991).
...
graph TD
    ...
    S3133 --> N3991["3991: Brushes"]
    style N3991 fill:#f96,stroke:#333,stroke-width:2px
```
