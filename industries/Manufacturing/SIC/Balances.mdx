...
Balances represents an important category within the Manufacturing sector (SIC 3596).
...
graph TD
    ...
    S3133 --> N3596["3596: Balances"]
    style N3596 fill:#f96,stroke:#333,stroke-width:2px
```
