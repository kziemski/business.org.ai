...
Beet Sugar represents an important category within the Manufacturing sector (SIC 2063).
...
graph TD
    ...
    S3133 --> N2063["2063: Beet Sugar"]
    style N2063 fill:#f96,stroke:#333,stroke-width:2px
```
