...
Frozen Desserts represents an important category within the Manufacturing sector (SIC 2024).
...
graph TD
    ...
    S3133 --> N2024["2024: Frozen Desserts"]
    style N2024 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2024 |
| Market Segment | Frozen Desserts |
...
*Source: SIC 2024 - Frozen Desserts*
