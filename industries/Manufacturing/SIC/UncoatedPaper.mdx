...
Uncoated Paper represents an important category within the Manufacturing sector (SIC 2674).
...
graph TD
    ...
    S3133 --> N2674["2674: Uncoated Paper"]
    style N2674 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2674 - Uncoated Paper*
