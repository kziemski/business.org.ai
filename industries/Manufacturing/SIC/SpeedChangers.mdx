...
Speed Changers represents an important category within the Manufacturing sector (SIC 3566).
...
graph TD
    ...
    S3133 --> N3566["3566: Speed Changers"]
    style N3566 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 3566 - Speed Changers*
