...
Cutting Tools represents an important category within the Manufacturing sector (SIC 3545).
...
graph TD
    ...
    S3133 --> N3545["3545: Cutting Tools"]
    style N3545 fill:#f96,stroke:#333,stroke-width:2px
```
