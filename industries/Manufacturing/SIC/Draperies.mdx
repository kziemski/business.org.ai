...
Draperies represents an important category within the Manufacturing sector (SIC 2391).
...
graph TD
    ...
    S3133 --> N2391["2391: Draperies"]
    style N2391 fill:#f96,stroke:#333,stroke-width:2px
```
