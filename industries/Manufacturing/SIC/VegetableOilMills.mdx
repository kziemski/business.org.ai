---
id: VegetableOilMills
name: Vegetable Oil Mills
code: 2076
type: Industry
level: SIC (2076)
status: complete
...
Vegetable Oil Mills represents an important category within the Manufacturing sector (SIC 2076).
...
graph TD
    ...
    S3133 --> N2076["2076: Vegetable Oil Mills"]
    style N2076 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2076 |
| Market Segment | Vegetable Oil Mills |
...
*Source: SIC 2076 - Vegetable Oil Mills*
