...
Orthopedic represents an important category within the Manufacturing sector (SIC 3842).
...
graph TD
    ...
    S3133 --> N3842["3842: Orthopedic"]
    style N3842 fill:#f96,stroke:#333,stroke-width:2px
```
