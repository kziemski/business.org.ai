...
Platemaking represents an important category within the Manufacturing sector (SIC 2796).
...
graph TD
    ...
    S3133 --> N2796["2796: Platemaking"]
    style N2796 fill:#f96,stroke:#333,stroke-width:2px
```
