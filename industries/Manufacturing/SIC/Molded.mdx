...
Molded represents an important category within the Manufacturing sector (SIC 3061).
...
graph TD
    ...
    S3133 --> N3061["3061: Molded"]
    style N3061 fill:#f96,stroke:#333,stroke-width:2px
```
