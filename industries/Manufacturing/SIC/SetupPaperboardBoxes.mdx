...
Setup Paperboard Boxes represents an important category within the Manufacturing sector (SIC 2652).
...
graph TD
    ...
    S3133 --> N2652["2652: Setup Paperboard Boxes"]
    style N2652 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2652 |
| Market Segment | Setup Paperboard Boxes |
...
*Source: SIC 2652 - Setup Paperboard Boxes*
