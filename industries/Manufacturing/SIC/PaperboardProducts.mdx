---
id: PaperboardProducts
name: Paperboard Products
code: 2679
type: Industry
level: SIC (2679)
status: complete
...
Paperboard Products represents an important category within the Manufacturing sector (SIC 2679).
...
graph TD
    ...
    S3133 --> N2679["2679: Paperboard Products"]
    style N2679 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2679 |
| Market Segment | Paperboard Products |
...
*Source: SIC 2679 - Paperboard Products*
