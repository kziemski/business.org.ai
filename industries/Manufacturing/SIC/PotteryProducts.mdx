...
Pottery Products represents an important category within the Manufacturing sector (SIC 3269).
...
graph TD
    ...
    N326 --> N3269["3269: Pottery Products"]
    style N3269 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3269 |
| Market Segment | Pottery Products |
...
*Source: SIC 3269 - Pottery Products*
