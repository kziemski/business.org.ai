...
Die-Cut Paper represents an important category within the Manufacturing sector (SIC 2675).
...
graph TD
    ...
    S3133 --> N2675["2675: Die-Cut Paper"]
    style N2675 fill:#f96,stroke:#333,stroke-width:2px
```
