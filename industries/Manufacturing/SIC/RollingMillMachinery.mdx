...
Rolling Mill Machinery represents an important category within the Manufacturing sector (SIC 3547).
...
graph TD
    ...
    S3133 --> N3547["3547: Rolling Mill Machinery"]
    style N3547 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3547 |
| Market Segment | Rolling Mill Machinery |
...
*Source: SIC 3547 - Rolling Mill Machinery*
