---
id: GuidedMissileSpaceVehicleParts
name: Guided Missile Space Vehicle Parts
code: 3769
type: Industry
level: SIC (3769)
status: complete
...
> Guided Missile Space Vehicle Parts and Auxiliary Equipment.

## Overview

Guided Missile Space Vehicle Parts represents an important category within the Manufacturing sector (SIC 3769).
...
graph TD
    ...
    S3133 --> N3769["3769: Guided Missile Space Vehicle Parts"]
    style N3769 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3769 |
| Market Segment | Guided Missile Space Vehicle Parts |
...
*Source: SIC 3769 - Guided Missile Space Vehicle Parts*
