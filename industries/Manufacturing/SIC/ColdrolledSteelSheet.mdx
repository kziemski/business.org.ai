...
Cold-Rolled Steel Sheet represents an important category within the Manufacturing sector (SIC 3316).
...
graph TD
    ...
    N331 --> N3316["3316: Cold-Rolled Steel Sheet"]
    style N3316 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3316 |
| Market Segment | Cold-Rolled Steel Sheet |
...
*Source: SIC 3316 - Cold-Rolled Steel Sheet*
