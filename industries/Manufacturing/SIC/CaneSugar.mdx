...
Cane Sugar represents an important category within the Manufacturing sector (SIC 2061).
...
graph TD
    ...
    S3133 --> N2061["2061: Cane Sugar"]
    style N2061 fill:#f96,stroke:#333,stroke-width:2px
```
