...
Mattresses represents an important category within the Manufacturing sector (SIC 2515).
...
graph TD
    ...
    S3133 --> N2515["2515: Mattresses"]
    style N2515 fill:#f96,stroke:#333,stroke-width:2px
```
