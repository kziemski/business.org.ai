...
Wood Household Furniture represents an important category within the Manufacturing sector (SIC 2511).
...
graph TD
    ...
    S3133 --> N2511["2511: Wood Household Furniture"]
    style N2511 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2511 |
| Market Segment | Wood Household Furniture |
...
*Source: SIC 2511 - Wood Household Furniture*
