...
Roasted Coffee represents an important category within the Manufacturing sector (SIC 2095).
...
graph TD
    ...
    S3133 --> N2095["2095: Roasted Coffee"]
    style N2095 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2095 - Roasted Coffee*
