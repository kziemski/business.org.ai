...
Grain Mill Products represents an important category within the Manufacturing sector (SIC 2041).
...
graph TD
    ...
    S3133 --> N2041["2041: Grain Mill Products"]
    style N2041 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2041 |
| Market Segment | Grain Mill Products |
...
*Source: SIC 2041 - Grain Mill Products*
