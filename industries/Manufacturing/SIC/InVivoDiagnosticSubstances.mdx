---
id: InVivoDiagnosticSubstances
name: In Vivo Diagnostic Substances
code: 2835
type: Industry
level: SIC (2835)
status: complete
...
In Vivo Diagnostic Substances represents an important category within the Manufacturing sector (SIC 2835).
...
graph TD
    ...
    S3133 --> N2835["2835: In Vivo Diagnostic Substances"]
    style N2835 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2835 |
| Market Segment | In Vivo Diagnostic Substances |
...
*Source: SIC 2835 - In Vivo Diagnostic Substances*
