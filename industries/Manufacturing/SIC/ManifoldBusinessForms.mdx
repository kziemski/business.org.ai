...
Manifold Business Forms represents an important category within the Manufacturing sector (SIC 2761).
...
graph TD
    ...
    S3133 --> N2761["2761: Manifold Business Forms"]
    style N2761 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2761 |
| Market Segment | Manifold Business Forms |
...
*Source: SIC 2761 - Manifold Business Forms*
