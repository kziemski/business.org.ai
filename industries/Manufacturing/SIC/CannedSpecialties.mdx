...
Canned Specialties represents an important category within the Manufacturing sector (SIC 2032).
...
graph TD
    ...
    S3133 --> N2032["2032: Canned Specialties"]
    style N2032 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2032 |
| Market Segment | Canned Specialties |
...
*Source: SIC 2032 - Canned Specialties*
