...
Malt Beverages represents an important category within the Manufacturing sector (SIC 2082).
...
graph TD
    ...
    S3133 --> N2082["2082: Malt Beverages"]
    style N2082 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 2082 - Malt Beverages*
