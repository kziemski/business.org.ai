...
Nonferrous Forgings represents an important category within the Manufacturing sector (SIC 3463).
...
graph TD
    ...
    S3133 --> N3463["3463: Nonferrous Forgings"]
    style N3463 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3463 |
| Market Segment | Nonferrous Forgings |
...
*Source: SIC 3463 - Nonferrous Forgings*
