...
Wood Television represents an important category within the Manufacturing sector (SIC 2517).
...
graph TD
    ...
    S3133 --> N2517["2517: Wood Television"]
    style N2517 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2517 |
| Market Segment | Wood Television |
...
*Source: SIC 2517 - Wood Television*
