...
Linoleum represents an important category within the Manufacturing sector (SIC 3996).
...
graph TD
    ...
    S3133 --> N3996["3996: Linoleum"]
    style N3996 fill:#f96,stroke:#333,stroke-width:2px
```
