...
Bus Bodies represents an important category within the Manufacturing sector (SIC 3713).
...
graph TD
    ...
    S3133 --> N3713["3713: Bus Bodies"]
    style N3713 fill:#f96,stroke:#333,stroke-width:2px
```
