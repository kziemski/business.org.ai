---
id: SwitchboardApparatus
name: Switchboard Apparatus
code: 3613
type: Industry
level: SIC (3613)
status: complete
...
Switchboard Apparatus represents an important category within the Manufacturing sector (SIC 3613).
...
graph TD
    ...
    S3133 --> N3613["3613: Switchboard Apparatus"]
    style N3613 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3613 |
| Market Segment | Switchboard Apparatus |
...
*Source: SIC 3613 - Switchboard Apparatus*
