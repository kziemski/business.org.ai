...
Fabricated Metal Products represents an important category within the Manufacturing sector (SIC 3499).
...
graph TD
    ...
    S3133 --> N3499["3499: Fabricated Metal Products"]
    style N3499 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3499 |
| Market Segment | Fabricated Metal Products |
...
*Source: SIC 3499 - Fabricated Metal Products*
