---
id: SmallwareMillsCotton
name: "Smallware Mills: Cotton"
code: 2241
type: Industry
level: SIC (2241)
status: complete
...
# Smallware Mills: Cotton

> Narrow Fabric and Other Smallware Mills: Cotton.

## Overview

Smallware Mills: Cotton represents an important category within the Manufacturing sector (SIC 2241).
...
graph TD
    ...
    S3133 --> N2241["2241: Smallware Mills: Cotton"]
    style N2241 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2241 |
| Market Segment | Smallware Mills: Cotton |
...
*Source: SIC 2241 - Smallware Mills: Cotton*
