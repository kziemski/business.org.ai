---
id: UnsupportedPlasticsFilm
name: Unsupported Plastics Film
code: 3081
type: Industry
level: SIC (3081)
status: complete
...
Unsupported Plastics Film represents an important category within the Manufacturing sector (SIC 3081).
...
graph TD
    ...
    S3133 --> N3081["3081: Unsupported Plastics Film"]
    style N3081 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3081 |
| Market Segment | Unsupported Plastics Film |
...
*Source: SIC 3081 - Unsupported Plastics Film*
