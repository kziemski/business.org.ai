...
Book Printing represents an important category within the Manufacturing sector (SIC 2732).
...
graph TD
    ...
    S3133 --> N2732["2732: Book Printing"]
    style N2732 fill:#f96,stroke:#333,stroke-width:2px
```
