...
Tubes represents an important category within the Manufacturing sector (SIC 3317).
...
graph TD
    ...
    N331 --> N3317["3317: Tubes"]
    style N3317 fill:#f96,stroke:#333,stroke-width:2px
```
