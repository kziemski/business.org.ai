...
Saw Blades represents an important category within the Manufacturing sector (SIC 3425).
...
graph TD
    ...
    S3133 --> N3425["3425: Saw Blades"]
    style N3425 fill:#f96,stroke:#333,stroke-width:2px
```
