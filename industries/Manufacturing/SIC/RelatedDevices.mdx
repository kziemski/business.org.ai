...
Related Devices represents an important category within the Manufacturing sector (SIC 3674).
...
graph TD
    ...
    S3133 --> N3674["3674: Related Devices"]
    style N3674 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3674 |
| Market Segment | Related Devices |
...
*Source: SIC 3674 - Related Devices*
