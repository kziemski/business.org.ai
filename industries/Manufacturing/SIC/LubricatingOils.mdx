...
Lubricating Oils represents an important category within the Manufacturing sector (SIC 2992).
...
graph TD
    ...
    S3133 --> N2992["2992: Lubricating Oils"]
    style N2992 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2992 |
| Market Segment | Lubricating Oils |
...
*Source: SIC 2992 - Lubricating Oils*
