...
Carpets represents an important category within the Manufacturing sector (SIC 2273).
...
graph TD
    ...
    S3133 --> N2273["2273: Carpets"]
    style N2273 fill:#f96,stroke:#333,stroke-width:2px
```
