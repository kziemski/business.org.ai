---
id: AnimalSlaughtering
name: Animal Slaughtering
code: 3116
type: Industry
...
> Manufacturing establishments primarily engaged in animal slaughtering.

## Overview

Animal Slaughtering represents an important category within the U.S. Manufacturing sector (NAICS 31-33). This industry group encompasses establishments primarily engaged in animal slaughtering.
...
graph TD
    ...
    style N3116 fill:#f96,stroke:#333,stroke-width:2px
```
...
The animal slaughtering industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 3116 |
| Market Segment | Animal Slaughtering |
...
*Source: NAICS 3116 - Animal Slaughtering*
