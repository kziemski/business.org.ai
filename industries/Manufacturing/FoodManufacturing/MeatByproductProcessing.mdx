---
id: MeatByproductProcessing
name: Meat Byproduct Processing
code: 311613
type: Industry
...
# Meat Byproduct Processing

> This U.

## Overview

Meat Byproduct Processing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3116 --> N311613["311613: Meat Byproduct Processing"]
    style N311613 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 311613 |
| Market Segment | Meat Byproduct Processing |
...
*Source: NAICS 311613 - Meat Byproduct Processing*
