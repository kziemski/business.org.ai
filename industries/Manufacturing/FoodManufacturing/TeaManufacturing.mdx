...
Tea Manufacturing represents an important category within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N311 --> N31192["31192: Tea Manufacturing"]
    style N31192 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 31192 |
| Market Segment | Tea Manufacturing |
...
*Source: NAICS 31192 - Tea Manufacturing*
