---
id: ConfectioneryManufacturingFromCacaoBeans
name: Confectionery Manufacturing from Cacao Beans
code: 311351
type: Industry
...
Confectionery Manufacturing from Cacao Beans represents a specialized segment within the U.S. Manufacturing sector (NAICS 31-33). This national industry encompasses establishments primarily engaged in confectionery manufacturing from cacao beans.

This U.S. industry comprises establishments primarily engaged in shelling, roasting, and grinding cacao beans and making chocolate cacao products and chocolate confectioneries. Cross-References. Establishments primarily engaged in--
...
graph TD
    ...
    N31135 --> N311351["311351: Confectionery Manufacturing from Caca..."]
    style N311351 fill:#f96,stroke:#333,stroke-width:2px
```
...
The confectionery manufacturing from cacao beans industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 311351 |
| Market Segment | Confectionery Manufacturing from Cacao Beans |
...
*Source: NAICS 311351 - Confectionery Manufacturing from Cacao Beans*
