---
id: ExtractManufacturing
name: Extract Manufacturing
code: 311942
type: Industry
...
Extract Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    style N311942 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 311942 |
| Market Segment | Extract Manufacturing |
...
*Source: NAICS 311942 - Extract Manufacturing*
