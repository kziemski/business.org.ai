...
Retail Bakeries represents a specialized segment within the U.S. Manufacturing sector (NAICS 31-33). This national industry encompasses establishments primarily engaged in retail bakeries.
...
graph TD
    ...
    style N311811 fill:#f96,stroke:#333,stroke-width:2px
```
...
The retail bakeries industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 311811 |
| Market Segment | Retail Bakeries |
...
*Source: NAICS 311811 - Retail Bakeries*
