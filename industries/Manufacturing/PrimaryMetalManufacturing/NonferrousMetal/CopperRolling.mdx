...
Copper Rolling represents an important category within the U.S. Manufacturing sector (NAICS 31-33). This industry encompasses establishments primarily engaged in copper rolling.
...
graph TD
    ...
    style N33142 fill:#f96,stroke:#333,stroke-width:2px
```
...
The copper rolling industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 33142 |
| Market Segment | Copper Rolling |
...
*Source: NAICS 33142 - Copper Rolling*
