---
id: AbrasiveProductManufacturing
...
Abrasive Product Manufacturing represents an important category within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N327 --> N32791["32791: Abrasive Product Manufacturing"]
    style N32791 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 32791 |
| Market Segment | Abrasive Product Manufacturing |
...
*Source: NAICS 32791 - Abrasive Product Manufacturing*
