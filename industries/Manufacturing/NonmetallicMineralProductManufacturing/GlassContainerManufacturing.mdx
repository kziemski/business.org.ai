---
id: GlassContainerManufacturing
...
Glass Container Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3272 --> N327213["327213: Glass Container Manufacturing"]
    style N327213 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 327213 |
| Market Segment | Glass Container Manufacturing |
...
*Source: NAICS 327213 - Glass Container Manufacturing*
