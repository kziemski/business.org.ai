---
id: GroundOrTreatedMineral
name: Ground or Treated Mineral
code: 327992
type: Industry
...
Ground or Treated Mineral represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N327 --> N327992["327992: Ground or Treated Mineral"]
    style N327992 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 327992 |
| Market Segment | Ground or Treated Mineral |
...
*Source: NAICS 327992 - Ground or Treated Mineral*
