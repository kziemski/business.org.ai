...
Concrete Pipe Manufacturing represents a specialized segment within the U.S. Manufacturing sector (NAICS 31-33). This national industry encompasses establishments primarily engaged in concrete pipe manufacturing.
...
graph TD
    ...
    style N327332 fill:#f96,stroke:#333,stroke-width:2px
```
...
The concrete pipe manufacturing industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 327332 |
| Market Segment | Concrete Pipe Manufacturing |
...
*Source: NAICS 327332 - Concrete Pipe Manufacturing*
