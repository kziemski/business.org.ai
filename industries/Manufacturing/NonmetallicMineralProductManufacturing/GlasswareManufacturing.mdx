...
Glassware Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3272 --> N327212["327212: Glassware Manufacturing"]
    style N327212 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 327212 |
| Market Segment | Glassware Manufacturing |
...
*Source: NAICS 327212 - Glassware Manufacturing*
