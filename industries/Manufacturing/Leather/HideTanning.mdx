...
> Manufacturing establishments primarily engaged in hide tanning.

## Overview

Hide Tanning represents an important category within the U.S. Manufacturing sector (NAICS 31-33). This industry group encompasses establishments primarily engaged in hide tanning.
...
graph TD
    ...
    style N3161 fill:#f96,stroke:#333,stroke-width:2px
```
...
The hide tanning industry is experiencing significant technological advancement:
...
*Source: NAICS 3161 - Hide Tanning*
