---
id: AirPurificationEquipmentManufacturing
name: "Air Purification Equipment Manufacturing"
code: "333413"
type: Industry
...
Air Purification Equipment Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3334 --> N333413["333413: Air Purification Equipment Manufacturing"]
    style N333413 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 333413 - Air Purification Equipment Manufacturing*
