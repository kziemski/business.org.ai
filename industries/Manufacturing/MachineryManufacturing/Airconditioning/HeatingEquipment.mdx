...
Heating Equipment ( represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3334 --> N333414["333414: Heating Equipment ("]
    style N333414 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 333414 |
| Market Segment | Heating Equipment ( |
...
*Source: NAICS 333414 - Heating Equipment (*
