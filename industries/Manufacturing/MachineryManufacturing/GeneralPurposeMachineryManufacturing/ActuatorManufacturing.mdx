---
id: ActuatorManufacturing
name: Actuator Manufacturing
code: 333995
type: Industry
...
Actuator Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3339 --> N333995["333995: Actuator Manufacturing"]
    style N333995 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 333995 |
| Market Segment | Actuator Manufacturing |
...
*Source: NAICS 333995 - Actuator Manufacturing*
