---
id: PowerDrivenHandtoolManufacturing
...
Power-Driven Handtool Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3339 --> N333991["333991: Power-Driven Handtool Manufacturing"]
    style N333991 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 333991 |
| Market Segment | Power-Driven Handtool Manufacturing |
...
*Source: NAICS 333991 - Power-Driven Handtool Manufacturing*
