---
id: TurbineGeneratorSetUnitsManufacturing
name: Turbine Generator Set Units Manufacturing
code: 333611
type: Industry
...
Turbine Generator Set Units Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N333 --> N3336["3336: Engine"]
    N3336 --> N333611["333611: Turbine Generator Set Units Manufactu..."]
    style N333611 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 333611 |
| Market Segment | Turbine Generator Set Units Manufacturing |
...
*Source: NAICS 333611 - Turbine Generator Set Units Manufacturing*
