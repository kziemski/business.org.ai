---
id: EngineEquipmentManufacturing
name: Engine Equipment Manufacturing
code: 333618
type: Industry
...
Engine Equipment Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3336 --> N333618["333618: Engine Equipment Manufacturing"]
    style N333618 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 333618 |
| Market Segment | Engine Equipment Manufacturing |
...
*Source: NAICS 333618 - Engine Equipment Manufacturing*
