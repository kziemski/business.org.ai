...
Fixture Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3335 --> N333514["333514: Fixture Manufacturing"]
    style N333514 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 333514 |
| Market Segment | Fixture Manufacturing |
...
*Source: NAICS 333514 - Fixture Manufacturing*
