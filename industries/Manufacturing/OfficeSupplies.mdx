...
Office Supplies ( represents an important category within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3399 --> N33994["33994: Office Supplies ("]
    style N33994 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 33994 - Office Supplies (*
