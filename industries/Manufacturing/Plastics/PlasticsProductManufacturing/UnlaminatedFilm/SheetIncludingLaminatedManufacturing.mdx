---
id: SheetIncludingLaminatedManufacturing
name: Sheet (including Laminated) Manufacturing
code: 326112
type: Industry
...
Sheet (including Laminated) Manufacturing represents a specialized segment within the U.S. Manufacturing sector (NAICS 31-33). This national industry encompasses establishments primarily engaged in sheet (including laminated) manufacturing.
...
graph TD
    ...
    N32611 --> N326112["326112: Sheet (including Laminated) Manufactu..."]
    style N326112 fill:#f96,stroke:#333,stroke-width:2px
```
...
The sheet (including laminated) manufacturing industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 326112 |
| Market Segment | Sheet (including Laminated) Manufacturing |
...
*Source: NAICS 326112 - Sheet (including Laminated) Manufacturing*
