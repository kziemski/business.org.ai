---
id: SupportActivitiesForPrinting
...
Support Activities for Printing represents an important category within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3231 --> N32312["32312: Support Activities for Printing"]
    style N32312 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 32312 |
| Market Segment | Support Activities for Printing |
...
*Source: NAICS 32312 - Support Activities for Printing*
