...
Silverware Manufacturing represents an important category within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    style N33991 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 33991 |
| Market Segment | Silverware Manufacturing |
...
*Source: NAICS 33991 - Silverware Manufacturing*
