---
id: GraphiteProductManufacturing
name: Graphite Product Manufacturing
code: 335991
type: Industry
...
Graphite Product Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N335 --> N335991["335991: Graphite Product Manufacturing"]
    style N335991 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 335991 |
| Market Segment | Graphite Product Manufacturing |
...
*Source: NAICS 335991 - Graphite Product Manufacturing*
