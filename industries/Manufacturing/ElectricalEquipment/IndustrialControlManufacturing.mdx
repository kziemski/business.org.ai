---
id: IndustrialControlManufacturing
name: Industrial Control Manufacturing
code: 335314
type: Industry
...
Industrial Control Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3353 --> N335314["335314: Industrial Control Manufacturing"]
    style N335314 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 335314 |
| Market Segment | Industrial Control Manufacturing |
...
*Source: NAICS 335314 - Industrial Control Manufacturing*
