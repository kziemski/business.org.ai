---
id: EnergyWireManufacturing
name: Energy Wire Manufacturing
code: 335929
type: Industry
...
Energy Wire Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N335 --> N33592["33592: Communication"]
    N33592 --> N335929["335929: Energy Wire Manufacturing"]
    style N335929 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 335929 |
| Market Segment | Energy Wire Manufacturing |
...
*Source: NAICS 335929 - Energy Wire Manufacturing*
