---
id: CustomCompoundingOfPurchasedResins
...
Custom Compounding of Purchased Resins represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3259 --> N325991["325991: Custom Compounding of Purchased Resins"]
    style N325991 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 325991 |
| Market Segment | Custom Compounding of Purchased Resins |
...
*Source: NAICS 325991 - Custom Compounding of Purchased Resins*
