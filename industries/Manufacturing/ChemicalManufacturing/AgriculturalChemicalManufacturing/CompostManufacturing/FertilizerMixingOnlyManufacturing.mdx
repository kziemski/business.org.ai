---
id: FertilizerMixingOnlyManufacturing
...
Fertilizer (Mixing Only) Manufacturing represents a specialized segment within the U.S. Manufacturing sector (NAICS 31-33). This national industry encompasses establishments primarily engaged in fertilizer (mixing only) manufacturing.
...
graph TD
    ...
    N32531 --> N325314["325314: Fertilizer (Mixing Only) Manufacturing"]
    style N325314 fill:#f96,stroke:#333,stroke-width:2px
```
...
The fertilizer (mixing only) manufacturing industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 325314 |
| Market Segment | Fertilizer (Mixing Only) Manufacturing |
...
*Source: NAICS 325314 - Fertilizer (Mixing Only) Manufacturing*
