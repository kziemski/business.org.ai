---
id: CoalProductsManufacturing
name: Coal Products Manufacturing
code: 324
type: Industry
level: Subsector
status: complete
...
Coal Products Manufacturing represents an important category within the U.S. Manufacturing sector (NAICS 31-33). This subsector encompasses establishments primarily engaged in coal products manufacturing.
...
graph TD
    ...
    S31 --> N324["324: Coal Products Manufacturing"]
    style N324 fill:#f96,stroke:#333,stroke-width:2px
```
...
The coal products manufacturing industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 324 |
| Market Segment | Coal Products Manufacturing |
...
*Source: NAICS 324 - Coal Products Manufacturing*
