---
id: PlumbingFixtureFitting
name: Plumbing Fixture Fitting
code: 332913
type: Industry
...
Plumbing Fixture Fitting represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    style N332913 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 332913 |
| Market Segment | Plumbing Fixture Fitting |
...
*Source: NAICS 332913 - Plumbing Fixture Fitting*
