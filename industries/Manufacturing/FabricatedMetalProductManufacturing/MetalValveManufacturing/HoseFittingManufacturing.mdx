---
id: HoseFittingManufacturing
name: "Hose Fitting Manufacturing"
code: "332912"
type: Industry
...
Hose Fitting Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    style N332912 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 332912 - Hose Fitting Manufacturing*
