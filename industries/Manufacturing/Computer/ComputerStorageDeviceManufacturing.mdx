---
id: ComputerStorageDeviceManufacturing
...
Computer Storage Device Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3341 --> N334112["334112: Computer Storage Device Manufacturing"]
    style N334112 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 334112 - Computer Storage Device Manufacturing*
