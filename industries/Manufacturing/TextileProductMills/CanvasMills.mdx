...
Canvas Mills represents an important category within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N314 --> N31491["31491: Canvas Mills"]
    style N31491 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 31491 |
| Market Segment | Canvas Mills |
...
*Source: NAICS 31491 - Canvas Mills*
