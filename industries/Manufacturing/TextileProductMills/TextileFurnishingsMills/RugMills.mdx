...
Rug Mills represents an important category within the U.S. Manufacturing sector (NAICS 31-33). This industry encompasses establishments primarily engaged in rug mills.
...
graph TD
    ...
    style N31411 fill:#f96,stroke:#333,stroke-width:2px
```
...
The rug mills industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 31411 |
| Market Segment | Rug Mills |
