---
id: SuppliesManufacturing
name: Supplies Manufacturing
code: 3391
type: Industry
...
> Establishments primarily engaged in supplies manufacturing.

## Overview

Supplies Manufacturing represents an important category within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    S3133 --> N3391["3391: Supplies Manufacturing"]
    style N3391 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 3391 |
| Market Segment | Supplies Manufacturing |
...
*Source: NAICS 3391 - Supplies Manufacturing*
