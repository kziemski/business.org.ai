...
Dental Laboratories represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3391 --> N339116["339116: Dental Laboratories"]
    style N339116 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 339116 |
| Market Segment | Dental Laboratories |
...
*Source: NAICS 339116 - Dental Laboratories*
