---
id: ManufacturedHomeMobileHomeManufacturing
...
Manufactured Home (Mobile Home) Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N321 --> N321991["321991: Manufactured Home (Mobile Home) Manuf..."]
    style N321991 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 321991 - Manufactured Home (Mobile Home) Manufacturing*
