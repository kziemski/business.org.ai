---
id: SpaceVehicleParts
name: Space Vehicle Parts
code: 336419
type: Industry
...
Space Vehicle Parts represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3364 --> N336419["336419: Space Vehicle Parts"]
    style N336419 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 336419 |
| Market Segment | Space Vehicle Parts |
...
*Source: NAICS 336419 - Space Vehicle Parts*
