---
id: RailroadRollingStockManufacturing
...
> Manufacturing establishments primarily engaged in railroad rolling stock manufacturing.

## Overview

Railroad Rolling Stock Manufacturing represents an important category within the U.S. Manufacturing sector (NAICS 31-33). This industry group encompasses establishments primarily engaged in railroad rolling stock manufacturing.
...
graph TD
    ...
    N336 --> N3365["3365: Railroad Rolling Stock Manufacturing"]
    style N3365 fill:#f96,stroke:#333,stroke-width:2px
```
...
The railroad rolling stock manufacturing industry is experiencing significant technological advancement:
...
| NAICS/SIC Code | 3365 |
| Market Segment | Railroad Rolling Stock Manufacturing |
...
*Source: NAICS 3365 - Railroad Rolling Stock Manufacturing*
