---
id: AuxiliaryEquipmentManufacturing
name: "Auxiliary Equipment Manufacturing"
code: "336413"
type: Industry
...
Auxiliary Equipment Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3364 --> N336413["336413: Auxiliary Equipment Manufacturing"]
    style N336413 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 336413 - Auxiliary Equipment Manufacturing*
