---
id: MotorVehicleBodyManufacturing
...
Motor Vehicle Body Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3362 --> N336211["336211: Motor Vehicle Body Manufacturing"]
    style N336211 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 336211 |
| Market Segment | Motor Vehicle Body Manufacturing |
...
*Source: NAICS 336211 - Motor Vehicle Body Manufacturing*
