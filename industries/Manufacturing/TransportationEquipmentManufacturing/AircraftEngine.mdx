...
Aircraft Engine represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N3364 --> N336412["336412: Aircraft Engine"]
    style N336412 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 336412 - Aircraft Engine*
