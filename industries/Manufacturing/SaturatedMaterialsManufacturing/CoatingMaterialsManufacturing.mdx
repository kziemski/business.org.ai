---
id: CoatingMaterialsManufacturing
name: Coating Materials Manufacturing
code: 324122
type: Industry
...
Coating Materials Manufacturing represents a specialized segment within the Manufacturing sector (NAICS 31-33).
...
graph TD
    ...
    N324 --> N32412["32412: Asphalt Paving"]
    N32412 --> N324122["324122: Coating Materials Manufacturing"]
    style N324122 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 324122 |
| Market Segment | Coating Materials Manufacturing |
...
*Source: NAICS 324122 - Coating Materials Manufacturing*
