...
Crude Petroleum Extraction represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (NAICS 21).
...
graph TD
    ...
    S21 --> N211["211: Oil"]
    N211 --> N2111["2111: Cigarettes"]
    N2111 --> N21112["21112: Crude Petroleum Extraction"]
    style N21112 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 21112 |
| Market Segment | Crude Petroleum Extraction |
