...
Natural Gas Extraction represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (NAICS 21).
...
graph TD
    ...
    style N21113 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 21113 |
| Market Segment | Natural Gas Extraction |
