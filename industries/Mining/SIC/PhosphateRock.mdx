...
Phosphate Rock represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1475).
...
graph TD
    ...
    S21 --> N1475["1475: Phosphate Rock"]
    style N1475 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 1475 - Phosphate Rock*
