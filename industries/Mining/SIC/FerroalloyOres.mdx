...
Ferroalloy Ores represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1061).
...
graph TD
    ...
    S21 --> N1061["1061: Ferroalloy Ores"]
    style N1061 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1061 |
| Market Segment | Ferroalloy Ores |
...
*Source: SIC 1061 - Ferroalloy Ores*
