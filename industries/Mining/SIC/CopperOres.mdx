...
Copper Ores represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1021).
...
graph TD
    ...
    S21 --> N1021["1021: Copper Ores"]
    style N1021 fill:#f96,stroke:#333,stroke-width:2px
```
