...
Silver Ores represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1044).
...
graph TD
    ...
    S21 --> N1044["1044: Silver Ores"]
    style N1044 fill:#f96,stroke:#333,stroke-width:2px
```
