---
id: NonmetallicMineralsServices
name: Nonmetallic Minerals Services
code: 1481
type: Industry
level: SIC (1481)
status: complete
...
Nonmetallic Minerals Services represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1481).
...
graph TD
    ...
    S21 --> N1481["1481: Nonmetallic Minerals Services"]
    style N1481 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1481 |
| Market Segment | Nonmetallic Minerals Services |
...
*Source: SIC 1481 - Nonmetallic Minerals Services*
