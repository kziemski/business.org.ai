...
Broken Stone represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1429).
...
graph TD
    ...
    S21 --> N1429["1429: Broken Stone"]
    style N1429 fill:#f96,stroke:#333,stroke-width:2px
```
