...
Gas Field Services represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1389).
...
graph TD
    ...
    S21 --> N1389["1389: Gas Field Services"]
    style N1389 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1389 |
| Market Segment | Gas Field Services |
...
*Source: SIC 1389 - Gas Field Services*
