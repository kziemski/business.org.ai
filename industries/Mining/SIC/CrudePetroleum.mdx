...
Crude Petroleum represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1311).
...
graph TD
    ...
    S21 --> N1311["1311: Crude Petroleum"]
    style N1311 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1311 |
| Market Segment | Crude Petroleum |
...
*Source: SIC 1311 - Crude Petroleum*
