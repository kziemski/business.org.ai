---
id: LigniteSurfaceMining
name: Lignite Surface Mining
code: 1221
type: Industry
level: SIC (1221)
status: complete
...
Lignite Surface Mining represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1221).
...
graph TD
    ...
    S21 --> N1221["1221: Lignite Surface Mining"]
    style N1221 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1221 |
| Market Segment | Lignite Surface Mining |
...
*Source: SIC 1221 - Lignite Surface Mining*
