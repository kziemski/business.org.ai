---
id: GasFieldExplorationServices
name: Gas Field Exploration Services
code: 1382
type: Industry
level: SIC (1382)
status: complete
...
Gas Field Exploration Services represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1382).
...
graph TD
    ...
    S21 --> N1382["1382: Gas Field Exploration Services"]
    style N1382 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1382 |
| Market Segment | Gas Field Exploration Services |
...
*Source: SIC 1382 - Gas Field Exploration Services*
