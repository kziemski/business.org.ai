...
Zinc Ores represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1031).
...
graph TD
    ...
    S21 --> N1031["1031: Zinc Ores"]
    style N1031 fill:#f96,stroke:#333,stroke-width:2px
```
