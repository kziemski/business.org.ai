...
Anthracite Mining represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1231).
...
graph TD
    ...
    S21 --> N1231["1231: Anthracite Mining"]
    style N1231 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1231 |
| Market Segment | Anthracite Mining |
...
*Source: SIC 1231 - Anthracite Mining*
