...
Potash represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1474).
...
graph TD
    ...
    S21 --> N1474["1474: Potash"]
    style N1474 fill:#f96,stroke:#333,stroke-width:2px
```
