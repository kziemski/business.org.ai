...
Iron Ores represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1011).
...
graph TD
    ...
    S21 --> N1011["1011: Iron Ores"]
    style N1011 fill:#f96,stroke:#333,stroke-width:2px
```
