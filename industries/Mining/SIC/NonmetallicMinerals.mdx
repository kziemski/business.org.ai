---
id: NonmetallicMinerals
name: Nonmetallic Minerals
code: 1499
type: Industry
level: SIC (1499)
status: complete
...
Nonmetallic Minerals represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1499).
...
graph TD
    ...
    S21 --> N1499["1499: Nonmetallic Minerals"]
    style N1499 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1499 |
| Market Segment | Nonmetallic Minerals |
...
*Source: SIC 1499 - Nonmetallic Minerals*
