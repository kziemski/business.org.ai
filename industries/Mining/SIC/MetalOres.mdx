...
Metal Ores represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1099).
...
graph TD
    ...
    S21 --> N1099["1099: Metal Ores"]
    style N1099 fill:#f96,stroke:#333,stroke-width:2px
```
