...
Coal Mining Services represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1241).
...
graph TD
    ...
    S21 --> N1241["1241: Coal Mining Services"]
    style N1241 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1241 |
| Market Segment | Coal Mining Services |
...
*Source: SIC 1241 - Coal Mining Services*
