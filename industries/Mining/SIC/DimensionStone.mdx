...
Dimension Stone represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1411).
...
graph TD
    ...
    S21 --> N1411["1411: Dimension Stone"]
    style N1411 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 1411 |
| Market Segment | Dimension Stone |
...
*Source: SIC 1411 - Dimension Stone*
