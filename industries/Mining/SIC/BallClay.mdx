...
Ball Clay represents an important category within the Mining, Quarrying, and Oil and Gas Extraction sector (SIC 1455).
...
graph TD
    ...
    S21 --> N1455["1455: Ball Clay"]
    style N1455 fill:#f96,stroke:#333,stroke-width:2px
```
