---
id: SatelliteTelecommunications
...
> Establishments primarily engaged in satellite telecommunications.

## Overview

Satellite Telecommunications represents an important category within the Information sector (NAICS 51). This industry group encompasses establishments primarily engaged in satellite telecommunications.
...
graph TD
    ...
    style N5174 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5174 |
| Market Segment | Satellite Telecommunications |
...
*Source: NAICS 5174 - Satellite Telecommunications*
