...
Message Communications represents an important category within the Information sector (SIC 4822).
...
graph TD
    S51["51: Information"]
    S51 --> N482["482: Rail Transportation"]
    N482 --> N4822["4822: Message Communications"]
    style N4822 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4822 |
| Market Segment | Message Communications |
...
*Source: SIC 4822 - Message Communications*
