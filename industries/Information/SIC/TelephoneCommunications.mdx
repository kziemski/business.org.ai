...
Telephone Communications represents an important category within the Information sector (SIC 4813).
...
graph TD
    ...
    N481 --> N4813["4813: Telephone Communications"]
    style N4813 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4813 |
| Market Segment | Telephone Communications |
...
*Source: SIC 4813 - Telephone Communications*
