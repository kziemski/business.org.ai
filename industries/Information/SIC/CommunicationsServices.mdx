...
Communications Services represents an important category within the Information sector (SIC 4899).
...
graph TD
    S51["51: Information"]
    S51 --> N4899["4899: Communications Services"]
    style N4899 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4899 |
| Market Segment | Communications Services |
...
*Source: SIC 4899 - Communications Services*
