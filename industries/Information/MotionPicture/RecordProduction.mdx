...
Record Production represents an important category within the Information sector (NAICS 51).
...
graph TD
    ...
    N512 --> N51225["51225: Record Production"]
    style N51225 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 51225 |
| Market Segment | Record Production |
...
*Source: NAICS 51225 - Record Production*
