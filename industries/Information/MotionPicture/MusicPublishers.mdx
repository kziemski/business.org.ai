...
Music Publishers represents an important category within the Information sector (NAICS 51).
...
graph TD
    ...
    N512 --> N51223["51223: Music Publishers"]
    style N51223 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 51223 |
| Market Segment | Music Publishers |
...
*Source: NAICS 51223 - Music Publishers*
