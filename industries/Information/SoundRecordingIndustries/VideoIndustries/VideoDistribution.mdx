...
Video Distribution represents an important category within the Information sector (NAICS 51). This industry encompasses establishments primarily engaged in video distribution.
...
graph TD
    ...
    style N51212 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 51212 |
| Market Segment | Video Distribution |
...
*Source: NAICS 51212 - Video Distribution*
