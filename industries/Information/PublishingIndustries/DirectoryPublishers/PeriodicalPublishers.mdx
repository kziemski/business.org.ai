...
Periodical Publishers represents an important category within the Information sector (NAICS 51). This industry encompasses establishments primarily engaged in periodical publishers.
...
graph TD
    ...
    style N51312 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 51312 |
| Market Segment | Periodical Publishers |
...
*Source: NAICS 51312 - Periodical Publishers*
