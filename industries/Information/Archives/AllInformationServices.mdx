---
id: AllInformationServices
name: All Information Services
code: 51929
type: Industry
level: Industry
status: complete
...
All Information Services represents an important category within the Information sector (NAICS 51).
...
graph TD
    S51["51: Information"]
    S51 --> N519["519: Web Search Portals"]
    N519 --> N5192["5192: Books"]
    N5192 --> N51929["51929: All Information Services"]
    style N51929 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 51929 |
| Market Segment | All Information Services |
...
*Source: NAICS 51929 - All Information Services*
