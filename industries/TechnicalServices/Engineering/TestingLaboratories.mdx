...
Testing Laboratories represents an important category within the Professional, Scientific, and Technical Services sector (NAICS 54).
...
graph TD
    ...
    N5413 --> N54138["54138: Testing Laboratories"]
    style N54138 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 54138 |
| Market Segment | Testing Laboratories |
...
*Source: NAICS 54138 - Testing Laboratories*
