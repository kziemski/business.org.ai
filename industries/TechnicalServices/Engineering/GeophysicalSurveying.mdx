---
id: GeophysicalSurveying
name: Geophysical Surveying
code: 54136
type: Industry
level: Industry
status: complete
...
Geophysical Surveying represents an important category within the Professional, Scientific, and Technical Services sector (NAICS 54).
...
graph TD
    ...
    N5413 --> N54136["54136: Geophysical Surveying"]
    style N54136 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 54136 |
| Market Segment | Geophysical Surveying |
...
*Source: NAICS 54136 - Geophysical Surveying*
