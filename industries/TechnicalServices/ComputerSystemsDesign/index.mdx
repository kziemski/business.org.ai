...
> Establishments primarily engaged in computer systems design.

## Overview

Computer Systems Design represents an important category within the Professional, Scientific, and Technical Services sector (NAICS 54).
...
graph TD
    ...
    style N5415 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5415 |
| Market Segment | Computer Systems Design |
...
*Source: NAICS 5415 - Computer Systems Design*
