...
Public Opinion Polling represents an important category within the Professional, Scientific, and Technical Services sector (NAICS 54).
...
graph TD
    ...
    S54 --> N54191["54191: Public Opinion Polling"]
    style N54191 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 54191 |
| Market Segment | Public Opinion Polling |
...
*Source: NAICS 54191 - Public Opinion Polling*
