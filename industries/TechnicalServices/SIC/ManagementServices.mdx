...
Management Services represents an important category within the Professional, Scientific, and Technical Services sector (SIC 8741).
...
graph TD
    ...
    S54 --> N8741["8741: Management Services"]
    style N8741 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8741 |
| Market Segment | Management Services |
...
*Source: SIC 8741 - Management Services*
