---
id: CommercialEconomic
name: Commercial Economic
code: 8732
type: Industry
level: SIC (8732)
status: complete
...
Commercial Economic represents an important category within the Professional, Scientific, and Technical Services sector (SIC 8732).
...
graph TD
    ...
    S54 --> N8732["8732: Commercial Economic"]
    style N8732 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8732 |
| Market Segment | Commercial Economic |
...
*Source: SIC 8732 - Commercial Economic*
