...
Surveying Services represents an important category within the Professional, Scientific, and Technical Services sector (SIC 8713).
...
graph TD
    ...
    S54 --> N8713["8713: Surveying Services"]
    style N8713 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8713 |
| Market Segment | Surveying Services |
...
*Source: SIC 8713 - Surveying Services*
