---
id: ServicesRelatedToAdvertising
name: Services Related to Advertising
code: 54189
type: Industry
level: Industry
status: complete
...
Services Related to Advertising represents an important category within the Professional, Scientific, and Technical Services sector (NAICS 54).
...
graph TD
    ...
    N5418 --> N54189["54189: Services Related to Advertising"]
    style N54189 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 54189 |
| Market Segment | Services Related to Advertising |
...
*Source: NAICS 54189 - Services Related to Advertising*
