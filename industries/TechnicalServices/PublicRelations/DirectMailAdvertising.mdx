...
Direct Mail Advertising represents an important category within the Professional, Scientific, and Technical Services sector (NAICS 54).
...
graph TD
    ...
    N5418 --> N54186["54186: Direct Mail Advertising"]
    style N54186 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 54186 |
| Market Segment | Direct Mail Advertising |
...
*Source: NAICS 54186 - Direct Mail Advertising*
