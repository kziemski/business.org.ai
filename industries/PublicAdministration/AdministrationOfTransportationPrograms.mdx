---
id: AdministrationOfTransportationPrograms
name: Administration of Transportation Programs
code: 92612
type: Industry
level: Industry
status: complete
...
Administration of Transportation Programs represents an important category within the Public Administration sector (NAICS 92).
...
graph TD
    ...
    N926 --> N92612["92612: Administration of Transportation Prog..."]
    style N92612 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 92612 |
| Market Segment | Administration of Transportation Programs |
...
*Source: NAICS 92612 - Administration of Transportation Programs*
