...
National Security represents an important category within the Public Administration sector (NAICS 92).
...
graph TD
    ...
    S92 --> N928["928: National Security"]
...
| NAICS/SIC Code | 928 |
| Market Segment | National Security |
...
*Source: NAICS 928 - National Security*
