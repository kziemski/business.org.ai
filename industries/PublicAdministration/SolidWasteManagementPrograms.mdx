---
id: SolidWasteManagementPrograms
name: Solid Waste Management Programs
code: 92411
type: Industry
level: Industry
status: complete
...
Solid Waste Management Programs represents an important category within the Public Administration sector (NAICS 92).
...
graph TD
    ...
    N924 --> N92411["92411: Solid Waste Management Programs"]
    style N92411 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 92411 |
| Market Segment | Solid Waste Management Programs |
...
*Source: NAICS 92411 - Solid Waste Management Programs*
