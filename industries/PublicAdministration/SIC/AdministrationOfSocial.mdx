---
id: AdministrationOfSocial
name: Administration of Social
code: 9441
type: Industry
level: SIC (9441)
status: complete
...
Administration of Social represents an important category within the Public Administration sector (SIC 9441).
...
graph TD
    ...
    S92 --> N9441["9441: Administration of Social"]
    style N9441 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 9441 |
| Market Segment | Administration of Social |
...
*Source: SIC 9441 - Administration of Social*
