...
Safety represents an important category within the Public Administration sector (SIC 9229).
...
graph TD
    ...
    style N9229 fill:#f96,stroke:#333,stroke-width:2px
```
