...
Public Finance represents an important category within the Public Administration sector (SIC 9311).
...
graph TD
    ...
    S92 --> N9311["9311: Public Finance"]
    style N9311 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 9311 - Public Finance*
