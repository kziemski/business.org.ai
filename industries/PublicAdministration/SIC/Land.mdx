...
Land represents an important category within the Public Administration sector (SIC 9512).
...
graph TD
    ...
    S92 --> N9512["9512: Land"]
    style N9512 fill:#f96,stroke:#333,stroke-width:2px
```
