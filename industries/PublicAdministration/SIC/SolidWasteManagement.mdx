...
Solid Waste Management represents an important category within the Public Administration sector (SIC 9511).
...
graph TD
    ...
    S92 --> N9511["9511: Solid Waste Management"]
    style N9511 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 9511 |
| Market Segment | Solid Waste Management |
...
*Source: SIC 9511 - Solid Waste Management*
