---
id: NonclassifiableEstablishments
...
Nonclassifiable Establishments represents an important category within the Public Administration sector (SIC 9999).
...
graph TD
    ...
    S92 --> N9999["9999: Nonclassifiable Establishments"]
    style N9999 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 9999 |
| Market Segment | Nonclassifiable Establishments |
...
*Source: SIC 9999 - Nonclassifiable Establishments*
