---
id: AdministrationOfCommunications
name: Administration of Communications
code: 9631
type: Industry
level: SIC (9631)
status: complete
...
Administration of Communications represents an important category within the Public Administration sector (SIC 9631).
...
graph TD
    ...
    S92 --> N9631["9631: Administration of Communications"]
    style N9631 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 9631 |
| Market Segment | Administration of Communications |
...
*Source: SIC 9631 - Administration of Communications*
