...
Space represents an important category within the Public Administration sector (SIC 9661).
...
graph TD
    ...
    S92 --> N9661["9661: Space"]
    style N9661 fill:#f96,stroke:#333,stroke-width:2px
```
