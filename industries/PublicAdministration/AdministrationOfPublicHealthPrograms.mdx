---
id: AdministrationOfPublicHealthPrograms
...
Administration of Public Health Programs represents an important category within the Public Administration sector (NAICS 92).
...
graph TD
    ...
    N923 --> N92312["92312: Administration of Public Health Programs"]
    style N92312 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 92312 |
| Market Segment | Administration of Public Health Programs |
...
*Source: NAICS 92312 - Administration of Public Health Programs*
