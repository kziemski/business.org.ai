---
id: LegislativeOfficesCombined
name: Legislative Offices, Combined
code: 92114
type: Industry
level: Industry
status: complete
...
Legislative Offices, Combined represents an important category within the Public Administration sector (NAICS 92).
...
graph TD
    ...
    N921 --> N92114["92114: Legislative Offices, Combined"]
    style N92114 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 92114 |
| Market Segment | Legislative Offices, Combined |
...
*Source: NAICS 92114 - Legislative Offices, Combined*
