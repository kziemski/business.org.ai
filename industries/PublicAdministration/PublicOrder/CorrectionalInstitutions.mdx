...
Correctional Institutions represents an important category within the Public Administration sector (NAICS 92).
...
graph TD
    ...
    S92 --> N922["922: Justice"]
    N922 --> N92214["92214: Correctional Institutions"]
    style N92214 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 92214 |
| Market Segment | Correctional Institutions |
...
*Source: NAICS 92214 - Correctional Institutions*
