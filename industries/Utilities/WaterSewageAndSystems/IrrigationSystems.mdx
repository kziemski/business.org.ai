...
Irrigation Systems represents an important category within the Utilities sector (NAICS 22).
...
graph TD
    ...
    style N22131 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 22131 |
| Market Segment | Irrigation Systems |
...
*Source: NAICS 22131 - Irrigation Systems*
