...
> Establishments primarily engaged in natural gas distribution.

## Overview

Natural Gas Distribution represents an important category within the Utilities sector (NAICS 22).
...
graph TD
    S22["22: Utilities"]
    S22 --> N2212["2212: Natural Gas Distribution"]
    style N2212 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 2212 |
| Market Segment | Natural Gas Distribution |
...
*Source: NAICS 2212 - Natural Gas Distribution*
