---
id: ElectricBulkPowerTransmission
name: "Electric Bulk Power Transmission"
code: "221121"
type: Industry
...
Electric Bulk Power Transmission represents a specialized segment within the Utilities sector (NAICS 22).
...
graph TD
    ...
    style N221121 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 221121 - Electric Bulk Power Transmission*
