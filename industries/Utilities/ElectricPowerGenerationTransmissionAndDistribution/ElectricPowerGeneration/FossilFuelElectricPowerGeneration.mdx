---
id: FossilFuelElectricPowerGeneration
...
Fossil Fuel Electric Power Generation represents a specialized segment within the Utilities sector (NAICS 22).
...
graph TD
    ...
    N22111 --> N221112["221112: Fossil Fuel Electric Power Generation"]
    style N221112 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 221112 - Fossil Fuel Electric Power Generation*
