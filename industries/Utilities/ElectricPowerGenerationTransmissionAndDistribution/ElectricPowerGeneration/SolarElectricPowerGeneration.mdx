---
id: SolarElectricPowerGeneration
...
Solar Electric Power Generation represents a specialized segment within the Utilities sector (NAICS 22).
...
graph TD
    ...
    style N221114 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 221114 - Solar Electric Power Generation*
