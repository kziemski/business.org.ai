---
id: GeothermalElectricPowerGeneration
...
Geothermal Electric Power Generation represents a specialized segment within the Utilities sector (NAICS 22).
...
graph TD
    ...
    N22111 --> N221116["221116: Geothermal Electric Power Generation"]
    style N221116 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 221116 - Geothermal Electric Power Generation*
