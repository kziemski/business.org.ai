---
id: HydroelectricPowerGeneration
...
Hydroelectric Power Generation represents a specialized segment within the Utilities sector (NAICS 22).
...
graph TD
    ...
    style N221111 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 221111 - Hydroelectric Power Generation*
