...
Refuse Systems represents an important category within the Utilities sector (SIC 4953).
...
graph TD
    S22["22: Utilities"]
    S22 --> N4953["4953: Refuse Systems"]
    style N4953 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 4953 - Refuse Systems*
