---
id: CombinationUtilities
name: Combination Utilities
code: 4939
type: Industry
level: SIC (4939)
status: complete
...
Combination Utilities represents an important category within the Utilities sector (SIC 4939).
...
graph TD
    ...
    N493 --> N4939["4939: Combination Utilities"]
    style N4939 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4939 |
| Market Segment | Combination Utilities |
...
*Source: SIC 4939 - Combination Utilities*
