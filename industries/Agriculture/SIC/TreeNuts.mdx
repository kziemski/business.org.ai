...
Tree Nuts represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0173).
...
graph TD
    ...
    S11 --> N0173["0173: Tree Nuts"]
    style N0173 fill:#f96,stroke:#333,stroke-width:2px
```
