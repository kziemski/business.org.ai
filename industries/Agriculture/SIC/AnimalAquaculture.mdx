...
Animal Aquaculture represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0273).
...
graph TD
    ...
    S11 --> N0273["0273: Animal Aquaculture"]
    style N0273 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0273 |
| Market Segment | Animal Aquaculture |
...
*Source: SIC 0273 - Animal Aquaculture*
