...
Preserves represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0921).
...
graph TD
    ...
    S11 --> N0921["0921: Preserves"]
    style N0921 fill:#f96,stroke:#333,stroke-width:2px
```
