...
Irish Potatoes represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0134).
...
graph TD
    ...
    S11 --> N0134["0134: Irish Potatoes"]
    style N0134 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 0134 - Irish Potatoes*
