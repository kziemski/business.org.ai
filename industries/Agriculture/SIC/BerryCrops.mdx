...
Berry Crops represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0171).
...
graph TD
    ...
    S11 --> N0171["0171: Berry Crops"]
    style N0171 fill:#f96,stroke:#333,stroke-width:2px
```
