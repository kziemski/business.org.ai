---
id: CropPreparationServicesForMarket
...
Crop Preparation Services for Market represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0723).
...
graph TD
    ...
    S11 --> N0723["0723: Crop Preparation Services for Market"]
    style N0723 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0723 |
| Market Segment | Crop Preparation Services for Market |
...
*Source: SIC 0723 - Crop Preparation Services for Market*
