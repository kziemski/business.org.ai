...
Animal Specialty Services represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0752).
...
graph TD
    ...
    S11 --> N0752["0752: Animal Specialty Services"]
    style N0752 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0752 |
| Market Segment | Animal Specialty Services |
...
*Source: SIC 0752 - Animal Specialty Services*
