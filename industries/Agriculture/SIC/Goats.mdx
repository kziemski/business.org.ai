...
Goats represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0214).
...
graph TD
    ...
    S11 --> N0214["0214: Goats"]
    style N0214 fill:#f96,stroke:#333,stroke-width:2px
```
