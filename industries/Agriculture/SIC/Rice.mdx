...
Rice represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0112).
...
graph TD
    ...
    S11 --> N0112["0112: Rice"]
    style N0112 fill:#f96,stroke:#333,stroke-width:2px
```
