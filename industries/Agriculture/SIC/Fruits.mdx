...
Fruits represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0179).
...
graph TD
    ...
    S11 --> N0179["0179: Fruits"]
    style N0179 fill:#f96,stroke:#333,stroke-width:2px
```
