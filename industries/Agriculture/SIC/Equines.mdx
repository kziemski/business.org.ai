...
Equines represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0272).
...
graph TD
    ...
    S11 --> N0272["0272: Equines"]
    style N0272 fill:#f96,stroke:#333,stroke-width:2px
```
