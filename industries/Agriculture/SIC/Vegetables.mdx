...
Vegetables represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0161).
...
graph TD
    ...
    S11 --> N0161["0161: Vegetables"]
    style N0161 fill:#f96,stroke:#333,stroke-width:2px
```
