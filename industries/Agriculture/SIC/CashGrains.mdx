...
Cash Grains represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0119).
...
graph TD
    ...
    S11 --> N0119["0119: Cash Grains"]
    style N0119 fill:#f96,stroke:#333,stroke-width:2px
```
