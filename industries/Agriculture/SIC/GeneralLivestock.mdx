...
General Livestock represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0219).
...
graph TD
    ...
    S11 --> N0219["0219: General Livestock"]
    style N0219 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0219 |
| Market Segment | General Livestock |
...
*Source: SIC 0219 - General Livestock*
