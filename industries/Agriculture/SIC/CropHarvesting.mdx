...
Crop Harvesting represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0722).
...
graph TD
    ...
    S11 --> N0722["0722: Crop Harvesting"]
    style N0722 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0722 |
| Market Segment | Crop Harvesting |
...
*Source: SIC 0722 - Crop Harvesting*
