...
Grapes represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0172).
...
graph TD
    ...
    S11 --> N0172["0172: Grapes"]
    style N0172 fill:#f96,stroke:#333,stroke-width:2px
```
