...
Shellfish represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0913).
...
graph TD
    ...
    S11 --> N0913["0913: Shellfish"]
    style N0913 fill:#f96,stroke:#333,stroke-width:2px
```
