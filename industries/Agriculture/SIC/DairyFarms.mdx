...
Dairy Farms represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0241).
...
graph TD
    ...
    S11 --> N0241["0241: Dairy Farms"]
    style N0241 fill:#f96,stroke:#333,stroke-width:2px
```
