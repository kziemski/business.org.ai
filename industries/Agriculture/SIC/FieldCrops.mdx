...
Field Crops represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0139).
...
graph TD
    ...
    S11 --> N0139["0139: Field Crops"]
    style N0139 fill:#f96,stroke:#333,stroke-width:2px
```
