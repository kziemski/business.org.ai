...
Finfish represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0912).
...
graph TD
    ...
    S11 --> N0912["0912: Finfish"]
    style N0912 fill:#f96,stroke:#333,stroke-width:2px
```
