...
Cotton represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0131).
...
graph TD
    ...
    S11 --> N0131["0131: Cotton"]
    style N0131 fill:#f96,stroke:#333,stroke-width:2px
```
