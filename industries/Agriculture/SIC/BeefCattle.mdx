...
Beef Cattle represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0212).
...
graph TD
    ...
    S11 --> N0212["0212: Beef Cattle"]
    style N0212 fill:#f96,stroke:#333,stroke-width:2px
```
