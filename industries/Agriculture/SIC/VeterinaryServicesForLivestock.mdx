---
id: VeterinaryServicesForLivestock
...
Veterinary Services for Livestock represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0741).
...
graph TD
    ...
    S11 --> N0741["0741: Veterinary Services for Livestock"]
    style N0741 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0741 |
| Market Segment | Veterinary Services for Livestock |
...
*Source: SIC 0741 - Veterinary Services for Livestock*
