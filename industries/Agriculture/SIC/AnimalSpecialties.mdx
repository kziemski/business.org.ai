---
id: AnimalSpecialties
name: Animal Specialties
code: 0279
type: Industry
level: SIC (0279)
status: complete
...
Animal Specialties represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0279).
...
graph TD
    ...
    S11 --> N0279["0279: Animal Specialties"]
    style N0279 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0279 |
| Market Segment | Animal Specialties |
...
*Source: SIC 0279 - Animal Specialties*
