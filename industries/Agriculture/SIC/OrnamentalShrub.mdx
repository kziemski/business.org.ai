...
Ornamental Shrub represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0783).
...
graph TD
    ...
    S11 --> N0783["0783: Ornamental Shrub"]
    style N0783 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0783 |
| Market Segment | Ornamental Shrub |
...
*Source: SIC 0783 - Ornamental Shrub*
