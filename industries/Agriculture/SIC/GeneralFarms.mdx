...
General Farms represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0191).
...
graph TD
    ...
    S11 --> N0191["0191: General Farms"]
    style N0191 fill:#f96,stroke:#333,stroke-width:2px
```
