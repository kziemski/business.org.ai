...
Garden Services represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0782).
...
graph TD
    ...
    S11 --> N0782["0782: Garden Services"]
    style N0782 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0782 |
| Market Segment | Garden Services |
...
*Source: SIC 0782 - Garden Services*
