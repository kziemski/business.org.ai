...
Marine Products represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0919).
...
graph TD
    ...
    S11 --> N0919["0919: Marine Products"]
    style N0919 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0919 |
| Market Segment | Marine Products |
...
*Source: SIC 0919 - Marine Products*
