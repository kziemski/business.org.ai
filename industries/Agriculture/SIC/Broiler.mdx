...
Broiler represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0251).
...
graph TD
    ...
    S11 --> N0251["0251: Broiler"]
    style N0251 fill:#f96,stroke:#333,stroke-width:2px
```
