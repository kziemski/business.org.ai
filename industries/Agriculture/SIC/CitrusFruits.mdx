...
Citrus Fruits represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0174).
...
graph TD
    ...
    S11 --> N0174["0174: Citrus Fruits"]
    style N0174 fill:#f96,stroke:#333,stroke-width:2px
```
