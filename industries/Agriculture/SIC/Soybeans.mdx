...
Soybeans represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0116).
...
graph TD
    ...
    S11 --> N0116["0116: Soybeans"]
    style N0116 fill:#f96,stroke:#333,stroke-width:2px
```
