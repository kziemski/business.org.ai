...
Chicken Eggs represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0252).
...
graph TD
    ...
    S11 --> N0252["0252: Chicken Eggs"]
    style N0252 fill:#f96,stroke:#333,stroke-width:2px
```
