---
id: OrnamentalFloriculture
name: Ornamental Floriculture
code: 0181
type: Industry
level: SIC (0181)
status: complete
...
Ornamental Floriculture represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0181).
...
graph TD
    ...
    S11 --> N0181["0181: Ornamental Floriculture"]
    style N0181 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0181 |
| Market Segment | Ornamental Floriculture |
...
*Source: SIC 0181 - Ornamental Floriculture*
