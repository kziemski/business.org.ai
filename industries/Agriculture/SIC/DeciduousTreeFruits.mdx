...
Deciduous Tree Fruits represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0175).
...
graph TD
    ...
    S11 --> N0175["0175: Deciduous Tree Fruits"]
    style N0175 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0175 |
| Market Segment | Deciduous Tree Fruits |
...
*Source: SIC 0175 - Deciduous Tree Fruits*
