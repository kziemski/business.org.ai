...
Beef Cattle Feedlots represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0211).
...
graph TD
    ...
    S11 --> N0211["0211: Beef Cattle Feedlots"]
    style N0211 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 0211 |
| Market Segment | Beef Cattle Feedlots |
...
*Source: SIC 0211 - Beef Cattle Feedlots*
