...
Sugar Beets represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (SIC 0133).
...
graph TD
    ...
    S11 --> N0133["0133: Sugar Beets"]
    style N0133 fill:#f96,stroke:#333,stroke-width:2px
```
