...
Soil Preparation represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1151 --> N115112["115112: Soil Preparation"]
    style N115112 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 115112 - Soil Preparation*
