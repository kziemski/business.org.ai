---
id: PostharvestCropActivities
name: "Postharvest Crop Activities"
code: "115114"
type: Industry
...
Postharvest Crop Activities represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1151 --> N115114["115114: Postharvest Crop Activities"]
    style N115114 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 115114 - Postharvest Crop Activities*
