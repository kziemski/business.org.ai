---
id: CropHarvestingPrimarilyByMachine
...
Crop Harvesting, Primarily by Machine represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1151 --> N115113["115113: Crop Harvesting, Primarily by Machine"]
    style N115113 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 115113 - Crop Harvesting, Primarily by Machine*
