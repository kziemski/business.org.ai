---
id: SupportActivitiesForAnimalProduction
...
> Establishments primarily engaged in support activities for animal production.

## Overview

Support Activities for Animal Production represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11). This industry group encompasses establishments primarily engaged in support activities for animal production.
...
graph TD
    ...
    N115 --> N1152["1152: Support Activities for Animal Production"]
    style N1152 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 1152 - Support Activities for Animal Production*
