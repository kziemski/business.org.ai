...
Cotton Ginning represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1151 --> N115111["115111: Cotton Ginning"]
    style N115111 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 115111 |
| Market Segment | Cotton Ginning |
...
*Source: NAICS 115111 - Cotton Ginning*
