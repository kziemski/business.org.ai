...
Tree Production represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1114 --> N111421["111421: Tree Production"]
    style N111421 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 111421 - Tree Production*
