...
Potato Farming represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).

This U.S. industry comprises establishments primarily engaged in growing potatoes and/or producing seed potatoes. Cross-References.
...
graph TD
    ...
    N111 --> N1112["1112: Vegetable"]
    N1112 --> N111211["111211: Potato Farming"]
    style N111211 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 111211 |
| Market Segment | Potato Farming |
...
*Source: NAICS 111211 - Potato Farming*
