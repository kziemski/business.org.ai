...
Citrus (except Orange) Groves represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11). This industry encompasses establishments primarily engaged in citrus (.
...
graph TD
    ...
    N1113 --> N11132["11132: Citrus (except Orange) Groves"]
    style N11132 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 11132 |
| Market Segment | Citrus (except Orange) Groves |
...
*Source: NAICS 11132 - Citrus (except Orange) Groves*
