...
Sugar Beet Farming represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).

This U.S. industry comprises establishments primarily engaged in growing sugar beets. Cross-References.
...
graph TD
    ...
    N1119 --> N111991["111991: Sugar Beet Farming"]
    style N111991 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 111991 |
| Market Segment | Sugar Beet Farming |
...
*Source: NAICS 111991 - Sugar Beet Farming*
