...
> Establishments primarily engaged in melon farming.

## Overview

Melon Farming represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11). This industry group encompasses establishments primarily engaged in melon farming.
...
graph TD
    ...
    N111 --> N1112["1112: Melon Farming"]
    style N1112 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 1112 - Melon Farming*
