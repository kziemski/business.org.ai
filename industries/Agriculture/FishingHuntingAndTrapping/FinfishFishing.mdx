...
Finfish Fishing represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1141 --> N114111["114111: Finfish Fishing"]
    style N114111 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 114111 |
| Market Segment | Finfish Fishing |
...
*Source: NAICS 114111 - Finfish Fishing*
