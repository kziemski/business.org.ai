...
> Establishments primarily engaged in trapping.

## Overview

Trapping represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11). This industry group encompasses establishments primarily engaged in trapping.
...
graph TD
    ...
    style N1142 fill:#f96,stroke:#333,stroke-width:2px
```
