...
Marine Fishing represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1141 --> N114119["114119: Marine Fishing"]
    style N114119 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 114119 |
| Market Segment | Marine Fishing |
...
*Source: NAICS 114119 - Marine Fishing*
