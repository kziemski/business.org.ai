...
Shellfish Fishing represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N1141 --> N114112["114112: Shellfish Fishing"]
    style N114112 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 114112 |
| Market Segment | Shellfish Fishing |
...
*Source: NAICS 114112 - Shellfish Fishing*
