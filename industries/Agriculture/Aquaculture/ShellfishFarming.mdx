...
Shellfish Farming represents a specialized segment within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11).
...
graph TD
    ...
    N112 --> N112512["112512: Shellfish Farming"]
