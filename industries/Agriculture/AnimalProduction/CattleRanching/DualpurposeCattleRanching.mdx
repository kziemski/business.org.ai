---
id: DualpurposeCattleRanching
name: Dual-Purpose Cattle Ranching
code: 11213
type: Industry
level: Industry
status: complete
...
# Dual-Purpose Cattle Ranching

> See industry description for 112130.

## Overview

Dual-Purpose Cattle Ranching represents an important category within the Agriculture, Forestry, Fishing and Hunting sector (NAICS 11). This industry encompasses establishments primarily engaged in dual-purpose cattle ranching.
...
graph TD
    ...
    style N11213 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 11213 |
| Market Segment | Dual-Purpose Cattle Ranching |
...
*Source: NAICS 11213 - Dual-Purpose Cattle Ranching*
