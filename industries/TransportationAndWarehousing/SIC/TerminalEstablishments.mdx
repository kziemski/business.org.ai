---
id: TerminalEstablishments
name: Terminal Establishments
code: 4013
type: Industry
level: SIC (4013)
status: complete
...
Terminal Establishments represents an important category within the Transportation and Warehousing sector (SIC 4013).
...
graph TD
    ...
    S4849 --> N4013["4013: Terminal Establishments"]
    style N4013 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4013 |
| Market Segment | Terminal Establishments |
...
*Source: SIC 4013 - Terminal Establishments*
