...
Taxicabs represents an important category within the Transportation and Warehousing sector (SIC 4121).
...
graph TD
    ...
    S4849 --> N4121["4121: Taxicabs"]
    style N4121 fill:#f96,stroke:#333,stroke-width:2px
```
