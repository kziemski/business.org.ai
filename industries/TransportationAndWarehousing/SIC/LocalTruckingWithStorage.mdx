...
Local Trucking With Storage represents an important category within the Transportation and Warehousing sector (SIC 4214).
...
graph TD
    ...
    S4849 --> N4214["4214: Local Trucking With Storage"]
    style N4214 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4214 |
| Market Segment | Local Trucking With Storage |
...
*Source: SIC 4214 - Local Trucking With Storage*
