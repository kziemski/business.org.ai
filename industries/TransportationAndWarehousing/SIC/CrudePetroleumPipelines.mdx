...
Crude Petroleum Pipelines represents an important category within the Transportation and Warehousing sector (SIC 4612).
...
graph TD
    ...
    S4849 --> N4612["4612: Crude Petroleum Pipelines"]
    style N4612 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4612 |
| Market Segment | Crude Petroleum Pipelines |
...
*Source: SIC 4612 - Crude Petroleum Pipelines*
