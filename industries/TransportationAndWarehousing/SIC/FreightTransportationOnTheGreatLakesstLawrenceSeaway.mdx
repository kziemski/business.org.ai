---
id: FreightTransportationOnTheGreatLakesStLawrenceSeaway
...
Freight Transportation on the Great Lakes-St. Lawrence Seaway represents an important category within the Transportation and Warehousing sector (SIC 4432).
...
graph TD
    ...
    S4849 --> N4432["4432: Freight Transportation on the Great L..."]
    style N4432 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4432 |
| Market Segment | Freight Transportation on the Great Lakes-St. Lawrence Seaway |
...
*Source: SIC 4432 - Freight Transportation on the Great Lakes-St. Lawrence Seaway*
