...
Bus Charter Service represents an important category within the Transportation and Warehousing sector (SIC 4142).
...
graph TD
    ...
    S4849 --> N4142["4142: Bus Charter Service"]
    style N4142 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4142 |
| Market Segment | Bus Charter Service |
...
*Source: SIC 4142 - Bus Charter Service*
