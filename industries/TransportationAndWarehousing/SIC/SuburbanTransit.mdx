...
Suburban Transit represents an important category within the Transportation and Warehousing sector (SIC 4111).
...
graph TD
    ...
    S4849 --> N4111["4111: Suburban Transit"]
    style N4111 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4111 |
| Market Segment | Suburban Transit |
...
*Source: SIC 4111 - Suburban Transit*
