---
id: WaterTransportationServices
name: Water Transportation Services
code: 4499
type: Industry
level: SIC (4499)
status: complete
...
Water Transportation Services represents an important category within the Transportation and Warehousing sector (SIC 4499).
...
graph TD
    ...
    S4849 --> N449["449: Home Furnishings"]
    N449 --> N4499["4499: Water Transportation Services"]
    style N4499 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4499 |
| Market Segment | Water Transportation Services |
...
*Source: SIC 4499 - Water Transportation Services*
