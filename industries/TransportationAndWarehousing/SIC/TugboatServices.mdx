...
Tugboat Services represents an important category within the Transportation and Warehousing sector (SIC 4492).
...
graph TD
    ...
    style N4492 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4492 |
| Market Segment | Tugboat Services |
...
*Source: SIC 4492 - Tugboat Services*
