...
Rental of Railroad Cars represents an important category within the Transportation and Warehousing sector (SIC 4741).
...
graph TD
    ...
    S4849 --> N4741["4741: Rental of Railroad Cars"]
    style N4741 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4741 |
| Market Segment | Rental of Railroad Cars |
...
*Source: SIC 4741 - Rental of Railroad Cars*
