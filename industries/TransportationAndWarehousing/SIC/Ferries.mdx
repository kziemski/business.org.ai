...
Ferries represents an important category within the Transportation and Warehousing sector (SIC 4482).
...
graph TD
    ...
    S4849 --> N4482["4482: Ferries"]
    style N4482 fill:#f96,stroke:#333,stroke-width:2px
```
