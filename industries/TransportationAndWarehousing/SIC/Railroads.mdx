...
Railroads represents an important category within the Transportation and Warehousing sector (SIC 4011).
...
graph TD
    ...
    S4849 --> N4011["4011: Railroads"]
    style N4011 fill:#f96,stroke:#333,stroke-width:2px
```
