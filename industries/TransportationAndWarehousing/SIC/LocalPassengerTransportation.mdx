---
id: LocalPassengerTransportation
...
Local Passenger Transportation represents an important category within the Transportation and Warehousing sector (SIC 4119).
...
graph TD
    ...
    S4849 --> N4119["4119: Local Passenger Transportation"]
    style N4119 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4119 |
| Market Segment | Local Passenger Transportation |
...
*Source: SIC 4119 - Local Passenger Transportation*
