...
School Buses represents an important category within the Transportation and Warehousing sector (SIC 4151).
...
graph TD
    ...
    S4849 --> N4151["4151: School Buses"]
    style N4151 fill:#f96,stroke:#333,stroke-width:2px
```
