---
id: ArrangementOfTransportationOfFreight
name: Arrangement of Transportation of Freight
code: 4731
type: Industry
level: SIC (4731)
status: complete
...
Arrangement of Transportation of Freight represents an important category within the Transportation and Warehousing sector (SIC 4731).
...
graph TD
    ...
    S4849 --> N4731["4731: Arrangement of Transportation of Freight"]
    style N4731 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4731 |
| Market Segment | Arrangement of Transportation of Freight |
...
*Source: SIC 4731 - Arrangement of Transportation of Freight*
