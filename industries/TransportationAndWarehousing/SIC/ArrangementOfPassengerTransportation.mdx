---
id: ArrangementOfPassengerTransportation
name: Arrangement of Passenger Transportation
code: 4729
type: Industry
level: SIC (4729)
status: complete
...
Arrangement of Passenger Transportation represents an important category within the Transportation and Warehousing sector (SIC 4729).
...
graph TD
    ...
    S4849 --> N4729["4729: Arrangement of Passenger Transportation"]
    style N4729 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4729 |
| Market Segment | Arrangement of Passenger Transportation |
...
*Source: SIC 4729 - Arrangement of Passenger Transportation*
