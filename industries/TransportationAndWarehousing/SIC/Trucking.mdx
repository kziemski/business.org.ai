...
Trucking represents an important category within the Transportation and Warehousing sector (SIC 4213).
...
graph TD
    ...
    S4849 --> N4213["4213: Trucking"]
    style N4213 fill:#f96,stroke:#333,stroke-width:2px
```
