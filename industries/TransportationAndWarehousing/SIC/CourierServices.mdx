...
Courier Services represents an important category within the Transportation and Warehousing sector (SIC 4215).
...
graph TD
    ...
    S4849 --> N4215["4215: Courier Services"]
    style N4215 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4215 |
| Market Segment | Courier Services |
...
*Source: SIC 4215 - Courier Services*
