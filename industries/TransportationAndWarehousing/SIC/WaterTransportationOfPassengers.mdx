---
id: WaterTransportationOfPassengers
name: Water Transportation of Passengers
code: 4489
type: Industry
level: SIC (4489)
status: complete
...
Water Transportation of Passengers represents an important category within the Transportation and Warehousing sector (SIC 4489).
...
graph TD
    ...
    S4849 --> N4489["4489: Water Transportation of Passengers"]
    style N4489 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4489 |
| Market Segment | Water Transportation of Passengers |
...
*Source: SIC 4489 - Water Transportation of Passengers*
