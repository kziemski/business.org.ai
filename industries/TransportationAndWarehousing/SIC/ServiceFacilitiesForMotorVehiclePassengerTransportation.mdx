---
id: ServiceFacilitiesForMotorVehiclePassengerTransportation
name: Service Facilities for Motor Vehicle Passenger Transportation
code: 4173
type: Industry
level: SIC (4173)
status: complete
...
Service Facilities for Motor Vehicle Passenger Transportation represents an important category within the Transportation and Warehousing sector (SIC 4173).
...
graph TD
    ...
    S4849 --> N4173["4173: Service Facilities for Motor Vehicle ..."]
    style N4173 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4173 |
| Market Segment | Service Facilities for Motor Vehicle Passenger Transportation |
...
*Source: SIC 4173 - Service Facilities for Motor Vehicle Passenger Transportation*
