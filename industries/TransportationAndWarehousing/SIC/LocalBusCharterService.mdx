...
Local Bus Charter Service represents an important category within the Transportation and Warehousing sector (SIC 4141).
...
graph TD
    ...
    S4849 --> N4141["4141: Local Bus Charter Service"]
    style N4141 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4141 |
| Market Segment | Local Bus Charter Service |
...
*Source: SIC 4141 - Local Bus Charter Service*
