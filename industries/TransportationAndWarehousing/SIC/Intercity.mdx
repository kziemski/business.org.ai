...
Intercity represents an important category within the Transportation and Warehousing sector (SIC 4131).
...
graph TD
    ...
    S4849 --> N4131["4131: Intercity"]
    style N4131 fill:#f96,stroke:#333,stroke-width:2px
```
