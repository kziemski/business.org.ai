---
id: LocalTruckingWithoutStorage
...
Local Trucking Without Storage represents an important category within the Transportation and Warehousing sector (SIC 4212).
...
graph TD
    ...
    S4849 --> N4212["4212: Local Trucking Without Storage"]
    style N4212 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4212 |
| Market Segment | Local Trucking Without Storage |
...
*Source: SIC 4212 - Local Trucking Without Storage*
