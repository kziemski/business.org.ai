...
Refined Petroleum Pipelines represents an important category within the Transportation and Warehousing sector (SIC 4613).
...
graph TD
    ...
    S4849 --> N4613["4613: Refined Petroleum Pipelines"]
    style N4613 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4613 |
| Market Segment | Refined Petroleum Pipelines |
...
*Source: SIC 4613 - Refined Petroleum Pipelines*
