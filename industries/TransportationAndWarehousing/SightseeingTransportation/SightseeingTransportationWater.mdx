---
id: SightseeingTransportationWater
name: Sightseeing Transportation, Water
code: 4872
type: Industry
...
> Establishments primarily engaged in sightseeing transportation, water.

## Overview

Sightseeing Transportation, Water represents an important category within the Transportation and Warehousing sector (NAICS 48-49). This industry group encompasses establishments primarily engaged in sightseeing transportation, water.
...
graph TD
    ...
    S48-49 --> N487["487: Sightseeing Transportation"]
    N487 --> N4872["4872: Sightseeing Transportation, Water"]
    style N4872 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 4872 |
| Level | Industry Group |
| Parent | [Sightseeing Transportation](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 4872 |
| Market Segment | Sightseeing Transportation, Water |
...
*Source: NAICS 4872 - Sightseeing Transportation, Water*
