---
id: SightseeingTransportationLand
name: Sightseeing Transportation, Land
code: 4871
type: Industry
...
> Establishments primarily engaged in sightseeing transportation, land.

## Overview

Sightseeing Transportation, Land represents an important category within the Transportation and Warehousing sector (NAICS 48-49). This industry group encompasses establishments primarily engaged in sightseeing transportation, land.
...
graph TD
    ...
    style N4871 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4871 |
| Market Segment | Sightseeing Transportation, Land |
...
*Source: NAICS 4871 - Sightseeing Transportation, Land*
