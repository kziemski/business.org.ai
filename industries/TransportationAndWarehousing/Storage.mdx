...
Storage represents an important category within the Transportation and Warehousing sector (NAICS 48-49). This subsector encompasses establishments primarily engaged in storage.
...
graph TD
    ...
    S48-49 --> N493["493: Storage"]
    style N493 fill:#f96,stroke:#333,stroke-width:2px
```
