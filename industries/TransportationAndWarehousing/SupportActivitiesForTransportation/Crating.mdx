...
Crating represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).
...
graph TD
    ...
    N488 --> N488991["488991: Crating"]
    style N488991 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 488991 |
| Market Segment | Crating |
