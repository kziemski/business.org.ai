---
id: SupportActivitiesForRailTransportation
...
> Establishments primarily engaged in support activities for rail transportation.

## Overview

Support Activities for Rail Transportation represents an important category within the Transportation and Warehousing sector (NAICS 48-49). This industry group encompasses establishments primarily engaged in support activities for rail transportation.
...
graph TD
    ...
    N488 --> N4882["4882: Support Activities for Rail Transport..."]
    style N4882 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 4882 |
| Market Segment | Support Activities for Rail Transportation |
...
*Source: NAICS 4882 - Support Activities for Rail Transportation*
