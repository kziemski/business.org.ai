...
Air Traffic Control represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49). This national industry encompasses establishments primarily engaged in air traffic control.
...
graph TD
    ...
    style N488111 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 488111 - Air Traffic Control*
