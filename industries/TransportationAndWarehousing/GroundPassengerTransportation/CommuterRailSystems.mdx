...
Commuter Rail Systems represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).
...
graph TD
    ...
    N4851 --> N485112["485112: Commuter Rail Systems"]
    style N485112 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 485112 - Commuter Rail Systems*
