...
Water Transportation represents an important category within the Transportation and Warehousing sector (NAICS 48-49). This subsector encompasses establishments primarily engaged in water transportation.
...
graph TD
    ...
    S48-49 --> N483["483: Water Transportation"]
    style N483 fill:#f96,stroke:#333,stroke-width:2px
    N483 --> N4831["4831: Great Lakes Water Transportation"]
...
|----------|------|-------------|
| [Great Lakes Water Transportation](./GreatLakesWaterTransportation/) | 4831 | Great Lakes Water Transportation |
| [Inland Water Transportation](./InlandWaterTransportation/) | 4832 | Inland Water Transportation |
...
| NAICS/SIC Code | 483 |
| Market Segment | Water Transportation |
...
*Source: NAICS 483 - Water Transportation*
