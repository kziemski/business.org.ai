---
id: DeepSeaPassengerTransportation
...
Deep Sea Passenger Transportation represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).
...
graph TD
    ...
    N4831 --> N483112["483112: Deep Sea Passenger Transportation"]
    style N483112 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 483112 |
| Market Segment | Deep Sea Passenger Transportation |
...
*Source: NAICS 483112 - Deep Sea Passenger Transportation*
