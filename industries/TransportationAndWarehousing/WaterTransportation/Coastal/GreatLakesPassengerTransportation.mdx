---
id: GreatLakesPassengerTransportation
name: "Great Lakes Passenger Transportation"
code: "483114"
type: Industry
...
Great Lakes Passenger Transportation represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).
...
graph TD
    ...
    N4831 --> N483114["483114: Great Lakes Passenger Transportation"]
    style N483114 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 483114 - Great Lakes Passenger Transportation*
