---
id: GreatLakesFreightTransportation
name: "Great Lakes Freight Transportation"
code: "483113"
type: Industry
...
Great Lakes Freight Transportation represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).
...
graph TD
    ...
    N4831 --> N483113["483113: Great Lakes Freight Transportation"]
    style N483113 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 483113 - Great Lakes Freight Transportation*
