---
id: DeepSeaFreightTransportation
...
Deep Sea Freight Transportation represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).

This U.S. industry comprises establishments primarily engaged in providing deep sea transportation of cargo to or from foreign ports. Cross-References.
...
graph TD
    ...
    N483 --> N4831["4831: Deep Sea"]
    N4831 --> N483111["483111: Deep Sea Freight Transportation"]
    style N483111 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 483111 |
| Market Segment | Deep Sea Freight Transportation |
...
*Source: NAICS 483111 - Deep Sea Freight Transportation*
