---
id: InlandWaterFreightTransportation
...
Inland Water Freight Transportation represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).

This U.S. industry comprises establishments primarily engaged in providing inland water transportation of cargo on lakes, rivers, or intracoastal waterways (except on the Great Lakes System). Cross-References. Establishments primarily engaged in--
...
graph TD
    ...
    N4832 --> N483211["483211: Inland Water Freight Transportation"]
    style N483211 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 483211 |
| Market Segment | Inland Water Freight Transportation |
...
*Source: NAICS 483211 - Inland Water Freight Transportation*
