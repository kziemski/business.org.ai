---
id: PipelineTransportationOfRefinedPetroleumProducts
...
Pipeline Transportation of Refined Petroleum Products represents an important category within the Transportation and Warehousing sector (NAICS 48-49).
...
graph TD
    ...
    S4849 --> N486["486: Pipeline Transportation"]
    N486 --> N48691["48691: Pipeline Transportation of Refined Pe..."]
    style N48691 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 48691 |
| Market Segment | Pipeline Transportation of Refined Petroleum Products |
...
*Source: NAICS 48691 - Pipeline Transportation of Refined Petroleum Products*
