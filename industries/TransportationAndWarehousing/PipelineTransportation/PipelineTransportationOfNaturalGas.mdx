---
id: PipelineTransportationOfNaturalGas
...
> Establishments primarily engaged in pipeline transportation of natural gas.

## Overview

Pipeline Transportation of Natural Gas represents an important category within the Transportation and Warehousing sector (NAICS 48-49). This industry group encompasses establishments primarily engaged in pipeline transportation of natural gas.
...
graph TD
    ...
    N486 --> N4862["4862: Pipeline Transportation of Natural Gas"]
    style N4862 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 4862 |
| Level | Industry Group |
| Parent | [Pipeline Transportation](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 4862 |
| Market Segment | Pipeline Transportation of Natural Gas |
...
*Source: NAICS 4862 - Pipeline Transportation of Natural Gas*
