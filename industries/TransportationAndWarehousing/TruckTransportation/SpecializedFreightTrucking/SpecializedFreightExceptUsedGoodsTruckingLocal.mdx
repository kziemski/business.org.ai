---
id: SpecializedFreightExceptUsedGoodsTruckingLocal
...
Specialized Freight (except Used Goods) Trucking, Local represents an important category within the Transportation and Warehousing sector (NAICS 48-49). This industry encompasses establishments primarily engaged in specialized freight (except used goods) trucking, local.
...
graph TD
    ...
    N4842 --> N48422["48422: Specialized Freight (except Used Good..."]
    style N48422 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 48422 |
| Market Segment | Specialized Freight (except Used Goods) Trucking, Local |
...
*Source: NAICS 48422 - Specialized Freight (except Used Goods) Trucking, Local*
