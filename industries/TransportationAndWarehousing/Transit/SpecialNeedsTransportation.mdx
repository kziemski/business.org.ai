...
Special Needs Transportation represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).
...
graph TD
    ...
    N485 --> N485991["485991: Special Needs Transportation"]
    style N485991 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 485991 |
| Market Segment | Special Needs Transportation |
...
*Source: NAICS 485991 - Special Needs Transportation*
