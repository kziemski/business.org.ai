...
Short Line Railroads represents a specialized segment within the Transportation and Warehousing sector (NAICS 48-49).

This U.S. industry comprises establishments known as short-line railroads primarily engaged in operating railroads for the transport of cargo over a short distance on local rail lines not part of a rail network. Cross-References. Establishments primarily engaged in--
...
graph TD
    ...
    S4849 --> N482["482: Rail Transportation"]
    N482 --> N482112["482112: Short Line Railroads"]
    style N482112 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 482112 |
| Market Segment | Short Line Railroads |
...
*Source: NAICS 482112 - Short Line Railroads*
