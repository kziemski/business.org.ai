...
Consumer Electronics represents an important category within the Real Estate and Rental and Leasing sector (NAICS 53). This industry encompasses establishments primarily engaged in consumer electronics.
...
graph TD
    ...
    style N53221 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 53221 - Consumer Electronics*
