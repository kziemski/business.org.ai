---
id: CemeterySubdividers
name: Cemetery Subdividers
code: 6553
type: Industry
level: SIC (6553)
status: complete
...
Cemetery Subdividers represents an important category within the Real Estate and Rental and Leasing sector (SIC 6553).
...
graph TD
    ...
    S53 --> N6553["6553: Cemetery Subdividers"]
    style N6553 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 6553 |
| Market Segment | Cemetery Subdividers |
...
*Source: SIC 6553 - Cemetery Subdividers*
