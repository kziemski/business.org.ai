...
Poultry Products represents an important category within the Wholesale Trade sector (SIC 5144).
...
graph TD
    ...
    S42 --> N5144["5144: Poultry Products"]
    style N5144 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5144 |
| Market Segment | Poultry Products |
...
*Source: SIC 5144 - Poultry Products*
