...
Farm Supplies represents an important category within the Wholesale Trade sector (SIC 5191).
...
graph TD
    ...
    style N5191 fill:#f96,stroke:#333,stroke-width:2px
```
