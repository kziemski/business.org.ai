...
Packaged Frozen Foods represents an important category within the Wholesale Trade sector (SIC 5142).
...
graph TD
    ...
    S42 --> N5142["5142: Packaged Frozen Foods"]
    style N5142 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5142 |
| Market Segment | Packaged Frozen Foods |
...
*Source: SIC 5142 - Packaged Frozen Foods*
