...
Electrical Appliances represents an important category within the Wholesale Trade sector (SIC 5064).
...
graph TD
    ...
    S42 --> N5064["5064: Electrical Appliances"]
    style N5064 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5064 |
| Market Segment | Electrical Appliances |
...
*Source: SIC 5064 - Electrical Appliances*
