...
Meat Products represents an important category within the Wholesale Trade sector (SIC 5147).
...
graph TD
    ...
    S42 --> N5147["5147: Meat Products"]
    style N5147 fill:#f96,stroke:#333,stroke-width:2px
```
