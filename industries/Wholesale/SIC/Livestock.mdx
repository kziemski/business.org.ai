...
Livestock represents an important category within the Wholesale Trade sector (SIC 5154).
...
graph TD
    ...
    S42 --> N5154["5154: Livestock"]
    style N5154 fill:#f96,stroke:#333,stroke-width:2px
```
