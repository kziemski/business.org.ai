...
Office Equipment represents an important category within the Wholesale Trade sector (SIC 5044).
...
graph TD
    ...
    S42 --> N5044["5044: Office Equipment"]
    style N5044 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5044 |
| Market Segment | Office Equipment |
...
*Source: SIC 5044 - Office Equipment*
