---
id: SuppliesHydronics
name: Supplies (Hydronics)
code: 5074
type: Industry
level: SIC (5074)
status: complete
...
Supplies (Hydronics) represents an important category within the Wholesale Trade sector (SIC 5074).
...
graph TD
    ...
    S42 --> N5074["5074: Supplies (Hydronics)"]
    style N5074 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5074 |
| Market Segment | Supplies (Hydronics) |
...
*Source: SIC 5074 - Supplies (Hydronics)*
