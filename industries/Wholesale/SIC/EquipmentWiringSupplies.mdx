---
id: EquipmentWiringSupplies
name: Equipment Wiring Supplies
code: 5063
type: Industry
level: SIC (5063)
status: complete
...
Equipment Wiring Supplies represents an important category within the Wholesale Trade sector (SIC 5063).
...
graph TD
    ...
    S42 --> N5063["5063: Equipment Wiring Supplies"]
    style N5063 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5063 |
| Market Segment | Equipment Wiring Supplies |
...
*Source: SIC 5063 - Equipment Wiring Supplies*
