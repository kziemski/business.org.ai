...
Tobacco Products represents an important category within the Wholesale Trade sector (SIC 5194).
...
graph TD
    ...
    S42 --> N519["519: Web Search Portals"]
    N519 --> N5194["5194: Tobacco Products"]
    style N5194 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5194 |
| Market Segment | Tobacco Products |
...
*Source: SIC 5194 - Tobacco Products*
