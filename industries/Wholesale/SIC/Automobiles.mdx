...
Automobiles represents an important category within the Wholesale Trade sector (SIC 5012).
...
graph TD
    ...
    S42 --> N5012["5012: Automobiles"]
    style N5012 fill:#f96,stroke:#333,stroke-width:2px
```
