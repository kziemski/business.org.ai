...
Fresh Fruits represents an important category within the Wholesale Trade sector (SIC 5148).
...
graph TD
    ...
    S42 --> N5148["5148: Fresh Fruits"]
    style N5148 fill:#f96,stroke:#333,stroke-width:2px
```
