...
Computers represents an important category within the Wholesale Trade sector (SIC 5045).
...
graph TD
    ...
    S42 --> N5045["5045: Computers"]
    style N5045 fill:#f96,stroke:#333,stroke-width:2px
```
