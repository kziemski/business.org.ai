---
id: DistilledAlcoholicBeverages
...
Distilled Alcoholic Beverages represents an important category within the Wholesale Trade sector (SIC 5182).
...
graph TD
    ...
    S42 --> N518["518: Computing Infrastructure Providers"]
    N518 --> N5182["5182: Distilled Alcoholic Beverages"]
    style N5182 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5182 |
| Market Segment | Distilled Alcoholic Beverages |
...
*Source: SIC 5182 - Distilled Alcoholic Beverages*
