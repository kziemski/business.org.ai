...
Allied Products represents an important category within the Wholesale Trade sector (SIC 5169).
...
graph TD
    ...
    S42 --> N516["516: Broadcasting"]
    N516 --> N5169["5169: Allied Products"]
    style N5169 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5169 |
| Market Segment | Allied Products |
...
*Source: SIC 5169 - Allied Products*
