...
Field Beans represents an important category within the Wholesale Trade sector (SIC 5153).
...
graph TD
    ...
    S42 --> N5153["5153: Field Beans"]
    style N5153 fill:#f96,stroke:#333,stroke-width:2px
```
