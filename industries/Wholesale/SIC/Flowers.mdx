...
Flowers represents an important category within the Wholesale Trade sector (SIC 5193).
...
graph TD
    ...
    style N5193 fill:#f96,stroke:#333,stroke-width:2px
```
