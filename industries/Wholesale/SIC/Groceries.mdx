...
Groceries represents an important category within the Wholesale Trade sector (SIC 5141).
...
graph TD
    ...
    S42 --> N5141["5141: Groceries"]
    style N5141 fill:#f96,stroke:#333,stroke-width:2px
```
