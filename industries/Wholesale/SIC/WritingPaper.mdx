...
Writing Paper represents an important category within the Wholesale Trade sector (SIC 5111).
...
graph TD
    ...
    S42 --> N5111["5111: Writing Paper"]
    style N5111 fill:#f96,stroke:#333,stroke-width:2px
```
