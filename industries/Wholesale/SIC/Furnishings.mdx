...
Furnishings represents an important category within the Wholesale Trade sector (SIC 5136).
...
graph TD
    ...
    S42 --> N513["513: Publishing Industries"]
    N513 --> N5136["5136: Furnishings"]
    style N5136 fill:#f96,stroke:#333,stroke-width:2px
```
