---
id: PersonalServicePaper
name: Personal Service Paper
code: 5113
type: Industry
level: SIC (5113)
status: complete
...
Personal Service Paper represents an important category within the Wholesale Trade sector (SIC 5113).
...
graph TD
    ...
    S42 --> N5113["5113: Personal Service Paper"]
    style N5113 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5113 |
| Market Segment | Personal Service Paper |
...
*Source: SIC 5113 - Personal Service Paper*
