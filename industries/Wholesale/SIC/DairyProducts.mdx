...
Dairy Products represents an important category within the Wholesale Trade sector (SIC 5143).
...
graph TD
    ...
    S42 --> N5143["5143: Dairy Products"]
    style N5143 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 5143 - Dairy Products*
