...
New Parts represents an important category within the Wholesale Trade sector (SIC 5013).
...
graph TD
    ...
    S42 --> N5013["5013: New Parts"]
    style N5013 fill:#f96,stroke:#333,stroke-width:2px
```
