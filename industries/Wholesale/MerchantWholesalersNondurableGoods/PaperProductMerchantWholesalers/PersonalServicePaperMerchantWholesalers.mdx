---
id: PersonalServicePaperMerchantWholesalers
name: Personal Service Paper Merchant Wholesalers
code: 42413
type: Industry
level: Industry
status: complete
...
# Personal Service Paper Merchant Wholesalers

> See industry description for 424130.

## Overview

Personal Service Paper Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in personal service paper merchant wholesalers.
...
graph TD
    ...
    N4241 --> N42413["42413: Personal Service Paper Merchant Whole..."]
    style N42413 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 42413 |
| Level | Industry |
| Parent | [Paper Product Merchant Wholesalers](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 42413 |
| Market Segment | Personal Service Paper Merchant Wholesalers |
...
*Source: NAICS 42413 - Personal Service Paper Merchant Wholesalers*
