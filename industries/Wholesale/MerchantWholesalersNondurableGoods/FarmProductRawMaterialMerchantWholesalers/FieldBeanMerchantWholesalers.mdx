---
id: FieldBeanMerchantWholesalers
name: Field Bean Merchant Wholesalers
code: 42451
type: Industry
level: Industry
status: complete
...
Field Bean Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in field bean merchant wholesalers.
...
graph TD
    ...
    style N42451 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 42451 |
| Level | Industry |
| Parent | [Farm Product Raw Material Merchant Wholesalers](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 42451 |
| Market Segment | Field Bean Merchant Wholesalers |
...
*Source: NAICS 42451 - Field Bean Merchant Wholesalers*
