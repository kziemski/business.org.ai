---
id: ShapesMerchantWholesalers
name: Shapes Merchant Wholesalers
code: 42461
type: Industry
level: Industry
status: complete
...
Shapes Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in shapes merchant wholesalers.
...
graph TD
    ...
    style N42461 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 42461 |
| Level | Industry |
| Parent | [Allied Products Merchant Wholesalers](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 42461 |
| Market Segment | Shapes Merchant Wholesalers |
...
*Source: NAICS 42461 - Shapes Merchant Wholesalers*
