---
id: PetroleumBulkStations
name: Petroleum Bulk Stations
code: 42471
type: Industry
level: Industry
status: complete
...
Petroleum Bulk Stations represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in petroleum bulk stations.
...
graph TD
    ...
    style N42471 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 42471 |
| Level | Industry |
| Parent | [Petroleum Products Merchant Wholesalers](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 42471 |
| Market Segment | Petroleum Bulk Stations |
...
*Source: NAICS 42471 - Petroleum Bulk Stations*
