---
id: PackagedFrozenFoodMerchantWholesalers
...
Packaged Frozen Food Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in packaged frozen food merchant wholesalers.
...
graph TD
    ...
    N4244 --> N42442["42442: Packaged Frozen Food Merchant Wholesa..."]
    style N42442 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 42442 |
| Market Segment | Packaged Frozen Food Merchant Wholesalers |
...
*Source: NAICS 42442 - Packaged Frozen Food Merchant Wholesalers*
