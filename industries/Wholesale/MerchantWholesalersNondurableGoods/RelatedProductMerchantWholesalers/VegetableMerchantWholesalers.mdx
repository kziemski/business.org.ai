---
id: VegetableMerchantWholesalers
name: Vegetable Merchant Wholesalers
code: 42448
type: Industry
level: Industry
status: complete
...
Vegetable Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in vegetable merchant wholesalers.
...
graph TD
    ...
    N4244 --> N42448["42448: Vegetable Merchant Wholesalers"]
    style N42448 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 42448 |
| Market Segment | Vegetable Merchant Wholesalers |
...
*Source: NAICS 42448 - Vegetable Merchant Wholesalers*
