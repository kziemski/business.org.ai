---
id: MotorVehiclePartsUsedMerchantWholesalers
...
Motor Vehicle Parts (Used) Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in motor vehicle parts (used) merchant wholesalers.
...
graph TD
    ...
    N4231 --> N42314["42314: Motor Vehicle Parts (Used) Merchant W..."]
    style N42314 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 42314 |
| Level | Industry |
| Parent | [Supplies Merchant Wholesalers](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 42314 |
| Market Segment | Motor Vehicle Parts (Used) Merchant Wholesalers |
...
*Source: NAICS 42314 - Motor Vehicle Parts (Used) Merchant Wholesalers*
