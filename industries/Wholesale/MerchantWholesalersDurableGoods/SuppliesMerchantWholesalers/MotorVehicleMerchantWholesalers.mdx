---
id: MotorVehicleMerchantWholesalers
name: Motor Vehicle Merchant Wholesalers
code: 42311
type: Industry
level: Industry
status: complete
...
Motor Vehicle Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in motor vehicle merchant wholesalers.
...
graph TD
    ...
    style N42311 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 42311 |
| Market Segment | Motor Vehicle Merchant Wholesalers |
...
*Source: NAICS 42311 - Motor Vehicle Merchant Wholesalers*
