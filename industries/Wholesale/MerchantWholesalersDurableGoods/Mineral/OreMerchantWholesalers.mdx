---
id: OreMerchantWholesalers
name: Ore Merchant Wholesalers
code: 42352
type: Industry
level: Industry
status: complete
...
Ore Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in ore merchant wholesalers.
...
graph TD
    ...
    style N42352 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 42352 |
| Market Segment | Ore Merchant Wholesalers |
...
*Source: NAICS 42352 - Ore Merchant Wholesalers*
