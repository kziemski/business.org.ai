---
id: ComputerPeripheralEquipment
name: Computer Peripheral Equipment
code: 42343
type: Industry
level: Industry
status: complete
...
Computer Peripheral Equipment represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in computer peripheral equipment.
...
graph TD
    ...
    style N42343 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 42343 |
| Market Segment | Computer Peripheral Equipment |
...
*Source: NAICS 42343 - Computer Peripheral Equipment*
