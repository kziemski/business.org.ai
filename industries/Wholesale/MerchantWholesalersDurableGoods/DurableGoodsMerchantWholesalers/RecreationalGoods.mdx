---
id: RecreationalGoods
name: Recreational Goods
code: 42391
type: Industry
level: Industry
status: complete
...
Recreational Goods represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in recreational goods.
...
graph TD
    ...
    style N42391 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 42391 |
| Market Segment | Recreational Goods |
...
*Source: NAICS 42391 - Recreational Goods*
