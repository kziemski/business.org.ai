---
id: HardwareMerchantWholesalers
...
Hardware Merchant Wholesalers represents an important category within the Wholesale Trade sector (NAICS 42). This industry encompasses establishments primarily engaged in hardware merchant wholesalers.
...
graph TD
    ...
    style N42371 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 42371 |
| Market Segment | Hardware Merchant Wholesalers |
...
*Source: NAICS 42371 - Hardware Merchant Wholesalers*
