...
Mobile Food Services represents an important category within the Accommodation and Food Services sector (NAICS 72). This industry encompasses establishments primarily engaged in mobile food services.
...
graph TD
    ...
    style N72233 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 72233 |
| Market Segment | Mobile Food Services |
...
*Source: NAICS 72233 - Mobile Food Services*
