...
Hotels ( represents an important category within the Accommodation and Food Services sector (NAICS 72).
...
graph TD
    ...
    style N72111 fill:#f96,stroke:#333,stroke-width:2px
```
