...
Recreational Vehicle Parks represents an important category within the Accommodation and Food Services sector (SIC 7033).
...
graph TD
    ...
    S72 --> N7033["7033: Recreational Vehicle Parks"]
    style N7033 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7033 |
| Market Segment | Recreational Vehicle Parks |
...
*Source: SIC 7033 - Recreational Vehicle Parks*
