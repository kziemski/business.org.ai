...
Boarding Houses represents an important category within the Accommodation and Food Services sector (SIC 7021).
...
graph TD
    ...
    S72 --> N7021["7021: Boarding Houses"]
    style N7021 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7021 |
| Market Segment | Boarding Houses |
...
*Source: SIC 7021 - Boarding Houses*
