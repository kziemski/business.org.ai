...
Medical Laboratories represents a specialized segment within the Health Care and Social Assistance sector (NAICS 62).
...
graph TD
    ...
    N6215 --> N621511["621511: Medical Laboratories"]
    style N621511 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: NAICS 621511 - Medical Laboratories*
