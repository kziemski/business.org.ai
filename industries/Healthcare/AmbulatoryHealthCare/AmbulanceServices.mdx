...
Ambulance Services represents an important category within the Health Care and Social Assistance sector (NAICS 62).
...
graph TD
    ...
    N621 --> N62191["62191: Ambulance Services"]
    style N62191 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 62191 |
| Market Segment | Ambulance Services |
...
*Source: NAICS 62191 - Ambulance Services*
