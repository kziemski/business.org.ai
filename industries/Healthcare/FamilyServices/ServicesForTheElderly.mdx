---
id: ServicesForTheElderly
name: Services for the Elderly
code: 62412
type: Industry
level: Industry
status: complete
...
Services for the Elderly represents an important category within the Health Care and Social Assistance sector (NAICS 62).
...
graph TD
    ...
    style N62412 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 62412 |
| Market Segment | Services for the Elderly |
...
*Source: NAICS 62412 - Services for the Elderly*
