...
Specialty Hospitals represents an important category within the Health Care and Social Assistance sector (SIC 8069).
...
graph TD
    ...
    S62 --> N8069["8069: Specialty Hospitals"]
    style N8069 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8069 |
| Market Segment | Specialty Hospitals |
...
*Source: SIC 8069 - Specialty Hospitals*
