---
id: ClinicsOfDoctorsOfMedicine
name: Clinics of Doctors of Medicine
code: 8011
type: Industry
level: SIC (8011)
status: complete
...
Clinics of Doctors of Medicine represents an important category within the Health Care and Social Assistance sector (SIC 8011).
...
graph TD
    ...
    S62 --> N8011["8011: Clinics of Doctors of Medicine"]
    style N8011 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8011 |
| Market Segment | Clinics of Doctors of Medicine |
...
*Source: SIC 8011 - Clinics of Doctors of Medicine*
