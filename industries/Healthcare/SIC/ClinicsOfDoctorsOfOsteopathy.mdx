---
id: ClinicsOfDoctorsOfOsteopathy
name: Clinics of Doctors of Osteopathy
code: 8031
type: Industry
level: SIC (8031)
status: complete
...
Clinics of Doctors of Osteopathy represents an important category within the Health Care and Social Assistance sector (SIC 8031).
...
graph TD
    ...
    S62 --> N8031["8031: Clinics of Doctors of Osteopathy"]
    style N8031 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8031 |
| Market Segment | Clinics of Doctors of Osteopathy |
...
*Source: SIC 8031 - Clinics of Doctors of Osteopathy*
