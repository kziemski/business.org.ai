...
Residential Care represents an important category within the Health Care and Social Assistance sector (SIC 8361).
...
graph TD
    ...
    S62 --> N8361["8361: Residential Care"]
    style N8361 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8361 |
| Market Segment | Residential Care |
...
*Source: SIC 8361 - Residential Care*
