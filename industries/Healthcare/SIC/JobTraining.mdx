...
Job Training represents an important category within the Health Care and Social Assistance sector (SIC 8331).
...
graph TD
    ...
    S62 --> N8331["8331: Job Training"]
    style N8331 fill:#f96,stroke:#333,stroke-width:2px
```
