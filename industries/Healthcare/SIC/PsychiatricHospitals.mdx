...
Psychiatric Hospitals represents an important category within the Health Care and Social Assistance sector (SIC 8063).
...
graph TD
    ...
    S62 --> N8063["8063: Psychiatric Hospitals"]
    style N8063 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8063 |
| Market Segment | Psychiatric Hospitals |
...
*Source: SIC 8063 - Psychiatric Hospitals*
