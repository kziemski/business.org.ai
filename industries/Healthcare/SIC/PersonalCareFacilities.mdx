---
id: PersonalCareFacilities
name: Personal Care Facilities
code: 8059
type: Industry
level: SIC (8059)
status: complete
...
Personal Care Facilities represents an important category within the Health Care and Social Assistance sector (SIC 8059).
...
graph TD
    ...
    S62 --> N8059["8059: Personal Care Facilities"]
    style N8059 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8059 |
| Market Segment | Personal Care Facilities |
...
*Source: SIC 8059 - Personal Care Facilities*
