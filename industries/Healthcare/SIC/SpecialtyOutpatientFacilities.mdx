---
id: SpecialtyOutpatientFacilities
name: Specialty Outpatient Facilities
code: 8093
type: Industry
level: SIC (8093)
status: complete
...
Specialty Outpatient Facilities represents an important category within the Health Care and Social Assistance sector (SIC 8093).
...
graph TD
    ...
    S62 --> N8093["8093: Specialty Outpatient Facilities"]
    style N8093 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8093 |
| Market Segment | Specialty Outpatient Facilities |
...
*Source: SIC 8093 - Specialty Outpatient Facilities*
