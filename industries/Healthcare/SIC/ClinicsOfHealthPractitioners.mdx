---
id: ClinicsOfHealthPractitioners
name: Clinics of Health Practitioners
code: 8049
type: Industry
level: SIC (8049)
status: complete
...
# Clinics of Health Practitioners

> Offices and Clinics of Health Practitioners.

## Overview

Clinics of Health Practitioners represents an important category within the Health Care and Social Assistance sector (SIC 8049).
...
graph TD
    ...
    S62 --> N8049["8049: Clinics of Health Practitioners"]
    style N8049 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8049 |
| Market Segment | Clinics of Health Practitioners |
...
*Source: SIC 8049 - Clinics of Health Practitioners*
