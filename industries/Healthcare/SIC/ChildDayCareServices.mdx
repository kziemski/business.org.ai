...
Child Day Care Services represents an important category within the Health Care and Social Assistance sector (SIC 8351).
...
graph TD
    ...
    S62 --> N8351["8351: Child Day Care Services"]
    style N8351 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 8351 |
| Market Segment | Child Day Care Services |
...
*Source: SIC 8351 - Child Day Care Services*
