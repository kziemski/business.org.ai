---
id: DevelopmentalDisabilityFacilities
name: Developmental Disability Facilities
code: 62321
type: Industry
level: Industry
status: complete
...
Developmental Disability Facilities represents an important category within the Health Care and Social Assistance sector (NAICS 62). This industry encompasses establishments primarily engaged in developmental disability facilities.
...
graph TD
    ...
    style N62321 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS Code | 62321 |
| Level | Industry |
| Parent | [Residential Intellectual and Developmental Disability](../) |
| Child Industries | 0 |
...
| NAICS/SIC Code | 62321 |
| Market Segment | Developmental Disability Facilities |
...
*Source: NAICS 62321 - Developmental Disability Facilities*
