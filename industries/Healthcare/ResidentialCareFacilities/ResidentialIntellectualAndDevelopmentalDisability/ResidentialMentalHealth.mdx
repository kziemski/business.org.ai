---
id: ResidentialMentalHealth
name: Residential Mental Health
code: 62322
type: Industry
level: Industry
status: complete
...
Residential Mental Health represents an important category within the Health Care and Social Assistance sector (NAICS 62). This industry encompasses establishments primarily engaged in residential mental health.
...
graph TD
    ...
    style N62322 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 62322 |
| Market Segment | Residential Mental Health |
...
*Source: NAICS 62322 - Residential Mental Health*
