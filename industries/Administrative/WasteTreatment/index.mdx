...
> Establishments primarily engaged in waste treatment.

## Overview

Waste Treatment represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (NAICS 56).
...
graph TD
    ...
    style N5622 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5622 |
| Market Segment | Waste Treatment |
...
*Source: NAICS 5622 - Waste Treatment*
