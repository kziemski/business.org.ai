...
Tour Operators represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (NAICS 56). This industry encompasses establishments primarily engaged in tour operators.
...
graph TD
    ...
    style N56152 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 56152 |
| Market Segment | Tour Operators |
...
*Source: NAICS 56152 - Tour Operators*
