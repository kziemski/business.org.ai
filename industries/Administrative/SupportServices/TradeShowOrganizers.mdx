---
id: TradeShowOrganizers
name: Trade Show Organizers
code: 56192
type: Industry
level: Industry
status: complete
...
Trade Show Organizers represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (NAICS 56).
...
graph TD
    ...
    N561 --> N56192["56192: Trade Show Organizers"]
    style N56192 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 56192 |
| Market Segment | Trade Show Organizers |
...
*Source: NAICS 56192 - Trade Show Organizers*
