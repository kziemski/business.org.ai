...
Labeling Services represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (NAICS 56).
...
graph TD
    ...
    N561 --> N56191["56191: Labeling Services"]
    style N56191 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 56191 |
| Market Segment | Labeling Services |
...
*Source: NAICS 56191 - Labeling Services*
