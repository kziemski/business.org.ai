...
> Establishments primarily engaged in waste collection.

## Overview

Waste Collection represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (NAICS 56).
...
graph TD
    ...
    style N5621 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 5621 |
| Market Segment | Waste Collection |
...
*Source: NAICS 5621 - Waste Collection*
