---
id: ComputerProgrammingServices
...
Computer Programming Services represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7371).
...
graph TD
    ...
    S56 --> N7371["7371: Computer Programming Services"]
    style N7371 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7371 |
| Market Segment | Computer Programming Services |
...
*Source: SIC 7371 - Computer Programming Services*
