---
id: InformationRetrievalServices
...
Information Retrieval Services represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7375).
...
graph TD
    ...
    S56 --> N7375["7375: Information Retrieval Services"]
    style N7375 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7375 |
| Market Segment | Information Retrieval Services |
...
*Source: SIC 7375 - Information Retrieval Services*
