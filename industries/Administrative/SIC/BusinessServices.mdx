...
Business Services represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7389).
...
graph TD
    ...
    S56 --> N7389["7389: Business Services"]
    style N7389 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7389 |
| Market Segment | Business Services |
...
*Source: SIC 7389 - Business Services*
