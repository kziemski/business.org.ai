...
News Syndicates represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7383).
...
graph TD
    ...
    S56 --> N7383["7383: News Syndicates"]
    style N7383 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7383 |
| Market Segment | News Syndicates |
...
*Source: SIC 7383 - News Syndicates*
