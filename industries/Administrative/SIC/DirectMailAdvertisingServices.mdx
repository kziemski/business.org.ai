---
id: DirectMailAdvertisingServices
...
Direct Mail Advertising Services represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7331).
...
graph TD
    ...
    S56 --> N7331["7331: Direct Mail Advertising Services"]
    style N7331 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7331 |
| Market Segment | Direct Mail Advertising Services |
...
*Source: SIC 7331 - Direct Mail Advertising Services*
