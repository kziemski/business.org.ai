---
id: ComputerIntegratedSystemsDesign
...
Computer Integrated Systems Design represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7373).
...
graph TD
    ...
    S56 --> N7373["7373: Computer Integrated Systems Design"]
    style N7373 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7373 |
| Market Segment | Computer Integrated Systems Design |
...
*Source: SIC 7373 - Computer Integrated Systems Design*
