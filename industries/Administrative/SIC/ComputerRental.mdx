...
Computer Rental represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7377).
...
graph TD
    ...
    S56 --> N7377["7377: Computer Rental"]
    style N7377 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7377 |
| Market Segment | Computer Rental |
...
*Source: SIC 7377 - Computer Rental*
