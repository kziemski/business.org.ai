...
Computer Processing represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7374).
...
graph TD
    ...
    S56 --> N7374["7374: Computer Processing"]
    style N7374 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7374 |
| Market Segment | Computer Processing |
...
*Source: SIC 7374 - Computer Processing*
