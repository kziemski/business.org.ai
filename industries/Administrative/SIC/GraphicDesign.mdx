...
Graphic Design represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7336).
...
graph TD
    ...
    S56 --> N7336["7336: Graphic Design"]
    style N7336 fill:#f96,stroke:#333,stroke-width:2px
```
...
*Source: SIC 7336 - Graphic Design*
