...
Collection Services represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7322).
...
graph TD
    ...
    S56 --> N7322["7322: Collection Services"]
    style N7322 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7322 |
| Market Segment | Collection Services |
...
*Source: SIC 7322 - Collection Services*
