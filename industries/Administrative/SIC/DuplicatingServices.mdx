...
Duplicating Services represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7334).
...
graph TD
    ...
    S56 --> N7334["7334: Duplicating Services"]
    style N7334 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 7334 |
| Market Segment | Duplicating Services |
...
*Source: SIC 7334 - Duplicating Services*
