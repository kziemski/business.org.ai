...
Disinfecting represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7342).
...
graph TD
    ...
    S56 --> N7342["7342: Disinfecting"]
    style N7342 fill:#f96,stroke:#333,stroke-width:2px
```
