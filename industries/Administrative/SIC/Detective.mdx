...
Detective represents an important category within the Administrative and Support and Waste Management and Remediation Services sector (SIC 7381).
...
graph TD
    ...
    S56 --> N7381["7381: Detective"]
    style N7381 fill:#f96,stroke:#333,stroke-width:2px
```
