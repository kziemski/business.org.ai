---
id: DirectLifeInsuranceCarriers
...
Direct Life Insurance Carriers represents a specialized segment within the Finance and Insurance sector (NAICS 52).

This U.S. industry comprises establishments primarily engaged in initially underwriting (i.e., assuming the risk and assigning premiums) annuities and life insurance policies, disability income insurance policies, and accidental death and dismemberment insurance policies. Cross-References.
...
graph TD
    ...
    style N524113 fill:#f96,stroke:#333,stroke-width:2px
```
...
| NAICS/SIC Code | 524113 |
| Market Segment | Direct Life Insurance Carriers |
...
*Source: NAICS 524113 - Direct Life Insurance Carriers*
