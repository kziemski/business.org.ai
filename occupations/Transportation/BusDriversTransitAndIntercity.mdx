...
Bus Drivers, Transit and Intercity professionals drive bus or motor coach, including regular route operations, charters, and private carriage. This occupation falls within the Transportation and Material Moving category and requires a combination of specialized knowledge, technical skills, and practical experience.
...
```graphdl
Bus Drivers, Transit and Intercity perform:
