...
```mermaid
mindmap
    root(("Command and Control Center Specialists"))
        Core Tasks
...
### Active Duty
Full-time military service with deployment readiness. Command and Control Center Specialists professionals maintain combat and operational readiness.
...
```
Command and Control Center Specialists perform:
