...
- Defense - All Branches - Command center operations
- [Government](/industries/PublicAdministration) - Emergency management agencies
- Aerospace - Space operations and satellite control
- Defense Contractors - C2 systems development
...
- [Information Technology](/occupations/Technology/index) - IT operations and network management
- [Emergency Management](/occupations/ProtectiveService) - FEMA, state, and local emergency operations
- [Cybersecurity](/occupations/Technology/index) - Security operations centers
- Defense Contractors - C2 systems development and operations
- [Aviation](/occupations/Transportation/index) - Air traffic control and flight operations
- [Management](/occupations/Management/index) - Operations management and crisis response

## Departments

This occupation typically works in:
- [Operations Centers](/departments/Operations/index)
- [Combat Information Centers](/departments/Operations/index)
- [Joint Operations Centers](/departments/Operations/index)
- [Air Operations Centers](/departments/Operations/index)
- [Emergency Management](/departments/Operations/index)
