...
This activity encompasses the end-to-end process of solicit customer feedback on services delivered within the customer service and support domain. It involves coordinating cross-functional teams, applying standardized methodologies, and leveraging organizational data to ensure consistent and effective outcomes. The process is aligned with the broader Manage Customer Service framework (APQC 6.3.4.4.3) and supports strategic objectives by translating operational requirements into actionable procedures.
...
flowchart LR
    ...
    subgraph Process["Solicit customer feedback on services delivered"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Solicit customer feedback on services delivered"]
        P4["Validate & Review"]
...
| Solicit customer feedback on services delivered | R | A | C | I |
