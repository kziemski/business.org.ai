...
flowchart LR
    ...
    subgraph Process["Create service order fulfillment schedule"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Create service order fulfillment schedule"]
        P4["Validate & Review"]
...
| Create service order fulfillment schedule | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete create service order fulfillment schedule process | Hours/Days |
| Completion Rate | Percentage of service order fulfillment schedule activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of service order fulfillment schedule outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of service order fulfillment schedule processed | $/Unit |
| Customer Satisfaction (CSAT) | Customer rating of the service order fulfillment schedule experience | 1-5 Scale |

## Related Concepts

- ServiceOrderFulfillmentSchedule
