...
flowchart LR
    ...
    subgraph Process["Generate service order"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Generate service order"]
        P4["Validate & Review"]
...
| Generate service order | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete generate service order process | Hours/Days |
| Completion Rate | Percentage of service order activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of service order outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of service order processed | $/Unit |
| Customer Satisfaction (CSAT) | Customer rating of the service order experience | 1-5 Scale |
