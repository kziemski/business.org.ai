...
flowchart LR
    ...
    subgraph Process["Investigate issue/perform root cause analysis"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Investigate issue/perform root cause analysis"]
        P4["Validate & Review"]
...
| Investigate issue/perform root cause analysis | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete investigate issueperform root cause analysis process | Hours/Days |
| Completion Rate | Percentage of issueperform root cause analysis activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of issueperform root cause analysis outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of issueperform root cause analysis processed | $/Unit |
| Customer Satisfaction (CSAT) | Customer rating of the issueperform root cause analysis experience | 1-5 Scale |
