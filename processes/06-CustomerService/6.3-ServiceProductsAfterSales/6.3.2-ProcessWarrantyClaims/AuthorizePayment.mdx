...
flowchart LR
    ...
    subgraph Process["Authorize payment"]
...
sequenceDiagram
    ...
    Agent->>Supervisor: Initiate authorize payment request
...
|-----|-------------|------|
| Cycle Time | Average time to complete authorize payment process | Hours/Days |
| Completion Rate | Percentage of payment activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of payment outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of payment processed | $/Unit |
