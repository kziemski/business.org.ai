...
flowchart LR
    ...
    subgraph Process["Analyze terms"]
...
sequenceDiagram
    ...
    Agent->>Supervisor: Initiate analyze terms request
...
|-----|-------------|------|
| Cycle Time | Average time to complete analyze terms process | Hours/Days |
| Completion Rate | Percentage of terms activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of terms outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of terms processed | $/Unit |
