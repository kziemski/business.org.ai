...
flowchart LR
    ...
    subgraph Process["Assess student and stakeholder needs"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Assess student and stakeholder needs"]
        P4["Validate & Review"]
...
sequenceDiagram
    ...
    Agent->>Supervisor: Initiate assess student and stakeholder needs request
...
| Assess student and stakeholder needs | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete assess student and stakeholder needs process | Hours/Days |
