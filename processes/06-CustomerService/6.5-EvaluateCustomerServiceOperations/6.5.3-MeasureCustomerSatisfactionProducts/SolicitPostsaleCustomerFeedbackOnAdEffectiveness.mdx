...
Customer service processes manage customer inquiries, complaints, and support to ensure customer satisfaction. This process focuses on solicit post-sale customer feedback on ad effectiveness, which is essential for organizational effectiveness and achieving business objectives.
...
sequenceDiagram
    ...
    Agent->>Supervisor: Initiate solicit post-sale customer feedback on ad effectiveness request
