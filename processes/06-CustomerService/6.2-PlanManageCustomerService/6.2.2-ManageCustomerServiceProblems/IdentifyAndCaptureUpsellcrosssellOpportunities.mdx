...
This activity encompasses the end-to-end process of identify and capture upsell/cross-sell opportunities within the customer service and support domain. It involves coordinating cross-functional teams, applying standardized methodologies, and leveraging organizational data to ensure consistent and effective outcomes. The process is aligned with the broader Manage Customer Service framework (APQC 6.2.2.5) and supports strategic objectives by translating operational requirements into actionable procedures.
...
Customer service processes manage customer inquiries, complaints, and support to ensure customer satisfaction. This process focuses on identify and capture upsell/cross-sell opportunities, which is essential for organizational effectiveness and achieving business objectives.
...
sequenceDiagram
    ...
    Agent->>Supervisor: Initiate identify and capture upsell/cross-sell opportunities request
