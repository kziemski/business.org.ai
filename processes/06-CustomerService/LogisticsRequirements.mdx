...
- [Supply Chain](/departments/SupplyChain) - Primary process ownership
- [Customer Service](/departments/CustomerService) - Service requirement input
- [Logistics](/departments/Logistics) - Operational execution
- [Warehousing](/departments/Warehousing) - Inventory management
- [Transportation](/departments/Transportation) - Carrier management
- [Finance](/departments/Finance) - Investment decisions
...
- [Transportation Planners](/occupations/TransportationPlanners) - Mode selection
- [Inventory Managers](/occupations/InventoryManagers) - Stock positioning
- [Operations Research Analysts](/occupations/OperationsResearchAnalysts) - Optimization
