...
flowchart LR
    ...
    subgraph Process["Create IT service marketing plan"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Create I T Service Marketing Plan"]
...
- ITServiceMarketingPlan

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Create IT service marketing plan | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
