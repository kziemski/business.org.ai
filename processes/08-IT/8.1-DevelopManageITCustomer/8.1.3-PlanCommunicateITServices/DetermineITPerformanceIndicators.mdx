...
flowchart LR
    ...
    subgraph Process["Determine IT performance indicators"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Determine I T Performance Indicators"]
...
|----------|-------------|-------------|-----------|----------|
| Determine IT performance indicators | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
