...
flowchart LR
    ...
    subgraph Process["Understand IT landscape"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Understand I T Landscape"]
...
|----------|-------------|-------------|-----------|----------|
| Understand IT landscape | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
