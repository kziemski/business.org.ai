...
flowchart LR
    ...
    subgraph Process["Outline IT service expectations"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Outline I T Service Expectations"]
...
- ITServiceExpectations

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Outline IT service expectations | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the outline process end-to-end | < 5 business days |
