...
flowchart LR
    ...
    subgraph Process["Develop IT visioning"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Develop I T Visioning"]
...
|----------|-------------|-------------|-----------|----------|
| Develop IT visioning | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
