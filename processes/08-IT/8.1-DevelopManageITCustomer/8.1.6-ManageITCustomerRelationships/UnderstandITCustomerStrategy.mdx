...
flowchart LR
    ...
    subgraph Process["Understand IT customer strategy"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Understand I T Customer Strategy"]
...
|----------|-------------|-------------|-----------|----------|
| Understand IT customer strategy | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
