...
flowchart LR
    ...
    subgraph Process["Maintain IT services catalog"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Maintain I T Services Catalog"]
...
|----------|-------------|-------------|-----------|----------|
| Maintain IT services catalog | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
