...
flowchart LR
    ...
    subgraph Process["Forecast IT service demand"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Forecast I T Service Demand"]
...
|----------|-------------|-------------|-----------|----------|
| Forecast IT service demand | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the forecast process end-to-end | < 5 business days |
