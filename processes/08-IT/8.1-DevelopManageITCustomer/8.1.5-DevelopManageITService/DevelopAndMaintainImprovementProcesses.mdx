...
flowchart LR
    ...
    subgraph Process["Develop and maintain improvement processes"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Develop And Maintain Improvement Processes"]
...
|----------|-------------|-------------|-----------|----------|
| Develop and maintain improvement processes | IT Business Analyst | CIO | Business Unit Leads | IT Staff |
