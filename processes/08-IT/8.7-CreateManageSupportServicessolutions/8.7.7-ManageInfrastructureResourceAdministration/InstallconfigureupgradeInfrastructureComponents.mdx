...
sequenceDiagram
    ...
    participant System
    IT Manager->>InfraTeam: Define infrastructure needs
    InfraTeam->>NetworkAdmin: Coordinate network setup
    NetworkAdmin->>System: Configure network
    InfraTeam->>System: Provision resources
    System->>InfraTeam: Return status
    InfraTeam->>InfraTeam: Validate configuration
    InfraTeam->>IT Manager: Report readiness
    IT Manager->>InfraTeam: Approve for production
```
