...
flowchart LR
    ...
    subgraph Process["Perform infrastructure component maintenance"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Perform Infrastructure Component Maintenance"]
...
|----------|-------------|-------------|-----------|----------|
| Perform infrastructure component maintenance | IT Service Manager | IT Director | Infrastructure Team | End Users |
