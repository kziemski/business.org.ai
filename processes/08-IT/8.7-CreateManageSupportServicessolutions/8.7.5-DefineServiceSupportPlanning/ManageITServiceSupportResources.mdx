...
flowchart LR
    ...
    subgraph Process["Manage IT service support resources"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Manage I T Service Support Resources"]
...
- ITServiceSupportResources

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Manage IT service support resources | IT Service Manager | IT Director | Infrastructure Team | End Users |
