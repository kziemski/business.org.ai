...
flowchart LR
    ...
    subgraph Process["Run and monitor batch job schedule"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Run And Monitor Batch Job Schedule"]
...
|----------|-------------|-------------|-----------|----------|
| Run and monitor batch job schedule | IT Service Manager | IT Director | Infrastructure Team | End Users |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the run process end-to-end | < 5 business days |
