...
flowchart LR
    ...
    subgraph Process["Manage IT infrastructure/data recovery"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Manage I T Infrastructuredata Recovery"]
...
|----------|-------------|-------------|-----------|----------|
| Manage IT infrastructure/data recovery | IT Service Manager | IT Director | Infrastructure Team | End Users |
