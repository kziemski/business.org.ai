...
flowchart LR
    ...
    subgraph Process["Manage infrastructure performance and capacity"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Manage Infrastructure Performance And Capacity"]
...
|----------|-------------|-------------|-----------|----------|
| Manage infrastructure performance and capacity | IT Service Manager | IT Director | Infrastructure Team | End Users |
