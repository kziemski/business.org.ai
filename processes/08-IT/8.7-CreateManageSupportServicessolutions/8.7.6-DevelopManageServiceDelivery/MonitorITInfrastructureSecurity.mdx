...
flowchart LR
    ...
    subgraph Process["Monitor IT infrastructure security"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Monitor I T Infrastructure Security"]
...
|----------|-------------|-------------|-----------|----------|
| Monitor IT infrastructure security | IT Service Manager | IT Director | Infrastructure Team | End Users |
