...
flowchart LR
    ...
    subgraph Process["Define IT service delivery portfolio"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Define I T Service Delivery Portfolio"]
...
- ITServiceDeliveryPortfolio

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Define IT service delivery portfolio | IT Service Manager | IT Director | Infrastructure Team | End Users |
