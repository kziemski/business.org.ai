...
flowchart LR
    ...
    subgraph Process["Define IT service delivery sourcing strategy"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Define I T Service Delivery Sourcing Strategy"]
...
- ITServiceDeliverySourcingStrategy

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Define IT service delivery sourcing strategy | IT Service Manager | IT Director | Infrastructure Team | End Users |
