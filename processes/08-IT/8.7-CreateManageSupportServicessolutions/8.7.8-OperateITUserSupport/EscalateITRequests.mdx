...
flowchart LR
    ...
    subgraph Process["Escalate IT requests"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Escalate I T Requests"]
...
|----------|-------------|-------------|-----------|----------|
| Escalate IT requests | IT Service Manager | IT Director | Infrastructure Team | End Users |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the escalate process end-to-end | < 5 business days |
