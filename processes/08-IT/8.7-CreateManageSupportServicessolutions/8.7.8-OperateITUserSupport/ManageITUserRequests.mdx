...
flowchart LR
    ...
    subgraph Process["Manage IT user requests"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Manage I T User Requests"]
...
|----------|-------------|-------------|-----------|----------|
| Manage IT user requests | IT Service Manager | IT Director | Infrastructure Team | End Users |
