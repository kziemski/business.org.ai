...
flowchart LR
    ...
    subgraph Process["Resolve IT issues/requests"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Resolve I T Issuesrequests"]
...
|----------|-------------|-------------|-----------|----------|
| Resolve IT issues/requests | IT Service Manager | IT Director | Infrastructure Team | End Users |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the resolve process end-to-end | < 5 business days |
