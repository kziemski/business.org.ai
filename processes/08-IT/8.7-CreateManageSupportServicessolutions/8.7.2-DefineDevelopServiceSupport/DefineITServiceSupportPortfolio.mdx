...
flowchart LR
    ...
    subgraph Process["Define IT service support portfolio"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Define I T Service Support Portfolio"]
...
|----------|-------------|-------------|-----------|----------|
| Define IT service support portfolio | IT Service Manager | IT Director | Infrastructure Team | End Users |
