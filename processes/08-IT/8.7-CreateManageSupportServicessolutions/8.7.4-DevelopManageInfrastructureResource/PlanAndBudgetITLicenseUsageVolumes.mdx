...
flowchart LR
    ...
    subgraph Process["Plan and budget IT license usage volumes"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Plan And Budget I T License Usage Volumes"]
...
|----------|-------------|-------------|-----------|----------|
| Plan and budget IT license usage volumes | IT Service Manager | IT Director | Infrastructure Team | End Users |
