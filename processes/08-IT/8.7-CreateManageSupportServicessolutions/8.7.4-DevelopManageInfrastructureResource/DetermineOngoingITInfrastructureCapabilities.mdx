...
flowchart LR
    ...
    subgraph Process["Determine ongoing IT infrastructure capabilities"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Determine Ongoing I T Infrastructure Capabilities"]
...
|----------|-------------|-------------|-----------|----------|
| Determine ongoing IT infrastructure capabilities | IT Service Manager | IT Director | Infrastructure Team | End Users |
