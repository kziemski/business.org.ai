...
flowchart LR
    ...
    subgraph Process["Plan IT infrastructure change"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Plan I T Infrastructure Change"]
...
|----------|-------------|-------------|-----------|----------|
| Plan IT infrastructure change | IT Service Manager | IT Director | Infrastructure Team | End Users |
