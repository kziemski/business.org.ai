...
flowchart LR
    ...
    subgraph Process["Schedule service delivery resources"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Schedule Service Delivery Resources"]
...
|----------|-------------|-------------|-----------|----------|
| Schedule service delivery resources | IT Service Manager | IT Director | Infrastructure Team | End Users |
