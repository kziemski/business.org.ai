...
flowchart LR
    ...
    subgraph Process["Define IT solution lifecycle"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Define I T Solution Lifecycle"]
...
|----------|-------------|-------------|-----------|----------|
| Define IT solution lifecycle | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
