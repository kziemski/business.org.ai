...
flowchart LR
    ...
    subgraph Process["Create service/solution design"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Create Servicesolution Design"]
...
|----------|-------------|-------------|-----------|----------|
| Create service/solution design | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
