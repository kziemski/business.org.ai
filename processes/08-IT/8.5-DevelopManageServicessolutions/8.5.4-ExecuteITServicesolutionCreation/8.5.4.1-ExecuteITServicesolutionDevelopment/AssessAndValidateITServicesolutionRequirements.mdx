...
flowchart LR
    ...
    subgraph Process["Assess and validate IT service/solution requirements"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess And Validate I T Servicesolution Requirements"]
...
|----------|-------------|-------------|-----------|----------|
| Assess and validate IT service/solution requirements | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
