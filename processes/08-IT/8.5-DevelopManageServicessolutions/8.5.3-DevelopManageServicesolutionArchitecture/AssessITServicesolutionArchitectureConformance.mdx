...
flowchart LR
    ...
    subgraph Process["Assess IT service/solution architecture conformance"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess I T Servicesolution Architecture Conformance"]
...
- ITServiceArchitectureConformance
- ITSolutionArchitectureConformance

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Assess IT service/solution architecture conformance | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
