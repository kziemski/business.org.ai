...
flowchart LR
    ...
    subgraph Process["Assess business constraints on IT service/solution"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess Business Constraints.on. I T Servicesolution"]
...
|----------|-------------|-------------|-----------|----------|
| Assess business constraints on IT service/solution | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
