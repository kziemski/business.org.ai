...
flowchart LR
    ...
    subgraph Process["Identify opportunities for IT component reuse"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Identify Opportunities"]
...
|----------|-------------|-------------|-----------|----------|
| Identify opportunities for IT component reuse | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
