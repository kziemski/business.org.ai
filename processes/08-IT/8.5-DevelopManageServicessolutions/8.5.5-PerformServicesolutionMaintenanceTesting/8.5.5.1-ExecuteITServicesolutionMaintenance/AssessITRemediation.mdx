...
flowchart LR
    ...
    subgraph Process["Assess IT remediation"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess I T Remediation"]
...
|----------|-------------|-------------|-----------|----------|
| Assess IT remediation | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
