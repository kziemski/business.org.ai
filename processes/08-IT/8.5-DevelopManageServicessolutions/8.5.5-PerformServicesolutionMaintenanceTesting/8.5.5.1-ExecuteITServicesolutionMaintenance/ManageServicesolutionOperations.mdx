...
flowchart LR
    ...
    subgraph Process["Manage service/solution operations"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Manage Servicesolution Operations"]
...
|----------|-------------|-------------|-----------|----------|
| Manage service/solution operations | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
