...
flowchart LR
    ...
    subgraph Process["Maintain service component portfolio"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Maintain Service Component Portfolio"]
...
|----------|-------------|-------------|-----------|----------|
| Maintain service component portfolio | IT Financial Analyst | CIO / CFO | Procurement | Budget Owners |
