...
flowchart LR
    ...
    subgraph Process["Establish data, information, and analytic objectives"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Establish Data Information And Analytic Objectives"]
...
|----------|-------------|-------------|-----------|----------|
| Establish data, information, and analytic objectives | IT HR Manager | IT Director | Department Managers | IT Staff |
