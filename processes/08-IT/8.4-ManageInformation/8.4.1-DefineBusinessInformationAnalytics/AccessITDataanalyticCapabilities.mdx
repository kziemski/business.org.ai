...
flowchart LR
    ...
    subgraph Process["Access IT data/analytic capabilities"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Access I T Dataanalytic Capabilities"]
...
- ITDataCapabilities
- ITAnalyticCapabilities

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Access IT data/analytic capabilities | IT HR Manager | IT Director | Department Managers | IT Staff |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the access process end-to-end | < 5 business days |
