...
flowchart LR
    ...
    subgraph Process["Evaluate IT continuity"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Evaluate I T Continuity"]
...
|----------|-------------|-------------|-----------|----------|
| Evaluate IT continuity | IT Security Manager | CIO | Risk Analyst | All IT Staff |
