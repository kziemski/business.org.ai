...
flowchart LR
    ...
    subgraph Process["Determine and evaluate IT regulatory and audit requirements"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Determine And Evaluate I T Regulatory And Audit Requirements"]
...
|----------|-------------|-------------|-----------|----------|
| Determine and evaluate IT regulatory and audit requirements | IT Security Manager | CIO | Risk Analyst | All IT Staff |
