...
flowchart LR
    ...
    subgraph Process["Evaluate IT-related risks resiliency"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Evaluate I Trelated Risks Resiliency"]
...
|----------|-------------|-------------|-----------|----------|
| Evaluate IT-related risks resiliency | IT Security Manager | CIO | Risk Analyst | All IT Staff |
