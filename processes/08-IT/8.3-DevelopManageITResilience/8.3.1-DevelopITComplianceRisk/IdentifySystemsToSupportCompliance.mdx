...
flowchart LR
    ...
    subgraph Process["Identify systems to support compliance"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Identify Systems"]
...
|----------|-------------|-------------|-----------|----------|
| Identify systems to support compliance | IT Security Manager | CIO | Risk Analyst | All IT Staff |
