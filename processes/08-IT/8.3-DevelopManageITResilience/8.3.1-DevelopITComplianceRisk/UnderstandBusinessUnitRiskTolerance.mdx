...
flowchart LR
    ...
    subgraph Process["Understand business unit risk tolerance"]
        ...
        P2 --> P3["Understand Business Unit Risk Tolerance"]
...
- BusinessUnitRiskTolerance

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Understand business unit risk tolerance | IT Security Manager | CIO | Risk Analyst | All IT Staff |
