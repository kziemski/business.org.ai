...
flowchart LR
    ...
    subgraph Process["Establish IT risk tolerance"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Establish I T Risk Tolerance"]
...
|----------|-------------|-------------|-----------|----------|
| Establish IT risk tolerance | IT Security Manager | CIO | Risk Analyst | All IT Staff |
