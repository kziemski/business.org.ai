...
flowchart LR
    ...
    subgraph Process["Identify, supervise and monitor IT risk mitigation measures"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Identify, Identify, supervise and monitor  I T risk mitigation measures"]
...
|----------|-------------|-------------|-----------|----------|
| Identify, supervise and monitor IT risk mitigation measures | IT Security Manager | CIO | Risk Analyst | All IT Staff |
