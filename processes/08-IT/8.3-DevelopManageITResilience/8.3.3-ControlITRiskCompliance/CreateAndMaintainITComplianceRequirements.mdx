...
flowchart LR
    ...
    subgraph Process["Create and maintain IT compliance requirements"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Create And Maintain I T Compliance Requirements"]
...
|----------|-------------|-------------|-----------|----------|
| Create and maintain IT compliance requirements | IT Security Manager | CIO | Risk Analyst | All IT Staff |
