...
flowchart LR
    ...
    subgraph Process["Create and maintain IT security policies, standards, and procedures"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Create And Maintain I T Security Policies Standards And Procedures"]
...
|----------|-------------|-------------|-----------|----------|
| Create and maintain IT security policies, standards, and procedures | IT Security Manager | CIO | Risk Analyst | All IT Staff |
