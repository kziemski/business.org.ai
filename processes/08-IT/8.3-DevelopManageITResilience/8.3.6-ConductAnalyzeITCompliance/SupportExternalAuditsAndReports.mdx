...
flowchart LR
    ...
    subgraph Process["Support external audits and reports"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Support External Audits And Reports"]
...
|----------|-------------|-------------|-----------|----------|
| Support external audits and reports | IT Security Manager | CIO | Risk Analyst | All IT Staff |
