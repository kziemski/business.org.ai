...
flowchart LR
    ...
    subgraph Process["Manage IT user authentication mechanisms"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Manage I T User Authentication Mechanisms"]
...
|----------|-------------|-------------|-----------|----------|
| Manage IT user authentication mechanisms | IT Security Manager | CIO | Risk Analyst | All IT Staff |
