...
flowchart LR
    ...
    subgraph Process["Establish mitigation approaches for IT risks"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Establish Mitigation Approaches"]
...
|----------|-------------|-------------|-----------|----------|
| Establish mitigation approaches for IT risks | IT Security Manager | CIO | Risk Analyst | All IT Staff |
