...
flowchart LR
    ...
    subgraph Process["Determine critical IT risks"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Determine Critical I T Risks"]
...
|----------|-------------|-------------|-----------|----------|
| Determine critical IT risks | IT Security Manager | CIO | Risk Analyst | All IT Staff |
