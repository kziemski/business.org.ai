...
flowchart LR
    ...
    subgraph Process["Prioritize IT risks"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Prioritize I T Risks"]
...
|----------|-------------|-------------|-----------|----------|
| Prioritize IT risks | IT Security Manager | CIO | Risk Analyst | All IT Staff |
