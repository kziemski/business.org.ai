...
flowchart LR
    ...
    subgraph Process["Review and monitor application security controls"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Review And Monitor Application Security Controls"]
...
|----------|-------------|-------------|-----------|----------|
| Review and monitor application security controls | IT Security Manager | CIO | Risk Analyst | All IT Staff |
