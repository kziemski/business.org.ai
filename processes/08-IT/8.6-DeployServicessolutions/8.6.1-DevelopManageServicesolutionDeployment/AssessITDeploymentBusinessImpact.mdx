...
flowchart LR
    ...
    subgraph Process["Assess IT deployment business impact"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess I T Deployment Business Impact"]
...
- ITDeploymentBusinessImpact

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Assess IT deployment business impact | Solutions Architect | IT Director | Business Analyst | End Users |
