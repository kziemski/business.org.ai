...
flowchart LR
    ...
    subgraph Process["Analyze deployments outcomes"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Analyze Deployments Outcomes"]
...
|----------|-------------|-------------|-----------|----------|
| Analyze deployments outcomes | Solutions Architect | IT Director | Business Analyst | End Users |
