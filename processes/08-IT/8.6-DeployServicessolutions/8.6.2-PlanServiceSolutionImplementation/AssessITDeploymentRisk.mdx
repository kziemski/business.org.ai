...
flowchart LR
    ...
    subgraph Process["Assess IT deployment risk"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess I T Deployment Risk"]
...
|----------|-------------|-------------|-----------|----------|
| Assess IT deployment risk | Solutions Architect | IT Director | Business Analyst | End Users |
