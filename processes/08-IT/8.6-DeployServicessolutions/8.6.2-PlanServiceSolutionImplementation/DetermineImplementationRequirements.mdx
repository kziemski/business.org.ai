...
flowchart LR
    ...
    subgraph Process["Determine implementation requirements"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Determine Implementation Requirements"]
...
|----------|-------------|-------------|-----------|----------|
| Determine implementation requirements | Solutions Architect | IT Director | Business Analyst | End Users |
