...
flowchart LR
    ...
    subgraph Process["Define implementation schedule and roll-out sequence"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Define Implementation Schedule And Rollout Sequence"]
...
|----------|-------------|-------------|-----------|----------|
| Define implementation schedule and roll-out sequence | Solutions Architect | IT Director | Business Analyst | End Users |
