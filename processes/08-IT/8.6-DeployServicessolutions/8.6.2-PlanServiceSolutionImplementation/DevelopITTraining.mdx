...
flowchart LR
    ...
    subgraph Process["Develop IT training"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Develop I T Training"]
...
|----------|-------------|-------------|-----------|----------|
| Develop IT training | Solutions Architect | IT Director | Business Analyst | End Users |
