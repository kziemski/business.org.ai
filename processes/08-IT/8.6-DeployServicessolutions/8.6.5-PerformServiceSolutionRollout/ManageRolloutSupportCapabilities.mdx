...
flowchart LR
    ...
    subgraph Process["Manage rollout support capabilities"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Manage Rollout Support Capabilities"]
...
- RolloutSupportCapabilities

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Manage rollout support capabilities | Solutions Architect | IT Director | Business Analyst | End Users |
