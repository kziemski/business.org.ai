...
flowchart LR
    ...
    subgraph Process["Execute rollout plans"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Execute Rollout Plans"]
...
|----------|-------------|-------------|-----------|----------|
| Execute rollout plans | Solutions Architect | IT Director | Business Analyst | End Users |
