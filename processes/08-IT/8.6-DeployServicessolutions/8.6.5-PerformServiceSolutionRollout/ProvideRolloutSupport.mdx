...
flowchart LR
    ...
    subgraph Process["Provide rollout support"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Provide Rollout Support"]
...
|----------|-------------|-------------|-----------|----------|
| Provide rollout support | Solutions Architect | IT Director | Business Analyst | End Users |
