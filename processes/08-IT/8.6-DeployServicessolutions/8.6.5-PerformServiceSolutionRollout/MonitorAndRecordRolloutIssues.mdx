...
flowchart LR
    ...
    subgraph Process["Monitor and record rollout issues"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Monitor And Record Rollout Issues"]
...
|----------|-------------|-------------|-----------|----------|
| Monitor and record rollout issues | Solutions Architect | IT Director | Business Analyst | End Users |
