...
flowchart LR
    ...
    subgraph Process["Support organizational changes"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Support Organizational Changes"]
...
|----------|-------------|-------------|-----------|----------|
| Support organizational changes | Solutions Architect | IT Director | Business Analyst | End Users |
