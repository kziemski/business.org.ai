...
flowchart LR
    ...
    subgraph Process["Asses IT change/release impact"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Asses I T Changerelease Impact"]
...
|----------|-------------|-------------|-----------|----------|
| Asses IT change/release impact | Solutions Architect | IT Director | Business Analyst | End Users |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the asses process end-to-end | < 5 business days |
