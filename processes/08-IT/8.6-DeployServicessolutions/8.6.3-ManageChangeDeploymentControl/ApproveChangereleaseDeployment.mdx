...
flowchart LR
    ...
    subgraph Process["Approve change/release deployment"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Approve Changerelease Deployment"]
...
|----------|-------------|-------------|-----------|----------|
| Approve change/release deployment | Solutions Architect | IT Director | Business Analyst | End Users |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the approve process end-to-end | < 5 business days |
