...
flowchart LR
    ...
    subgraph Process["Assess IT change/release risk"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess I T Changerelease Risk"]
...
|----------|-------------|-------------|-----------|----------|
| Assess IT change/release risk | Solutions Architect | IT Director | Business Analyst | End Users |
