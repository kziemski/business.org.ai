...
flowchart LR
    ...
    subgraph Process["Perform post-installation testing"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Perform Postinstallation Testing"]
...
|----------|-------------|-------------|-----------|----------|
| Perform post-installation testing | Solutions Architect | IT Director | Business Analyst | End Users |
