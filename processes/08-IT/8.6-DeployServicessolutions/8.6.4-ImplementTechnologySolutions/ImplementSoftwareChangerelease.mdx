...
flowchart LR
    ...
    subgraph Process["Implement software change/release"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Implement Software Changerelease"]
...
|----------|-------------|-------------|-----------|----------|
| Implement software change/release | Solutions Architect | IT Director | Business Analyst | End Users |
