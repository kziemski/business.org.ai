...
flowchart LR
    ...
    subgraph Process["Distribute software components network-wide"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Distribute Software Components Networkwide"]
...
|----------|-------------|-------------|-----------|----------|
| Distribute software components network-wide | Solutions Architect | IT Director | Business Analyst | End Users |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the distribute process end-to-end | < 5 business days |
