...
flowchart LR
    ...
    subgraph Process["Assess performance against IT service and project value criteria"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Assess Performance.against. I T Service And Project Value Criteria"]
...
|----------|-------------|-------------|-----------|----------|
| Assess performance against IT service and project value criteria | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
