...
flowchart LR
    ...
    subgraph Process["Evaluate IT research project outcomes"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Evaluate I T Research Project Outcomes"]
...
|----------|-------------|-------------|-----------|----------|
| Evaluate IT research project outcomes | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
