...
flowchart LR
    ...
    subgraph Process["Identify and promote viable concepts"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Identify And Promote Viable Concepts"]
...
|----------|-------------|-------------|-----------|----------|
| Identify and promote viable concepts | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
