...
flowchart LR
    ...
    subgraph Process["Monitor and analyze IT financial performance"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Monitor And Analyze I T Financial Performance"]
...
|----------|-------------|-------------|-----------|----------|
| Monitor and analyze IT financial performance | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
