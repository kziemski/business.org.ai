...
flowchart LR
    ...
    subgraph Process["Optimize IT resource allocation"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Optimize I T Resource Allocation"]
...
- ITResourceAllocation

## RACI Matrix

| Activity | Responsible | Accountable | Consulted | Informed |
|----------|-------------|-------------|-----------|----------|
| Optimize IT resource allocation | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the optimize process end-to-end | < 5 business days |
