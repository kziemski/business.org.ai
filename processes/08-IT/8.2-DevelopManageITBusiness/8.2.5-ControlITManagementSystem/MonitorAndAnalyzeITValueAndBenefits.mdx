...
flowchart LR
    ...
    subgraph Process["Monitor and analyze IT value and benefits"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Monitor And Analyze I T Value And Benefits"]
...
|----------|-------------|-------------|-----------|----------|
| Monitor and analyze IT value and benefits | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
