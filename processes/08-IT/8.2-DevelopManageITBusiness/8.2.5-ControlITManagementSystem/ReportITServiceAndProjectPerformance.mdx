...
flowchart LR
    ...
    subgraph Process["Report IT service and project performance"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Report I T Service And Project Performance"]
...
|----------|-------------|-------------|-----------|----------|
| Report IT service and project performance | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
...
|--------|-------------|--------|
| Process Cycle Time | Average time to complete the report process end-to-end | < 5 business days |
