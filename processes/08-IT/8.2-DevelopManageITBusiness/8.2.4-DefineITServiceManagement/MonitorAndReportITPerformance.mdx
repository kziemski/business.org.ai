...
flowchart LR
    ...
    subgraph Process["Monitor and report IT performance"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Monitor And Report I T Performance"]
...
|----------|-------------|-------------|-----------|----------|
| Monitor and report IT performance | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
