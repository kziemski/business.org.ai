...
flowchart LR
    ...
    subgraph Process["Align IT portfolio to business objectives"]
        P1["Gather Requirements"] --> P2["Analyze Current State"]
        P2 --> P3["Align I T Portfolio"]
...
|----------|-------------|-------------|-----------|----------|
| Align IT portfolio to business objectives | IT Strategic Planner | CIO | Enterprise Architect | Department Heads |
