...
This activity encompasses the end-to-end process of establish quality targets within the supply chain and physical product delivery domain. It involves coordinating cross-functional teams, applying standardized methodologies, and leveraging organizational data to ensure consistent and effective outcomes. The process is aligned with the broader Deliver Physical Products framework (APQC 4.1.8.1) and supports strategic objectives by translating operational requirements into actionable procedures.
...
flowchart LR
    ...
    subgraph Process["Establish quality targets"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Establish quality targets"]
        P4["Validate & Review"]
...
sequenceDiagram
    ...
    Warehouse->>Logistics: Initiate establish quality targets request
...
| Establish quality targets | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete establish quality targets process | Hours/Days |
| Completion Rate | Percentage of quality targets activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of quality targets outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of quality targets processed | $/Unit |
