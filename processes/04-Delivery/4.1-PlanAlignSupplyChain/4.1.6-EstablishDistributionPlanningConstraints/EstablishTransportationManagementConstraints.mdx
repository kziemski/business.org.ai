...
flowchart LR
    ...
    subgraph Process["Establish transportation management constraints"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Establish transportation management constraints"]
        P4["Validate & Review"]
...
sequenceDiagram
    ...
    Warehouse->>Logistics: Initiate establish transportation management constraints request
...
| Establish transportation management constraints | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete establish transportation management constraints process | Hours/Days |
| Completion Rate | Percentage of transportation management constraints activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of transportation management constraints outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of transportation management constraints processed | $/Unit |
