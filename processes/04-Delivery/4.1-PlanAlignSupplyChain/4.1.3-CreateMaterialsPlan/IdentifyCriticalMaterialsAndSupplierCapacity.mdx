...
This activity encompasses the end-to-end process of identify critical materials and supplier capacity within the supply chain and physical product delivery domain. It involves coordinating cross-functional teams, applying standardized methodologies, and leveraging organizational data to ensure consistent and effective outcomes. The process is aligned with the broader Deliver Physical Products framework (APQC 4.1.3.3) and supports strategic objectives by translating operational requirements into actionable procedures.
...
flowchart LR
    ...
    subgraph Process["Identify critical materials and supplier capacity"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Identify critical materials and supplier capacity"]
        P4["Validate & Review"]
...
sequenceDiagram
    ...
    Warehouse->>Logistics: Initiate identify critical materials and supplier capacity request
...
| Identify critical materials and supplier capacity | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete identify critical materials and supplier capacity process | Hours/Days |
| Completion Rate | Percentage of critical materials and supplier capacity activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of critical materials and supplier capacity outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of critical materials and supplier capacity processed | $/Unit |
| On-Time Delivery | Percentage of deliverables completed within target timeline | % |

## Related Concepts

- CriticalMaterialsCapacity
- SupplierCapacity
