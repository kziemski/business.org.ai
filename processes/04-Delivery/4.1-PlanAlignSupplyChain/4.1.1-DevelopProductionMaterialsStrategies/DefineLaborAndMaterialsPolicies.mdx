...
flowchart LR
    ...
    subgraph Process["Define labor and materials policies"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Define labor and materials policies"]
        P4["Validate & Review"]
...
sequenceDiagram
    ...
    Warehouse->>Logistics: Initiate define labor and materials policies request
...
| Define labor and materials policies | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete define labor and materials policies process | Hours/Days |
| Completion Rate | Percentage of labor and materials policies activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of labor and materials policies outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of labor and materials policies processed | $/Unit |
