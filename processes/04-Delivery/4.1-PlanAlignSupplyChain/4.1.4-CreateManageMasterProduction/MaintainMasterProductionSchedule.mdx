...
flowchart LR
    ...
    subgraph Process["Maintain master production schedule"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Maintain master production schedule"]
        P4["Validate & Review"]
...
sequenceDiagram
    ...
    Warehouse->>Logistics: Initiate maintain master production schedule request
...
| Maintain master production schedule | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete maintain master production schedule process | Hours/Days |
| Completion Rate | Percentage of master production schedule activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of master production schedule outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of master production schedule processed | $/Unit |
