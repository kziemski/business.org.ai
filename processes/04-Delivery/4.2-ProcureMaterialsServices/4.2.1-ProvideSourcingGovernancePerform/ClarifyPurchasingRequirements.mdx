...
flowchart LR
    ...
    subgraph Process["Clarify purchasing requirements"]
        P1["Gather Requirements"]
        P2["Analyze Current State"]
        P3["Clarify purchasing requirements"]
        P4["Validate & Review"]
...
sequenceDiagram
    ...
    Warehouse->>Logistics: Initiate clarify purchasing requirements request
...
| Clarify purchasing requirements | R | A | C | I |
...
|-----|-------------|------|
| Cycle Time | Average time to complete clarify purchasing requirements process | Hours/Days |
| Completion Rate | Percentage of purchasing requirements activities completed on schedule | % |
| Quality Score | Accuracy and quality rating of purchasing requirements outputs | 1-10 Scale |
| Cost Efficiency | Cost per unit of purchasing requirements processed | $/Unit |
