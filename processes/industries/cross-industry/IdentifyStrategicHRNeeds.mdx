...
- [Industrial-Organizational Psychologists](/occupations/SocialScience/IndustrialOrganizationalPsychologists)
...
- [Workforce Planning](/departments/WorkforcePlanning)
...
Strategic HR needs identification is foundational for aligning human capital with business strategy. Every organization must anticipate future workforce requirements to remain competitive.

### Cross-Industry Best Practices

| Practice | Description |
|----------|-------------|
| Business Strategy Alignment | Link HR needs directly to strategic business objectives |
| Workforce Analytics | Use data to identify gaps between current and future state |
| Skills Forecasting | Project future capability requirements based on market trends |
| Scenario Planning | Develop HR strategies for multiple business scenarios |
| Leadership Involvement | Engage business leaders in validating HR priorities |

### Common Metrics

- Strategic HR initiative completion rate
- Workforce readiness index
- Critical role vacancy rate
- Skills gap closure rate
- HR strategy alignment score
