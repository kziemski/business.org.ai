---
id: petroleum-upstream_OilExplorationCompanies_CommunicateStrategicInitiativesToBusinessUnitsAndStakeholders
...
```
OilExplorationCompanies.communicate.StrategicInitiatives.to.BusinessUnitsAndStakeholders
```
