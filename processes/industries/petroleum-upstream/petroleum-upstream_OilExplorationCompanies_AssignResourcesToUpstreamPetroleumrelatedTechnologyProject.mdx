---
id: petroleum-upstream_OilExplorationCompanies_AssignResourcesToUpstreamPetroleumrelatedTechnologyProject
...
```
OilExplorationCompanies.assign.Resources.to.UpstreamPetroleumRelatedTechnologyProject
```
