---
id: petroleum-upstream_PetroleumUpstreamCompanies_DevelopRoleActivityDiagramsToAssessHandoffActivity
...
```
PetroleumUpstreamCompanies.develop.RoleActivityDiagrams.to.AssessHandOffActivity
```
