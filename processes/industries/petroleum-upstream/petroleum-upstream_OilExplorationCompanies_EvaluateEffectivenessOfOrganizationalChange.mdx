---
id: petroleum-upstream_OilExplorationCompanies_EvaluateEffectivenessOfOrganizationalChange
...
```
OilExplorationCompanies.evaluate.Effectiveness.of.OrganizationalChange
```
