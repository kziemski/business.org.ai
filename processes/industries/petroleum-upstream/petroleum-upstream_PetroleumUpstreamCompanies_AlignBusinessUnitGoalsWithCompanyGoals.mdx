---
id: petroleum-upstream_PetroleumUpstreamCompanies_AlignBusinessUnitGoalsWithCompanyGoals
...
```
PetroleumUpstreamCompanies.align.BusinessUnitGoals.with.CompanyGoals
```
