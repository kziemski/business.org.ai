---
id: petroleum-upstream_PetroleumUpstreamCompanies_DevelopShorttermquarterTo1YearBusinessStrategy
...
```
PetroleumUpstreamCompanies.develop.ShortTerm(Quarter.to.Year
```
