---
id: petroleum-upstream_OilExplorationCompanies_DevelopRoleAnalysisAndActivityDiagramsForKeyProcesses
...
```
OilExplorationCompanies.develop.RoleAnalysisAndActivityDiagrams.for.KeyProcesses
```
