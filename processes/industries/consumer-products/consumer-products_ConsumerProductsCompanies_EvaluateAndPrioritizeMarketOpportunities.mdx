---
id: consumer-products_ConsumerProductsCompanies_EvaluateAndPrioritizeMarketOpportunities
...
```
ConsumerProductsCompanies.evaluate.AndPrioritizeMarketOpportunities
```
