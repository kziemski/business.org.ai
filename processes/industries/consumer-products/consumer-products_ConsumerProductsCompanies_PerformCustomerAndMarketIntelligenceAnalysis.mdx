---
id: consumer-products_ConsumerProductsCompanies_PerformCustomerAndMarketIntelligenceAnalysis
...
```
ConsumerProductsCompanies.perform.CustomerAndMarketIntelligenceAnalysis
```
