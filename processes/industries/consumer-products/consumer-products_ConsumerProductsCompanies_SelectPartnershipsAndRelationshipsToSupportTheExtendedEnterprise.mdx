---
id: consumer-products_ConsumerProductsCompanies_SelectPartnershipsAndRelationshipsToSupportTheExtendedEnterprise
...
```
ConsumerProductsCompanies.select.PartnershipsAndRelationships.to.SupportExtendedEnterprise
```
