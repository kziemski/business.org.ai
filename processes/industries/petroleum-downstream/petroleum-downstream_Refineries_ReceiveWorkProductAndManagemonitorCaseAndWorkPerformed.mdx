---
id: petroleum-downstream_Refineries_ReceiveWorkProductAndManagemonitorCaseAndWorkPerformed
...
```
Refineries.receive.WorkProductAndManage/MonitorCaseAndWorkPerformed
```
