---
id: petroleum-downstream_PetroleumDownstreamCompanies_DevelopAndMaintainServicesolutionArchitectures
...
```
PetroleumDownstreamCompanies.develop.AndMaintainService/solutionArchitectures
```
