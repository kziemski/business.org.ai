---
id: petroleum-downstream_Refineries_ConfirmAlignmentOfProductserviceConceptsWithBusinessStrategy
...
```
Refineries.confirm.Alignment.of.Product/ServiceConceptsWithBusinessStrategy
```
