---
id: petroleum-downstream_PetroleumDownstreamCompanies_DesignTheRelationshipsBetweenOrganizationalUnits
...
```
PetroleumDownstreamCompanies.design.Relationships.between.OrganizationalUnits
```
