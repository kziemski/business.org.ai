---
id: petroleum-downstream_PetroleumDownstreamCompanies_FinalizeProductserviceCharacteristicsAndBusinessCases
...
```
PetroleumDownstreamCompanies.finalize.Product/ServiceCharacteristicsAndBusinessCases
```
