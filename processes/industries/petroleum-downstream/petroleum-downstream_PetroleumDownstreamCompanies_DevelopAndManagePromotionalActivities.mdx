---
id: petroleum-downstream_PetroleumDownstreamCompanies_DevelopAndManagePromotionalActivities
...
```
PetroleumDownstreamCompanies.develop.AndManagePromotionalActivities
```
