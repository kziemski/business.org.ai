---
id: petroleum-downstream_Refineries_CollaborateOnDesignWithSuppliersAndExternalPartners
...
```
Refineries.collaborate.on.DesignWithSuppliersAndExternalPartners
```
