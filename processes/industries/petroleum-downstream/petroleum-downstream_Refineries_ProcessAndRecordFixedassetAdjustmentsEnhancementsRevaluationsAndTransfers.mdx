---
id: petroleum-downstream_Refineries_ProcessAndRecordFixedassetAdjustmentsEnhancementsRevaluationsAndTransfers
...
```
Refineries.process.AndRecordFixedAssetAdjustments,Enhancements,Revaluations,AndTransfers
```
