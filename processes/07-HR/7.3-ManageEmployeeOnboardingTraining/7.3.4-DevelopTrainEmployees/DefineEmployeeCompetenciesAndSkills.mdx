...
This process establishes clear definitions and frameworks for employee competencies and skills. It involves stakeholder consultation, industry benchmarking, documentation of standards and criteria, and alignment with organizational strategy to ensure consistency and clarity across all business units.
...
flowchart LR
    ...
    subgraph Process["Define employee competencies and skills"]
        S1["Initiate & Plan"]
