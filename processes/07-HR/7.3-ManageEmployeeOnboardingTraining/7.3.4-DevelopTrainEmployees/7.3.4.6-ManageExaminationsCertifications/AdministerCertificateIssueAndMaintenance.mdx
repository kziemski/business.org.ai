...
This process handles the administration of certificate issue and maintenance across the organization. It includes processing transactions, maintaining records, ensuring policy compliance, managing exceptions, and providing support to stakeholders throughout the administrative lifecycle.
...
flowchart LR
    ...
    subgraph Process["Administer certificate issue and maintenance"]
        S1["Initiate & Plan"]
