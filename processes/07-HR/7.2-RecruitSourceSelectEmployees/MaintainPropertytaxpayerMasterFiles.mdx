...
This process ensures ongoing maintenance and currency of propertytaxpayer master files. It includes regular reviews, updates based on changing requirements, quality assurance checks, version control, and stakeholder communication regarding any changes.
...
flowchart LR
    ...
    subgraph Process["Maintain property/taxpayer master files"]
        S1["Initiate & Plan"]
