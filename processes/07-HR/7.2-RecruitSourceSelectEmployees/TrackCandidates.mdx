...
This process provides systematic tracking of candidates throughout their lifecycle. It includes data capture, status monitoring, progress reporting, exception management, and historical record maintenance for audit and analysis purposes.
...
flowchart LR
    ...
    subgraph Process["Track candidates"]
        S1["Initiate & Plan"]
