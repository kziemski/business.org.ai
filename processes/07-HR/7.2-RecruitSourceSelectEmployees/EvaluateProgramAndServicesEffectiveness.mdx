...
This process conducts thorough evaluation of program and services effectiveness using quantitative and qualitative methods. It involves establishing evaluation criteria, collecting performance data, conducting analysis, benchmarking against standards, and producing actionable recommendations.
...
flowchart LR
    ...
    subgraph Process["Evaluate program and services effectiveness"]
        S1["Initiate & Plan"]
