...
This process creates and establishes robust frameworks for collection policies. It involves defining standards, setting benchmarks, documenting procedures, obtaining stakeholder buy-in, and implementing governance structures to ensure long-term sustainability and effectiveness.
...
flowchart LR
    ...
    subgraph Process["Establish collection policies"]
        S1["Initiate & Plan"]
