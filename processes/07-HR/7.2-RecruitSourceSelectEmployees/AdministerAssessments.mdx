...
This process handles the administration of assessments across the organization. It includes processing transactions, maintaining records, ensuring policy compliance, managing exceptions, and providing support to stakeholders throughout the administrative lifecycle.
...
flowchart LR
    ...
    subgraph Process["Administer assessments"]
        S1["Initiate & Plan"]
