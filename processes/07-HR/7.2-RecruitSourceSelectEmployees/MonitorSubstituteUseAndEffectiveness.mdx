...
This process implements ongoing monitoring and tracking of substitute use and effectiveness. It involves defining key indicators, establishing reporting cadences, analyzing trends, identifying anomalies, and triggering corrective actions when performance deviates from established targets.
...
flowchart LR
    ...
    subgraph Process["Monitor substitute use and effectiveness"]
        S1["Initiate & Plan"]
