...
This process manages the systematic gathering of workforce data. It involves identifying data sources, designing collection methods, executing data gathering activities, validating collected data, and organizing results for analysis.
...
flowchart LR
    ...
    subgraph Process["Gather workforce data"]
        S1["Initiate & Plan"]
