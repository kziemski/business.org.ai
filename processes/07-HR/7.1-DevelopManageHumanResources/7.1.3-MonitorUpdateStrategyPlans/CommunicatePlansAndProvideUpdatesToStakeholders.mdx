...
flowchart LR
    ...
    subgraph Process["Communicate plans and provide updates to stakeholders"]
        S1["Initiate & Plan"]
...
sequenceDiagram
    ...
    HRM->>HRS: Initiate communicate plans and provide updates to stakeholders process
