...
flowchart LR
    ...
    subgraph Process["Measure contribution to business strategy"]
        S1["Initiate & Plan"]
...
sequenceDiagram
    ...
    HRM->>HRS: Initiate measure contribution to business strategy process
