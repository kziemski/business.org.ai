...
This process executes the core activities related to operational workforce planning. It encompasses planning, resource allocation, task execution, quality assurance, and results documentation to deliver consistent and measurable outcomes aligned with organizational standards.
...
flowchart LR
    ...
    subgraph Process["Perform operational workforce planning"]
        S1["Initiate & Plan"]
...
sequenceDiagram
    ...
    HRM->>HRS: Initiate perform operational workforce planning process
