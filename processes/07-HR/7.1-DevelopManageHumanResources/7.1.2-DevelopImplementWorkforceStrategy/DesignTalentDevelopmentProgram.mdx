...
This process covers the strategic design of talent development program. It involves requirements gathering, best practice research, stakeholder consultation, prototype development, pilot testing, and iterative refinement to create solutions that meet organizational needs effectively.
...
flowchart LR
    ...
    subgraph Process["Design talent development program"]
        S1["Initiate & Plan"]
...
sequenceDiagram
    ...
    HRM->>HRS: Initiate design talent development program process
