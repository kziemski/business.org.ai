...
This process executes the core activities related to workforce planning. It encompasses planning, resource allocation, task execution, quality assurance, and results documentation to deliver consistent and measurable outcomes aligned with organizational standards.
...
flowchart LR
    ...
    subgraph Process["Perform workforce planning"]
        S1["Initiate & Plan"]
...
sequenceDiagram
    ...
    HRM->>HRS: Initiate perform workforce planning process
