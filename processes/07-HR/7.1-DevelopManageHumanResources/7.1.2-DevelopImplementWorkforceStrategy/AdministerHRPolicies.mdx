...
This process handles the administration of h r policies across the organization. It includes processing transactions, maintaining records, ensuring policy compliance, managing exceptions, and providing support to stakeholders throughout the administrative lifecycle.
...
flowchart LR
    ...
    subgraph Process["Administer HR policies"]
        S1["Initiate & Plan"]
...
sequenceDiagram
    ...
    HRM->>HRS: Initiate administer hr policies process
