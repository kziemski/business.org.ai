...
flowchart LR
    ...
    subgraph Process["Manage employer branding"]
        S1["Initiate & Plan"]
...
sequenceDiagram
    ...
    HRM->>HRS: Initiate manage employer branding process
