...
This process provides systematic review and evaluation of compensation plan. It includes performance assessment against established criteria, gap analysis, stakeholder feedback collection, and generation of recommendations for improvement and optimization.
...
flowchart LR
    ...
    subgraph Process["Review compensation plan"]
        S1["Initiate & Plan"]
