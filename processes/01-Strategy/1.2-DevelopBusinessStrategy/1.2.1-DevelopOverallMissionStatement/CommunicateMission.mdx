...
sequenceDiagram
    ...
    SD->>+CEO: Draft mission statement elements
    CEO->>+MA: Review mission scope
    MA->>+CEO: Provide leadership input
    CEO->>+SD: Refine mission language
    SD-->>-CEO: Finalize mission statement
```
