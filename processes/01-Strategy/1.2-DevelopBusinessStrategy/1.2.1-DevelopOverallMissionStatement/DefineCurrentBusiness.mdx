...
sequenceDiagram
    ...
    SD->>+CEO: Document current business model
    CEO->>+SD: Identify core value propositions
    SD->>+CEO: Define target markets
    CEO->>+MA: Present business definition
    MA-->>-CEO: Approve business scope
```
