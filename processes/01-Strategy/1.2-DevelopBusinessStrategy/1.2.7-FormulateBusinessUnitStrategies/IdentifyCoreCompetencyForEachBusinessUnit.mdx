...
sequenceDiagram
    ...
    SD->>+CEO: Assess unit capabilities
    CEO->>+SD: Identify distinctive strengths
    SD->>+CEO: Document core competencies
    CEO->>+MA: Present competency mapping
    MA-->>-CEO: Validate competency priorities
```
