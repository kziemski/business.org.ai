...
sequenceDiagram
    ...
    SD->>+CEO: Evaluate design alternatives
    CEO->>+SD: Assess organizational impacts
    SD->>+CEO: Analyze implementation risks
    CEO->>+MA: Present feasibility assessment
    MA-->>-CEO: Select design approach
```
