...
sequenceDiagram
    ...
    SD->>+CEO: Prepare workshop materials
    CEO->>+MA: Facilitate design sessions
    MA->>+SD: Capture workshop outputs
    SD->>+CEO: Synthesize design decisions
    CEO-->>-MA: Present workshop results
```
