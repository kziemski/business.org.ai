...
sequenceDiagram
    ...
    SD->>+CEO: Map unit relationships
    CEO->>+SD: Define coordination mechanisms
    SD->>+CEO: Design governance model
    CEO->>+MA: Present relationship design
    MA-->>-CEO: Approve organizational links
```
