...
sequenceDiagram
    ...
    SD->>+CEO: Define key metrics
    CEO->>+SD: Establish measurement methods
    SD->>+CEO: Collect baseline data
    CEO->>+MA: Present baseline metrics
    MA-->>-CEO: Approve performance targets
```
