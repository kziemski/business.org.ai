...
sequenceDiagram
    ...
    SD->>+CEO: Draft organizational objectives
    CEO->>+SD: Align with strategic vision
    SD->>+CEO: Validate objective feasibility
    CEO->>+MA: Present objectives to leadership
    MA-->>-CEO: Approve organizational objectives
```
