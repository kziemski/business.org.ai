...
sequenceDiagram
    ...
    SD->>+CEO: Assess improvement opportunities
    CEO->>+SD: Evaluate lean methodologies
    SD->>+CEO: Design improvement programs
    CEO->>+MA: Present improvement options
    MA-->>-CEO: Approve improvement initiatives
```
...
- LeanImprovementOptions
- ContinuousImprovementOptions
