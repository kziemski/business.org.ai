...
sequenceDiagram
    ...
    SD->>+CEO: Analyze shared services potential
    CEO->>+SD: Evaluate consolidation benefits
    SD->>+CEO: Assess transition requirements
    CEO->>+MA: Present shared services options
    MA-->>-CEO: Approve shared services model
```
