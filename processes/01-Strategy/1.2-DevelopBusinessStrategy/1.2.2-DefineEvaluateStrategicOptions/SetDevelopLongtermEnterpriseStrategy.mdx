...
sequenceDiagram
    ...
    SD->>+CEO: Develop long-term scenarios
    CEO->>+SD: Evaluate strategic trajectories
    SD->>+CEO: Draft enterprise strategy
    CEO->>+MA: Present long-term direction
    MA-->>-CEO: Approve enterprise strategy
```
