...
sequenceDiagram
    ...
    SD->>+CEO: Identify partnership opportunities
    CEO->>+SD: Evaluate alliance structures
    SD->>+CEO: Assess partnership terms
    CEO->>+MA: Present alliance options
    MA-->>-CEO: Approve partnership approach
```
