...
sequenceDiagram
    ...
    SD->>+CEO: Evaluate IP acquisition targets
    CEO->>+SD: Assess IP valuation
    SD->>+CEO: Analyze licensing options
    CEO->>+MA: Present IP options
    MA-->>-CEO: Approve IP investments
```
