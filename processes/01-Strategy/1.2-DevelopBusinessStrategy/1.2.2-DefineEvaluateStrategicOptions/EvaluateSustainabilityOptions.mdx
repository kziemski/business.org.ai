...
sequenceDiagram
    ...
    SD->>+CEO: Assess sustainability gaps
    CEO->>+SD: Evaluate ESG frameworks
    SD->>+CEO: Develop sustainability roadmap
    CEO->>+MA: Present sustainability options
    MA-->>-CEO: Approve sustainability targets
```
