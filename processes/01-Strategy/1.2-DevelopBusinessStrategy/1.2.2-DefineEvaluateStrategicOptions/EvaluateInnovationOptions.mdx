...
sequenceDiagram
    ...
    SD->>+CEO: Scan innovation landscape
    CEO->>+SD: Evaluate innovation models
    SD->>+CEO: Assess innovation investments
    CEO->>+MA: Present innovation options
    MA-->>-CEO: Approve innovation strategy
```
