...
sequenceDiagram
    ...
    SD->>+CEO: Analyze global market opportunities
    CEO->>+SD: Evaluate geographic expansion
    SD->>+CEO: Assess global support models
    CEO->>+MA: Present global options
    MA-->>-CEO: Approve global strategy
```
