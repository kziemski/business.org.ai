...
sequenceDiagram
    ...
    Analyst->>+Dir: Analyze deal structure
    Dir->>+Analyst: Evaluate transaction risks
    Analyst->>+Dir: Prepare deal documentation
    Dir->>+Exec: Present deal terms
    Exec-->>-Dir: Approve deal execution
```
