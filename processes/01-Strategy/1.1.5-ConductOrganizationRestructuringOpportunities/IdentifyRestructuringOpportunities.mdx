...
sequenceDiagram
    ...
    MRA->>+SD: Scan restructuring opportunities
    SD->>+MRA: Evaluate strategic options
    MRA->>+SD: Assess feasibility
    SD->>+MA: Present restructuring options
    MA-->>-SD: Prioritize opportunities
```
