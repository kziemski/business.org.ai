...
sequenceDiagram
    ...
    PM->>+SD: Gather initiative criteria
    SD->>+PM: Apply prioritization framework
    PM->>+SD: Rank strategic initiatives
    SD->>+COO: Present priority list
    COO-->>-SD: Approve initiative priorities
```
