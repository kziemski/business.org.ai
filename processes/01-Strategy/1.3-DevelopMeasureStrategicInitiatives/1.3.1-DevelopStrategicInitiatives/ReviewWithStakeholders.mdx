...
sequenceDiagram
    ...
    PM->>+SD: Prepare initiative materials
    SD->>+COO: Schedule stakeholder review
    COO->>+PM: Gather stakeholder feedback
    PM->>+SD: Incorporate feedback
    SD-->>-COO: Confirm stakeholder alignment
```
