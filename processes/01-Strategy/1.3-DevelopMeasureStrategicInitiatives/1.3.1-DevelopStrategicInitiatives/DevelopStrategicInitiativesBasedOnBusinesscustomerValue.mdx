...
sequenceDiagram
    ...
    PM->>+SD: Identify value drivers
    SD->>+PM: Design initiative scope
    PM->>+SD: Document value propositions
    SD->>+COO: Present initiative designs
    COO-->>-SD: Approve initiative development
```
