...
sequenceDiagram
    ...
    PM->>+SD: Analyze customer impact
    SD->>+PM: Quantify customer benefits
    PM->>+SD: Document customer value
    SD->>+COO: Present customer value analysis
    COO-->>-SD: Approve customer value assessment
```
