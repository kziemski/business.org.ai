...
sequenceDiagram
    ...
    PM->>+SD: Calculate financial returns
    SD->>+PM: Assess strategic alignment
    PM->>+SD: Document business value
    SD->>+COO: Present business value analysis
    COO-->>-SD: Approve investment decisions
```
