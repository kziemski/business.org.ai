...
sequenceDiagram
    ...
    PM->>+SD: Define success metrics
    SD->>+PM: Establish measurement approach
    PM->>+SD: Document measurement framework
    SD->>+COO: Present measurement plan
    COO-->>-SD: Approve metrics and targets
```
