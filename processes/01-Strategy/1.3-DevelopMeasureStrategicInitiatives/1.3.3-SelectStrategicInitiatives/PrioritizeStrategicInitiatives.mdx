...
sequenceDiagram
    ...
    PM->>+SD: Apply prioritization criteria
    SD->>+PM: Rank initiative portfolio
    PM->>+SD: Validate priority sequence
    SD->>+COO: Present prioritized list
    COO-->>-SD: Approve priority ranking
```
