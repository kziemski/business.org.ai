...
sequenceDiagram
    ...
    PM->>+SD: Develop communication materials
    SD->>+COO: Approve communication plan
    COO->>+PM: Distribute to business units
    PM->>+SD: Track acknowledgment
    SD-->>-COO: Report communication status
```
