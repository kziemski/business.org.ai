...
sequenceDiagram
    ...
    MRA->>+SD: Assess environmental factors
    SD->>+MRA: Define sustainability criteria
    MRA->>+SD: Analyze environmental impact
    SD->>+MA: Present environmental risks
    MA-->>-SD: Approve mitigation actions
```
