...
sequenceDiagram
    ...
    MRA->>+SD: Monitor regulatory landscape
    SD->>+MRA: Identify compliance requirements
    MRA->>+SD: Analyze regulatory impact
    SD->>+MA: Present compliance risks
    MA-->>-SD: Approve mitigation plan
```
