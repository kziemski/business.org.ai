...
sequenceDiagram
    ...
    MRA->>+SD: Identify market alternatives
    SD->>+MRA: Evaluate substitution risks
    MRA->>+SD: Analyze competitive offerings
    SD->>+MA: Present alternative assessment
    MA-->>-SD: Confirm strategic response
```
