...
sequenceDiagram
    ...
    BArc->>+SD: Prepare approval package
    SD->>+CSO: Present to approval authority
    CSO->>+SD: Review and provide feedback
    SD->>+BArc: Address approval conditions
    BArc-->>-SD: Obtain formal approval
```
