...
sequenceDiagram
    ...
    BArc->>+SD: Map existing models
    SD->>+BArc: Identify integration points
    BArc->>+SD: Design integration approach
    SD->>+CSO: Present integration plan
    CSO-->>-SD: Approve integration approach
```
