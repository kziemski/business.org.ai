...
sequenceDiagram
    ...
    MRA->>+SD: Assess organizational structure
    SD->>+MRA: Evaluate culture and capabilities
    MRA->>+SD: Identify organizational gaps
    SD->>+MA: Present organizational analysis
    MA-->>-SD: Approve change initiatives
```
