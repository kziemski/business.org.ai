...
sequenceDiagram
    ...
    MRA->>+SD: Compile financial statements
    SD->>+MRA: Apply financial ratios
    MRA->>+SD: Analyze liquidity and solvency
    SD->>+MA: Present financial health report
    MA-->>-SD: Approve resource allocation
```
