...
sequenceDiagram
    ...
    MRA->>+SD: Inventory technology assets
    SD->>+MRA: Assess system capabilities
    MRA->>+SD: Identify technology gaps
    SD->>+MA: Present technology assessment
    MA-->>-SD: Approve technology roadmap
```
