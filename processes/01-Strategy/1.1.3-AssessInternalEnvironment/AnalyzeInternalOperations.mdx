...
sequenceDiagram
    ...
    MRA->>+SD: Map operational processes
    SD->>+MRA: Identify efficiency gaps
    MRA->>+SD: Benchmark performance
    SD->>+MA: Present operational analysis
    MA-->>-SD: Prioritize improvements
```
