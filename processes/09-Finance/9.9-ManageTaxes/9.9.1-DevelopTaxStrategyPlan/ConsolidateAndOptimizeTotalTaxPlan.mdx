...
sequenceDiagram
    autonumber
    Accountant->>+ERP System: Extract tax data
    ...
    Accountant->>+CFO: Consult on treatment
    CFO-->>-Accountant: Provide guidance
    Accountant->>+Auditor: Update tax records
    Auditor-->>-Accountant: Confirm update
```
