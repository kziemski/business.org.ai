...
```mermaid
flowchart LR
    A["Identify requirements for tax planning/strategy"] --> B["Gather relevant data and documentation"]
    B --> C["Perform tax planning/strategy"]
