...
```mermaid
flowchart LR
    A["Identify requirements for account resolution with internal parties"] --> B["Gather relevant data and documentation"]
    B --> C["Discuss account resolution with internal parties"]
