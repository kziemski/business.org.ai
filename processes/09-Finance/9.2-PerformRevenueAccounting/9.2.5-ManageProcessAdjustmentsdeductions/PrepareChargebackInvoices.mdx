...
```mermaid
flowchart LR
    A["Identify requirements for chargeback invoices"] --> B["Gather relevant data and documentation"]
    B --> C["Prepare chargeback invoices"]
