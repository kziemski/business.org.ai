...
sequenceDiagram
    autonumber
    Control Analyst->>+Process Owner: Retrieve control data
    Process Owner-->>-Control Analyst: Return relevant records
    Control Analyst->>+Process Owner: Assess control status
    Process Owner-->>-Control Analyst: Return assessment
    Control Analyst->>+Controller: Submit for review
    Controller-->>-Control Analyst: Approve results
    Control Analyst->>+Auditor: Document for audit
