...
```mermaid
flowchart LR
    A["Identify requirements for fixed-asset accounting"] --> B["Gather relevant data and documentation"]
    B --> C["Perform fixed-asset accounting"]
...
sequenceDiagram
    ...
    Accountant->>+ERP System: Execute perform action
