...
```mermaid
flowchart LR
    A["Identify requirements for and record fixed-asset additions and retires"] --> B["Gather relevant data and documentation"]
    B --> C["Process and record fixed-asset additions and retires"]
