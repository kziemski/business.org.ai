...
```mermaid
flowchart LR
    A["Identify requirements for consolidated reporting/review of cost management reports"] --> B["Gather relevant data and documentation"]
    B --> C["Perform consolidated reporting/review of cost management reports"]
