...
```mermaid
flowchart LR
    A["Identify requirements for regulatory reports"] --> B["Gather relevant data and documentation"]
    B --> C["Produce regulatory reports"]
