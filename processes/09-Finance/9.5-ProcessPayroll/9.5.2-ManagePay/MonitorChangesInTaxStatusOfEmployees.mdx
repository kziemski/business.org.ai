...
sequenceDiagram
    autonumber
    Tax Analyst->>+ERP System: Retrieve payroll data
    ERP System-->>-Tax Analyst: Return relevant records
    Tax Analyst->>+Tax Manager: Submit for review
    Tax Manager-->>-Tax Analyst: Approve processing
    Tax Analyst->>+ERP System: Execute monitor action
    ERP System-->>-Tax Analyst: Confirm completion
    Tax Analyst->>+External Advisor: Update payroll records
