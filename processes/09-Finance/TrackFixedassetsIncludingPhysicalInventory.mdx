...
```mermaid
flowchart LR
    A["Identify requirements for fixed-assets including physical inventory"] --> B["Gather relevant data and documentation"]
    B --> C["Track fixed-assets including physical inventory"]
...
sequenceDiagram
    ...
    Accountant->>+ERP System: Execute track action
