...
sequenceDiagram
    autonumber
    Tax Analyst->>+ERP System: Initiate and report relevant tax data
    ...
    Tax Analyst->>+ERP System: Execute capture action
    ERP System-->>-Tax Analyst: Confirm completion
    Tax Analyst->>+Controller: Document for audit
    Controller-->>-Tax Analyst: Confirm documentation
    Tax Analyst->>+External Advisor: Report to management
    External Advisor-->>-Tax Analyst: Acknowledge report
```
