...
```mermaid
flowchart LR
    A["Identify requirements for restitution"] --> B["Gather relevant data and documentation"]
    B --> C["Handle restitution"]
