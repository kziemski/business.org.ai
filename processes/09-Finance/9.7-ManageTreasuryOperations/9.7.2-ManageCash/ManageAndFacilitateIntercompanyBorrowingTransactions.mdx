...
```mermaid
flowchart LR
    A["Identify requirements for and facilitate inter-company borrowing transactions"] --> B["Gather relevant data and documentation"]
    B --> C["Manage and facilitate inter-company borrowing transactions"]
...
sequenceDiagram
    autonumber
    Treasury Analyst->>+ERP System: Initiate and facilitate inter-company borrowing transactions
