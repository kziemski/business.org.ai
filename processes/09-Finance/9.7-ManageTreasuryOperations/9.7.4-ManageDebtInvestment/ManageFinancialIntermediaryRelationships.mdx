...
```mermaid
flowchart LR
    A["Identify requirements for financial intermediary relationships"] --> B["Gather relevant data and documentation"]
    B --> C["Manage financial intermediary relationships"]
...
sequenceDiagram
    autonumber
    Treasury Analyst->>+ERP System: Initiate financial intermediary relationships
