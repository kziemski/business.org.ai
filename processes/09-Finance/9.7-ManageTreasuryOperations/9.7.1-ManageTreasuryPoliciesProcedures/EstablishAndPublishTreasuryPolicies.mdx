...
```mermaid
flowchart LR
    A["Identify requirements for and publish treasury policies"] --> B["Gather relevant data and documentation"]
    B --> C["Establish and publish treasury policies"]
...
sequenceDiagram
    autonumber
    Treasury Analyst->>+ERP System: Initiate and publish treasury policies
