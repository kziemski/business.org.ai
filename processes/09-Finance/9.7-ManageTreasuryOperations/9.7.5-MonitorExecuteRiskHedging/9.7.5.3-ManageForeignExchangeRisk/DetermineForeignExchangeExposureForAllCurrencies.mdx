...
Activity 9.7.5.3.2 is an activity within the Treasury Management domain of the Manage Financial Resources framework.
...
```mermaid
flowchart LR
    A["Identify requirements for foreign exchange exposure for all currencies"] --> B["Gather relevant data and documentation"]
    B --> C["Determine foreign exchange exposure for all currencies"]
