...
```mermaid
flowchart LR
    A["Identify requirements for physical positions"] --> B["Gather relevant data and documentation"]
    B --> C["Measure physical positions"]
