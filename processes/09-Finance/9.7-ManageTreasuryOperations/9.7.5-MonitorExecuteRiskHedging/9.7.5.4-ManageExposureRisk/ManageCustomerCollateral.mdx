...
```mermaid
flowchart LR
    A["Identify requirements for customer collateral"] --> B["Gather relevant data and documentation"]
    B --> C["Manage customer collateral"]
