...
```mermaid
flowchart LR
    A["Identify requirements for annual customer credit reviews"] --> B["Gather relevant data and documentation"]
    B --> C["Perform annual customer credit reviews"]
