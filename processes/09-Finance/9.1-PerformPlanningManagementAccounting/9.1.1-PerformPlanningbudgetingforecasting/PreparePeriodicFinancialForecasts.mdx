---
id: PreparePeriodicFinancialForecasts
...
graph TD
    ...
    N9_1_1 --> N9_1_1_4["9.1.1.4 Prepare periodic financial forecasts"]
    style N9_1_1_4 fill:#e1f5fe
```
...
```mermaid
flowchart LR
    A["Identify requirements for periodic financial forecasts"] --> B["Gather relevant data and documentation"]
    B --> C["Prepare periodic financial forecasts"]
...
```graphdl
prepare.PeriodicFinancialForecasts
```

| Component | Value | Description |
|-----------|-------|-------------|
| Verb | `prepare` | Primary action |
| Object | `periodic financial forecasts` | Direct object |
...
sequenceDiagram
    autonumber
    Budget Analyst->>+ERP System: Extract actuals data
    ERP System-->>-Budget Analyst: Return YTD results
    Budget Analyst->>+Department Head: Request driver updates
    Department Head-->>-Budget Analyst: Provide forecast inputs
    Budget Analyst->>+ERP System: Run forecast model
    ERP System-->>-Budget Analyst: Return forecast results
    Budget Analyst->>+FPA Manager: Review forecast variance
    FPA Manager-->>-Budget Analyst: Approve forecast
    Budget Analyst->>+Controller: Update planning system
    Controller-->>-Budget Analyst: Confirm update
```

## Related Concepts

- PeriodicFinancialForecasts

---

*Source: APQC PCF 10773 (9.1.1.4) - APQC*