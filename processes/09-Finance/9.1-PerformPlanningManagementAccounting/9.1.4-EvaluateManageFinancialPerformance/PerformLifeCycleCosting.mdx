...
```mermaid
flowchart LR
    A["Identify requirements for life cycle costing"] --> B["Gather relevant data and documentation"]
    B --> C["Perform life cycle costing"]
