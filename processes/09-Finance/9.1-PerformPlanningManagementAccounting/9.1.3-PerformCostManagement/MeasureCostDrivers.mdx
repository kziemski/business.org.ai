...
```mermaid
flowchart LR
    A["Identify requirements for cost drivers"] --> B["Gather relevant data and documentation"]
    B --> C["Measure cost drivers"]
