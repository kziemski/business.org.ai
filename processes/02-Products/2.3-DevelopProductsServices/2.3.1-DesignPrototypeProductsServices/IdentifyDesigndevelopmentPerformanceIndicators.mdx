...
- DesignPerformanceIndicators
- DevelopmentPerformanceIndicators
...
flowchart LR
    ...
    subgraph Process["Identify design/development performance indicators"]
        S0["Plan Development"]
        S1["Create Design"]
        S2["Build Solution"]
        S3["Validate Output"]
...
sequenceDiagram
    ...
    ProductManager->>Engineer: Initiate identify design/development performance indicators request
