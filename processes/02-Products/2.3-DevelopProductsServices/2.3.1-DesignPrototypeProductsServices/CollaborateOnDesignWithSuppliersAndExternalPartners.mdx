...
- DesignWithSuppliersPartners
- DesignWithExternalPartners
...
flowchart LR
    ...
    subgraph Process["Collaborate on design with suppliers and external partners"]
        S0["Plan Development"]
        S1["Create Design"]
        S2["Build Solution"]
        S3["Validate Output"]
...
sequenceDiagram
    ...
    ProductManager->>Engineer: Initiate collaborate on design with suppliers and external partners request
