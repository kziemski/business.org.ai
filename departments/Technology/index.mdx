...
|------|-------|-------------|
| [Computer and Information Systems Managers](/occupations/ComputerAndInformationSystemsManagers) | Director/VP | Plan, direct, or coordinate IT activities |
| [Information Technology Project Managers](/occupations/InformationTechnologyProjectManagers) | Manager | Plan and manage IT projects |
| [Computer Network Architects](/occupations/ComputerNetworkArchitects) | Architect | Design computer and information networks |
| [Database Architects](/occupations/DatabaseArchitects) | Architect | Design database and data warehouse systems |
| [Information Security Analysts](/occupations/InformationSecurityAnalysts) | Sr. Analyst | Plan and implement security measures |
| [Software Developers](/occupations/SoftwareDevelopers) | Engineer | Design, develop, and test software |
| [Network and Computer Systems Administrators](/occupations/NetworkAndComputerSystemsAdministrators) | Administrator | Install, configure, and maintain systems |
| [Computer User Support Specialists](/occupations/ComputerUserSupportSpecialists) | Support | Provide technical assistance to users |
| [Data Scientists](/occupations/DataScientists) | Analyst | Develop analytics applications and models |
...
- [Define Business Technology and Governance Strategy](/processes/DefineBusinessTechnologyAndGovernanceStrategy) - Primary Owner
- [Create and Publish Enterprise Architecture Principles](/processes/CreateAndPublishEnterpriseArchitecturePrinciples) - Primary Owner
- [Define and Manage Technology Innovation](/processes/DefineAndManageTechnologyInnovation) - Primary Owner
- [Develop IT Compliance, Risk, and Security Strategy](/processes/DevelopItComplianceRiskAndSecurityStrategy) - Primary Owner
- [Develop and Manage IT Security, Privacy, and Data Protection](/processes/DevelopAndManageItSecurityPrivacyAndDataProtection) - Primary Owner
- [Implement Technology Solutions](/processes/ImplementTechnologySolutions) - Primary Owner
- [Develop and Manage Infrastructure Resource Planning](/processes/DevelopAndManageInfrastructureResourcePlanning) - Primary Owner
- [Create and Manage Support Services/Solutions](/processes/CreateAndManageSupportServicessolutions) - Primary Owner
- [Define and Develop Service Support Strategy](/processes/DefineAndDevelopServiceSupportStrategy) - Primary Owner
- [Provide Service Support Tools and Technology](/processes/ProvideServiceSupportToolsAndTechnology) - Primary Owner
