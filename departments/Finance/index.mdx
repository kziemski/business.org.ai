...
| Process Group | [Manage Financial Resources](/processes/industries/utilities/utilities_UtilityCompanies_ManageFinancialResources) |
...
|------|-------|-------------|
| [Financial Managers](/occupations/Management/FinancialManagers) | Director/VP | Plan, direct, or coordinate financial activities |
| [Treasurers and Controllers](/occupations/Management/TreasurersAndControllers) | Director | Direct financial activities including planning and investments |
| [Accountants and Auditors](/occupations/Business/Financial/AccountantsAndAuditors) | Manager/Sr. | Examine and interpret accounting records |
| [Budget Analysts](/occupations/Business/Financial/BudgetAnalysts) | Analyst | Examine budget estimates for accuracy and conformance |
| [Financial and Investment Analysts](/occupations/Business/FinancialAndInvestmentAnalysts) | Analyst | Conduct quantitative financial analyses |
| [Credit Analysts](/occupations/Business/Financial/CreditAnalysts) | Analyst | Analyze credit data and financial statements |
| [Financial Risk Specialists](/occupations/Business/FinancialRiskSpecialists) | Sr. Analyst | Analyze exposure to credit and market risk |
...
- [Manage Financial Resources](/processes/industries/utilities/utilities_UtilityCompanies_ManageFinancialResources) - Primary Owner
- [Perform Planning and Management Accounting](/processes/industries/utilities/utilities_UtilityCompanies_PerformPlanningAndManagementAccounting) - Primary Owner
- [Develop and Maintain Budget Policies and Procedures](/processes/industries/utilities/utilities_UtilityCompanies_DevelopAndMaintainBudgetPoliciesAndProcedures) - Primary Owner
- [Prepare Periodic Budgets and Plans](/processes/industries/utilities/utilities_UtilityCompanies_PreparePeriodicBudgetsAndPlans) - Primary Owner
- [Perform Revenue Accounting](/processes/industries/utilities/utilities_UtilityCompanies_PerformRevenueAccounting) - Primary Owner
- [Perform General Accounting and Reporting](/processes/industries/utilities/utilities_UtilityCompanies_PerformGeneralAccountingAndReporting) - Primary Owner
- [Perform Fixed-Asset Accounting](/processes/09-Finance/9.3-PerformGeneralAccountingReporting/9.3.2-PerformGeneralAccounting/PerformFixedassetAccounting) - Primary Owner
- [Process Payroll](/processes/industries/utilities/utilities_UtilityCompanies_ProcessPayroll) - Primary Owner
- [Administer Payroll](/processes/industries/utilities/utilities_UtilityCompanies_AdministerPayroll) - Primary Owner
