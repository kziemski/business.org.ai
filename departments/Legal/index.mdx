...
|------|-------|-------------|
| [Lawyers](/occupations/Legal/Lawyers) | VP/Director | Represent clients and advise on legal transactions |
| [Compliance Managers](/occupations/Management/ComplianceManagers) | Director | Coordinate activities to ensure compliance with standards |
| [Compliance Officers](/occupations/Business/Operations/ComplianceOfficers) | Manager | Examine and investigate compliance with laws and regulations |
| [Regulatory Affairs Managers](/occupations/Management/RegulatoryAffairsManagers) | Manager | Coordinate production activities for regulatory compliance |
| [Paralegals and Legal Assistants](/occupations/Legal/ParalegalsAndLegalAssistants) | Specialist | Assist lawyers by researching and preparing legal documents |
| [Title Examiners, Abstractors, and Searchers](/occupations/Legal/TitleExaminersAbstractorsAndSearchers) | Specialist | Search records and examine legal documents |
...
- [Manage Contracts](/processes/industries/utilities/utilities_UtilityCompanies_ManageContracts) - Primary Owner
- [Negotiate and Establish Contracts](/processes/industries/utilities/utilities_UtilityCompanies_NegotiateAndEstablishContracts) - Primary Owner
- [Manage Patents, Copyrights, and Regulatory Requirements](/processes/industries/utilities/utilities_UtilityCompanies_ManagePatentsCopyrightsAndRegulatoryRequirements) - Primary Owner
- [Conduct Mandatory and Elective Reviews](/processes/industries/utilities/utilities_UtilityCompanies_ConductMandatoryAndElectiveReviews) - Primary Owner
- [Train Employees on Appropriate Regulatory Requirements](/processes/industries/utilities/utilities_UtilityCompanies_TrainEmployeesOnAppropriateRegulatoryRequirements) - Primary Owner
- [Maintain Records for Regulatory Agencies](/processes/industries/utilities/utilities_UtilityCompanies_MaintainRecordsForRegulatoryAgencies) - Primary Owner
- [Manage Regulatory Submission Life Cycle](/processes/industries/utilities/utilities_UtilityCompanies_ManageRegulatorySubmissionLifeCycle) - Primary Owner
- [Perform Due Diligence](/processes/01-Strategy/1.1.5-ConductOrganizationRestructuringOpportunities/PerformDuediligence) - Primary Owner
- [Review Infringement of Patents and Copyrights](/processes/industries/utilities/utilities_UtilityCompanies_ReviewInfringementOfPatentsAndCopyrights) - Primary Owner
- [Derive Regulatory Compliance Requirements](/processes/industries/utilities/utilities_UtilityCompanies_DeriveRegulatoryComplianceRequirements) - Primary Owner
